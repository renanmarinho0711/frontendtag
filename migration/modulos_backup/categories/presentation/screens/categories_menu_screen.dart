...
class _CategoriasMenuScreenState extends ConsumerState<CategoriasMenuScreen> with ResponsiveCache {
  ...
  Widget _buildStatsCards() {
    ...
    final estatisticas = [
      {'label': 'Bebidas', 'valor': '247', 'icon': Icons.local_drink_rounded, 'cor': AppThemeColors.blueMaterial, 'mudanca': '+5', 'tipo': 'aumento'},
      {'label': 'Mercearia', 'valor': '532', 'icon': Icons.shopping_basket_rounded, 'cor': AppThemeColors.brownMain, 'mudanca': '+18', 'tipo': 'aumento'},
      {'label': 'Perecíveis', 'valor': '189', 'icon': Icons.dining_rounded, 'cor': AppThemeColors.greenMaterial, 'mudanca': '+7', 'tipo': 'aumento'},
      {'label': 'Limpeza', 'valor': '156', 'icon': Icons.clean_hands_rounded, 'cor': AppThemeColors.blueCyan, 'mudanca': '+3', 'tipo': 'aumento'},
    ];
        ...
        final opcoes = [
          {
            ...
            'gradiente': [AppThemeColors.categoryVisualizar, AppThemeColors.categoryVisualizarDark],
          ...
          },
          {
            ...
            'gradiente': [AppThemeColors.categoryNova, AppThemeColors.categoryNovaDark],
          ...
          },
          {
            ...
            'gradiente': [AppThemeColors.categoryProdutos, AppThemeColors.categoryProdutosDark],
          ...
          },
          {
            ...
            'gradiente': [AppThemeColors.categoryAdmin, AppThemeColors.categoryAdminDark],
          ...
          },
          {
            ...
            'gradiente': [AppThemeColors.categoryStats, AppThemeColors.categoryStatsDark],
          ...
          },
          {
            ...
            'gradiente': [AppThemeColors.categoryImportExport, AppThemeColors.categoryImportExportDark],
            'destino': null,
          },
        ];
        return _buildOptionCard(opcoes[index], index);
      },
    );
  }
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: AppThemeColors.surfaceOverlay50),
                    ),
                    child: Text(
                      opcao['badge'],
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.import_export_rounded, color: AppThemeColors.surface, size: 24),
            ),
