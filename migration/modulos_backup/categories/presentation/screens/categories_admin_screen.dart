...
class _CategoriasAdminScreenState extends ConsumerState<CategoriasAdminScreen>
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            icon: const Icon(Icons.edit_rounded, color: AppThemeColors.surface),
            onPressed: _selectedItems.isEmpty ?  null : () => _bulkEdit(),
          ),
          IconButton(
            icon: const Icon(Icons.delete_rounded, color: AppThemeColors.surface),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(AppSizes.paddingBase.get(isMobile, isTablet)),
                borderSide: const BorderSide(color: AppThemeColors.greenMaterial, width: 2),
              ),
              filled: true,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: isSelected
              ...
              : null,
          color: isSelected ?  null : AppThemeColors.textSecondary,
          borderRadius: BorderRadius.circular(AppSizes.paddingLgAlt.get(isMobile, isTablet)),
          border: Border.all(
            color: isSelected ? AppThemeColors.transparent : AppThemeColors.grey500.withValues(alpha: 0.4),
          ),
        ),
        child: Text(
          label,
          style: TextStyle(
            ...
            color: isSelected ? AppThemeColors.surface : AppThemeColors.textSecondary,
          ),
        ),
      ),
    );
    ...
    return TweenAnimationBuilder(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: isSelected ?  Border.all(color: AppThemeColors.surface, width: 3) : null,
          boxShadow: [
            BoxShadow(
                ...
                if (_isSelectMode)
                  Positioned(
                    ...
                    child: Container(
                      ...
                      height: 28,
                      decoration: BoxDecoration(
                        color: isSelected ? AppThemeColors.surface : AppThemeColors.surfaceOverlay30,
    ...
    return TweenAnimationBuilder(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isSelected
              ? Border.all(color: AppThemeColors.greenMaterial, width: 2)
              : Border.all(color: AppThemeColors.textSecondary),
          boxShadow: [
            BoxShadow(
              color: isSelected
                  ? AppThemeColors.greenMaterial.withValues(alpha: 0.2)
                          ...
                          children: [
                            ...
                            if (! categoria['ativa'])
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: AppThemeColors.redMain.withValues(alpha: 0.2),
                                  borderRadius: BorderRadius.circular(8),
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                color: AppThemeColors.grey500.withValues(alpha: 0.7),
                              ),
                            ),
  ...
  void _bulkDelete() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        icon: const Icon(Icons.delete_sweep_rounded, color: AppThemeColors.redMain, size: 48),
