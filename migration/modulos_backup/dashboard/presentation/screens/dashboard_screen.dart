...
class _DashboardScreenState extends ConsumerState<DashboardScreen> with TickerProviderStateMixin {
  ...
  Map<String, dynamic> get _estrategiasData {
    ...
    final cores = [AppThemeColors.greenMaterial, AppThemeColors.blueMaterial, AppThemeColors.orangeMaterial, AppThemeColors.greenMaterial, AppThemeColors.materialTeal, AppThemeColors.blueIndigo];
  ...
  Widget _buildCompactMetricsGrid() {
    ...
    final estatisticas = [
      {'label': 'Produtos Ativos', 'valor': '1.234', 'icon': Icons.inventory_2_rounded, 'cor': AppThemeColors.blueMaterial, 'mudanca': '+12%', 'tipo': 'aumento'},
      {'label': 'Tags Criadas', 'valor': '987', 'icon': Icons.label_rounded, 'cor': AppThemeColors.blueCyan, 'mudanca': '+8%', 'tipo': 'aumento'},
      {'label': 'Sincronizações', 'valor': '42', 'icon': Icons.sync_rounded, 'cor': AppThemeColors.blueCyan, 'mudanca': '+3', 'tipo': 'aumento'},
      {'label': 'Categorias', 'valor': '156', 'icon': Icons.category_rounded, 'cor': AppThemeColors.blueCyan, 'mudanca': '+5%', 'tipo': 'aumento'},
    ];
    ...
    return RepaintBoundary(
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppThemeColors.moduleEstrategias.withValues(alpha: 0.08),
  ...
  Widget _buildEstrategiasLucroCard() {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppThemeColors.greenMaterial.withValues(alpha: 0.3),
  ...
  Widget _buildEstrategiasDetalhadasCard() {
    ...
    return Container(
      decoration: BoxDecoration(
        color: AppThemeColors.surfaceTinted,
        borderRadius: BorderRadius.circular(
          isMobile ? 16 : (isTablet ? 18 : 20),
        ),
        boxShadow: [
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCompactQuickActionButton(
              ...
              [AppThemeColors.moduleDashboard, AppThemeColors.moduleDashboardDark],
            ...
            _buildCompactQuickActionButton(
              ...
              [AppThemeColors.moduleProdutos, AppThemeColors.moduleProdutosDark],
            ...
            _buildCompactQuickActionButton(
              ...
              [AppThemeColors.modulePrecificacao, AppThemeColors.modulePrecificacaoDark],
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            _buildStatusRow('Conexão', 'Conectado', AppThemeColors.greenMain),
            const SizedBox(height: 8),
            _buildStatusRow('Última sincronização', 'Há 5 minutos', AppThemeColors.blueMain),
            const SizedBox(height: 8),
            _buildStatusRow('Pendências', '0 itens', AppThemeColors.textSecondary),
          ],
        ),
        actions: [
          TextButton(
  ...
  Color _getAlertCardBackground(Color alertColor) {
    ...
    if (alertColor.value == AppThemeColors.alertWarningLight.value ||
        alertColor.value == AppThemeColors.alertOrangeMain.value ||
        alertColor.value == AppThemeColors.alertWarningIcon.value) {
      return AppThemeColors.alertWarningCardBackground;
    } else if (alertColor.value == AppThemeColors.alertWarningLight.value ||
               alertColor.value == AppThemeColors.alertRedMain.value ||
               alertColor.value == AppThemeColors.alertErrorBackground.value) {
      return AppThemeColors.alertErrorCardBackground;
    }
  ...
  Color _getAlertCardBorder(Color alertColor) {
    ...
    if (alertColor.value == AppThemeColors.alertWarningLight.value ||
        alertColor.value == AppThemeColors.alertOrangeMain.value ||
        alertColor.value == AppThemeColors.alertWarningIcon.value) {
      return AppThemeColors.alertWarningCardBorder;
    } else if (alertColor.value == AppThemeColors.alertWarningLight.value ||
               alertColor.value == AppThemeColors.alertRedMain.value ||
               alertColor.value == AppThemeColors.alertErrorBackground.value) {
      return AppThemeColors.alertErrorCardBorder;
    }
    // Fallback para cor genérica
    ...
    if (tipo.contains('sem preço') || tipo.contains('sem_preco')) {
          ...
          content: Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.filter_list_rounded, color: AppThemeColors.surface, size: 18),
              ),
              const SizedBox(width: 12),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Row(
            children: [
              Icon(alerta['icone'] as IconData, color: AppThemeColors.surface, size: 20),
              const SizedBox(width: 12),
    ...
    Future.delayed(const Duration(milliseconds: 300), () {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.add_box_rounded, color: AppThemeColors.surface, size: 18),
              ),
              const SizedBox(width: 12),
              const Expanded(
          ...
          backgroundColor: AppThemeColors.moduleProdutos,
          behavior: SnackBarBehavior.floating,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
          margin: const EdgeInsets.all(16),
  ...
  void _navegarParaImportacao() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.upload_file_rounded, color: AppThemeColors.surface, size: 18),
            ),
            const SizedBox(width: 12),
            const Expanded(
        ...
        backgroundColor: AppThemeColors.modulePrecificacao,
        behavior: SnackBarBehavior.floating,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        margin: const EdgeInsets.all(16),
        duration: const Duration(seconds: 3),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Icons.logout_rounded, color: AppThemeColors.redMain),
            SizedBox(
              width: ResponsiveHelper.getResponsivePadding(
                context,
                mobile: 10,
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: Container(
            ...
            decoration: BoxDecoration(
              color: (isProduto ? AppThemeColors.blueMain : AppThemeColors.greenMaterial)
