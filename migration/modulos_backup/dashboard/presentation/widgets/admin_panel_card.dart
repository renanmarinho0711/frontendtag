      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: isPlatformAdmin 
              ...
              : isClientAdmin
                  ? [AppThemeColors.adminPanelBackground1, AppThemeColors.adminPanelBackground2]
                  : [AppThemeColors.adminPanelBackground1, AppThemeColors.adminPanelBackground2],
        ),
        borderRadius: BorderRadius.circular(isMobile ? 16 : 20),
        boxShadow: [
          BoxShadow(
            color: (isPlatformAdmin ? AppThemeColors.moduleDashboard : AppThemeColors.blueCyan).withValues(alpha: 0.3),
            blurRadius: 20,
          ...
          child: Row(
            ...
            children: [
              ...
              Icon(
                ...
                color: AppThemeColors.surfaceOverlay60,
                size: isMobile ? 14 : 16,
              ),
            ],
          ),
