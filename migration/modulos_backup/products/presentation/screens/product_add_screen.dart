          ...
          label: Row(
            ...
            children: [
              Icon(
                categoria.iconData,
                size: 16,
                color: isSelected ? AppThemeColors.surface : cor,
              ),
        ...
        label: Row(
          ...
          children: [
            Icon(
              theme.icon,
              size: 16,
              color: isSelected ? AppThemeColors.surface : theme.color,
            ),
            const SizedBox(width: AppSpacing.xs),
            Text(cat),
          ],
  ...
  void _showValidationError(String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Row(
          children: [
            const Icon(Icons.warning_rounded, color: AppThemeColors.surface),
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isCompleted 
                        ? AppThemeColors.brandPrimaryGreen 
                        : isActive 
                            ? AppThemeColors.brandPrimaryGreen.withValues(alpha: 0.2)
                            : AppThemeColors.grey200,
                    border: isActive 
                  ...
                  child: Center(
                    child: isCompleted
                        ? const Icon(Icons.check_rounded, color: AppThemeColors.surface, size: 16)
                        : Text(
                            '${stepIndex + 1}',
                            style: TextStyle(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    AppThemeColors.infoPastel.withValues(alpha: 0.5),
                    AppThemeColors.infoPastel.withValues(alpha: 0.2),
                  ],
                ),
                borderRadius: AppRadius.card,
                border: Border.all(color: AppThemeColors.blueMain.withValues(alpha: 0.3)),
              ),
              child: Column(
                children: [
                  Row(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: margem > 0 
            ...
            : AppThemeColors.errorBackground,
        borderRadius: AppRadius.sm,
      ),
      child: Row(
        children: [
          Icon(
            ...
            color: margem > 0 ? AppThemeColors.success : AppThemeColors.error,
          ),
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildResumoItem('Código de Barras', _codigoController.text, Icons.qr_code_rounded),
                ...
                _buildResumoItem('Preço', 'R\$ ${preco.toStringAsFixed(2)}', Icons.attach_money_rounded),
                if (precoKg != null)
                  _buildResumoItem('Preço/Kg', 'R\$ ${precoKg.toStringAsFixed(2)}', Icons.monitor_weight_rounded),
                if (_descricaoController.text.isNotEmpty)
                  _buildResumoItem('Descrição', _descricaoController.text, Icons.description_rounded),
              ],
            ),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _vincularTag 
                    ? AppThemeColors.brandPrimaryGreen.withValues(alpha: 0.5) 
          ...
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.info_outline_rounded, color: AppThemeColors.blueMain),
                const SizedBox(width: AppSpacing.md),
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 13,
                      color: AppThemeColors.blueMain.withValues(alpha: 0.8),
                    ),
                  ),
                ),
              ],
  ...
  Widget _buildResumoItem(String label, String value, IconData icon) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(icon, size: 18, color: AppThemeColors.textSecondary),
          const SizedBox(width: AppSpacing.md),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
            ...
            child: _currentStep < _totalSteps - 1
                ? FilledButton.icon(
                    ...
                    style: FilledButton.styleFrom(
                      ...
                      disabledBackgroundColor: AppThemeColors.textSecondaryOverlay30,
                    ),
                  )
                : FilledButton.icon(
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(
          ...
          color: showValidation && isValid ? AppThemeColors.success : null,
        ),
        suffixIcon: showValidation
            ? Icon(
                isValid ? Icons.check_circle_rounded : Icons.error_rounded,
                color: isValid ? AppThemeColors.success : AppThemeColors.error,
                size: 20,
              )
            : null,
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: showValidation && isValid 
                ...
                : AppThemeColors.textSecondaryOverlay30,
          ),
        ),
    ...
    if (storeId == null || storeId.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Row(
            children: [
              const Icon(Icons.error_rounded, color: AppThemeColors.surface),
              const SizedBox(width: AppSpacing.md),
              Expanded(
                child: Text(
