...
class _ProdutosEditarScreenState extends ConsumerState<ProdutosEditarScreen> 
  ...
  Widget _buildModernAppBar() {
    final isMobile = ResponsiveHelper.isMobile(context);
    final isTablet = ResponsiveHelper.isTablet(context);
    final productColor = widget.product.cor ?? AppThemeColors.brandPrimaryGreen;
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  widget.product.nome,
                  style: _responsiveTextStyle(AppTextStyles.caption.copyWith(color: AppThemeColors.textSecondary)),
                  maxLines: 1,
                  ...
                  children: [
                    Text(
                      ...
                      style: _responsiveTextStyle(AppTextStyles.sectionTitle.copyWith(
                        color: hasTag ? AppThemeColors.successDark : AppThemeColors.warningDark,
                      )),
                    ),
                    SizedBox(
              ...
              if (hasTag)
                OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    foregroundColor: AppThemeColors.warningDark,
                    side: const BorderSide(color: AppThemeColors.warning),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildTagInfo('Status', 'ðŸŸ¢ Online'),
                  const SizedBox(height: AppSpacing.sm),
                  _buildTagInfo('Ãšltima Sincronização', 
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: const Row(
                        children: [
                          Icon(Icons.open_in_new_rounded, color: AppThemeColors.surface),
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: const Row(
                        children: [
                          Icon(Icons.qr_code_scanner_rounded, color: AppThemeColors.surface),
                          SizedBox(width: AppSpacing.md),
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                ...
                style: _responsiveTextStyle(AppTextStyles.tiny.copyWith(
                  fontWeight: FontWeight.bold,
                  color: isAumento ? AppThemeColors.warning : AppThemeColors.brandPrimaryGreen,
                )),
              ),
            ],
          ),
