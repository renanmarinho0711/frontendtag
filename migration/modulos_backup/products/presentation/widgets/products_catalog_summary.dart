          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color.alphaBlend(stat.color.withValues(alpha: 0.12), AppThemeColors.surface),
                  Color.alphaBlend(stat.color.withValues(alpha: 0.04), AppThemeColors.surface),
                ],
              ),
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: stat.isWarning
                    ? Color.alphaBlend(stat.color.withValues(alpha: 0.5), AppThemeColors.surface)
                    : Color.alphaBlend(stat.color.withValues(alpha: 0.25), AppThemeColors.surface),
