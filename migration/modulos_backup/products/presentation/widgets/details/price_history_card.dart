    ...
    return Row(
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color:
                isAumento ? AppThemeColors.errorLight : AppThemeColors.successLight,
          ...
          child: Row(
            ...
            children: [
              Icon(
                ...
                size: 10,
                color: isAumento ? AppThemeColors.error : AppThemeColors.success,
              ),
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold,
                  color:
                      isAumento ? AppThemeColors.error : AppThemeColors.success,
                ),
              ),
            ],
          ),
