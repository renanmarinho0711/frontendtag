...
class ProductFilters extends StatelessWidget {
  ...
  Widget _buildFilterContainer(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: AppThemeColors.brandPrimaryGreen.withValues(alpha: 0.15), width: 1),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          _buildSearchField(isMobile, isTablet),
          SizedBox(height: AppSizes.paddingBase.get(isMobile, isTablet)),
          _buildDropdowns(isMobile, isTablet),
        ],
      ),
    );
  }

  Widget _buildSearchField(bool isMobile, bool isTablet) {
    return TextField(
  ...
  Widget _buildDropdowns(bool isMobile, bool isTablet) {
    return Row(
      children: [
        Expanded(
