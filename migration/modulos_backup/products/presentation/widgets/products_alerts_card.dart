  ...
  Color get color {
    switch (priority) {
      ...
      case AlertPriority.success:
        return AppThemeColors.brandPrimaryGreen;
    }
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: Color.alphaBlend(sortedAlerts.first.color.withValues(alpha: 0.3), AppThemeColors.surface),
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
            color: Color.alphaBlend(sortedAlerts.first.color.withValues(alpha: 0.1), AppThemeColors.surface),
            blurRadius: 16,
