...
class BarcodeScannerWidget extends StatefulWidget {
  ...
  const BarcodeScannerWidget({
    ...
    this.primaryColor = AppThemeColors.brandPrimaryGreen,
    this.autoClose = true,
...
class _BarcodeScannerWidgetState extends State<BarcodeScannerWidget>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppThemeColors.neutralBlack,
      body: Stack(
        children: [
          // Câmera
          MobileScanner(
  ...
  Widget _buildControlButton({
    ...
    return Material(
      color: isActive 
          ? widget.primaryColor 
          : AppThemeColors.neutralBlack.withValues(alpha: 0.5),
    ...
    return CustomPaint(
      painter: ScanOverlayPainter(
        ...
        borderColor: _hasDetected 
            ...
            : widget.primaryColor,
        overlayColor: AppThemeColors.neutralBlack.withValues(alpha: 0.6),
      ),
      child: Center(
        child: Column(
  ...
  Widget _buildDetectedIndicator() {
    return Center(
      child: Container(
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        ...
        builder: (context) => BarcodeScannerWidget(
          title: title,
          subtitle: subtitle,
          primaryColor: primaryColor ?? AppThemeColors.brandPrimaryGreen,
