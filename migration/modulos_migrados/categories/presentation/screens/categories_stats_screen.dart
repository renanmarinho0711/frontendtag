...
class _CategoriasEstatisticasScreenState extends ConsumerState<CategoriasEstatisticasScreen>
  ...
  Widget _buildPeriodOption(BuildContext context, String label, String value) {
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          gradient: isSelected
              ? const LinearGradient(colors: [ThemeColors.of(context).greenMaterial, ThemeColors.of(context).greenDark])
              : null,
          borderRadius: BorderRadius.circular(AppSizes.paddingBase.get(isMobile, isTablet)),
        ),
        child: Text(
  ...
  Widget _buildSummaryCards(BuildContext context) {
    ...
    final cards = [
      ...
      _buildSummaryCard(context, 'Ticket Médio',
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _buildMetricBox(context, 'Ticket Médio',
  ...
  void _exportarRelatorio() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        icon: const Icon(Icons.file_download_rounded, color: ThemeColors.of(context).greenMaterial, size: 48),
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ListTile(
              leading: Icon(Icons.picture_as_pdf_rounded, color: ThemeColors.of(context).redMain),
