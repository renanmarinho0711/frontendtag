        ...
        children: [
          Row(
            children: [
              ...
              _buildStepIndicator(context, 4, 'Concluído', _step >= 4),
            ],
          ),
          if (_step == 3) ...[
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.sm),
          _buildInfoItem(context, 'codigo', 'Código de barras (mínimo 8 dígitos)'),
          _buildInfoItem(context, 'nome', 'Nome do produto (obrigatório)'),
          _buildInfoItem(context, 'preco', 'Preço unitário (formato: 9.99)'),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: _buildStatCard(context, 'Válidos',
                '$_validosNoPreview',
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              _buildFieldChip(context, 'Código', item.codigo),
  ...
  void _baixarTemplate() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Row(
          children: [
            Icon(Icons.download_rounded, color: ThemeColors.of(context).surface),
            const SizedBox(width: AppSpacing.md),
