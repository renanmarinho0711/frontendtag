                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text('â€¢', style: TextStyle(color: ThemeColors.of(context).textSecondary, fontSize: 12)),
                            ),
                            Text(
                              produto.codigo,
                              style: TextStyle(
  ...
  Widget _buildSelectionHeader(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          IconButton(
            icon: const Icon(Icons.close_rounded, color: ThemeColors.of(context).surface),
          ...
          if (selectedCount < totalProducts)
            TextButton.icon(
              ...
              icon: Icon(Icons.select_all_rounded, color: ThemeColors.of(context).surface, size: 18),
              label: Text(
                'Todos',
                style: TextStyle(
                  color: ThemeColors.of(context).surface,
