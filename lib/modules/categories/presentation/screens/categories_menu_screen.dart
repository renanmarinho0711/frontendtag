...
class _CategoriasMenuScreenState extends ConsumerState<CategoriasMenuScreen> with ResponsiveCache {
  ...
  Widget build(BuildContext context) {
    // Responsividade dispon�vel via ResponsiveHelper se necess�rio
    return PopScope(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Organize produtos em categorias para facilitar a gest�o e navega��o do seu cat�logo.',
                  style: TextStyle(
                    fontSize: ResponsiveHelper.getResponsiveFontSize(
                      context,
                      baseFontSize: 11,
  ...
  Widget _buildStatsCards(BuildContext context) {
    ...
    final estatisticas = [
      ...
      {'label': 'Perec�veis', 'valor': '189', 'icon': Icons.dining_rounded, 'cor': ThemeColors.of(context).greenMaterial, 'mudanca': '+7', 'tipo': 'aumento'},
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        final opcoes = [
          ...
          {
            'titulo': 'Administra��o Completa',
            'subtitulo': 'Controle total e avan�ado',
          ...
          {
            'titulo': 'Estat�sticas',
            'subtitulo': 'An�lises e relat�rios',
