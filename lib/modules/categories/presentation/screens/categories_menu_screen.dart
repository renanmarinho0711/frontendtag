...
class _CategoriasMenuScreenState extends ConsumerState<CategoriasMenuScreen> with ResponsiveCache {
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: colors.blueCyan.withValues(alpha: 0.2),
              borderRadius: BorderRadius.circular(
                ResponsiveHelper.getResponsiveBorderRadius(
                  context,
                  mobile: 8,
              ...
              border: Border.all(color: colors.blueCyan.withValues(alpha: 0.4)),
            ),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [colors.infoPastel, colors.primaryPastel],
        ),
        borderRadius: BorderRadius.circular(
          isMobile ? 12 : 14,
        ),
  ...
  Widget _buildStatsCards(BuildContext context) {
    ...
    final estatisticas = [
      {'label': 'Bebidas', 'valor': '247', 'icon': Icons.local_drink_rounded, 'cor': colors.blueMaterial, 'mudanca': '+5', 'tipo': 'aumento'},
      {'label': 'Mercearia', 'valor': '532', 'icon': Icons.shopping_basket_rounded, 'cor': colors.brownMain, 'mudanca': '+18', 'tipo': 'aumento'},
      {'label': 'Perecãveis', 'valor': '189', 'icon': Icons.dining_rounded, 'cor': colors.greenMaterial, 'mudanca': '+7', 'tipo': 'aumento'},
      {'label': 'Limpeza', 'valor': '156', 'icon': Icons.clean_hands_rounded, 'cor': colors.blueCyan, 'mudanca': '+3', 'tipo': 'aumento'},
    ];
        ...
        final opcoes = [
          {
            ...
            'gradiente': [colors.categoryVisualizar, colors.categoryVisualizarDark],
          ...
          },
          {
            ...
            'gradiente': [colors.categoryNova, colors.categoryNovaDark],
          ...
          },
          {
            ...
            'gradiente': [colors.categoryProdutos, colors.categoryProdutosDark],
          ...
          },
          {
            ...
            'gradiente': [colors.categoryAdmin, colors.categoryAdminDark],
          ...
          },
          {
            ...
            'gradiente': [colors.categoryStats, colors.categoryStatsDark],
          ...
          },
          {
            ...
            'gradiente': [colors.categoryImportExport, colors.categoryImportExportDark],
            'destino': null,
          },
        ];
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: colors.surfaceOverlay50),
                    ),
                    child: Text(
        ...
        title: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [colors.yellowGold, colors.warning],
                ),
                borderRadius: BorderRadius.circular(8),
              ),
              child: Icon(Icons.import_export_rounded, color: colors.surface, size: 24),
            ),
          ...
          children: [
            ListTile(
              leading: Container(
                ...
                child: Icon(Icons.upload_rounded, color: colors.infoDark),
              ),
            ...
            ListTile(
              leading: Container(
                padding: const EdgeInsets.all(8),
                decoration: BoxDecoration(
                  color: colors.successPastel,
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Icon(Icons.download_rounded, color: colors.successIcon),
              ),
