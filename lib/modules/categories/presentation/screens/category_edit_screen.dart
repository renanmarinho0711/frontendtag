...
class _CategoriasEditarScreenState extends ConsumerState<CategoriasEditarScreen>
  ...
  final List<Color> _coresDisponiveis = [
    const Color(0xFF2196F3), // blueMaterial
    const Color(0xFF4CAF50), // greenMaterial
    const Color(0xFFFFB300), // yellowGold
    const Color(0xFF00BCD4), // blueCyan
    const Color(0xFF03A9F4), // blueLight
    const Color(0xFF795548), // brownMain
    const Color(0xFF00BCD4), // cyanMain
    const Color(0xFFE53935), // error
  ];
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  _buildSubcategoriesCard(context),
                  SizedBox(
        ...
        children: [
          ...
          if (_alteracoesFeitas)
            Container(
              ...
              decoration: BoxDecoration(
                color: colors.yellowGold.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(
                  isMobile ? 7 : 8,
                ),
  ...
  Widget _buildSubcategoriesCard(BuildContext context) {
    final colors = ThemeColors.of(context);
    final isMobile = ResponsiveHelper.isMobile(context);
    final isTablet = ResponsiveHelper.isTablet(context);
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(
                        color: colors.textSecondaryOverlay60),
                    shape: RoundedRectangleBorder(
