  ...
  Widget _buildStats(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _buildStatItem(context, 'Cr�ticos',
              '$_estoquesCriticos',
              Icons.error_rounded,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: _buildStockInfo(context, 'M�nimo',
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetalheRow(context, 'Estoque M�nimo', '${item.estoqueMinimo} un'),
              _buildDetalheRow(context, 'Estoque M�ximo', '${item.estoqueMaximo} un'),
              _buildDetalheRow(context, 'Status', item.status),
              _buildDetalheRow(context, 'Última Atualiza��o', _formatarData(item.ultimaAtualizacao)),
              const Divider(height: 24),
              _buildDetalheRow(context, 'Valor Unit�rio', _formatarMoeda(item.valorUnitario)),
