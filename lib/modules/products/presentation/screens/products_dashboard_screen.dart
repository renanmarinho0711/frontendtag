...
class _ProdutosDashboardScreenState extends ConsumerState<ProdutosDashboardScreen>
  ...
  /// Carrega prefer�ncia do onboarding
  ...
  /// Salva prefer�ncia do onboarding
  ...
  // Estat�sticas do provider ou valores default
  ...
  // Verifica condi��es para onboarding contextual
  bool get _shouldShowOnboarding {
    if (!_showOnboarding) return false;
    if (_totalProdutos == 0) return true; // Cat�logo vazio
    if (_semTag > 0 && _semTag / _totalProdutos > 0.3) return true; // >30% sem tag
    return false;
  }
  
  String get _onboardingMessage {
    if (_totalProdutos == 0) return 'Comece seu cat�logo adicionando produtos!';
  ...
  /// HEADER - Com sync status, voltar, sincronizar e configura��es
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: Text('Exibir dicas e sugest�es'),
              trailing: Switch(
            ...
            ListTile(
              ...
              title: Text('Sincroniza��o autom�tica'),
  ...
  Widget _buildContextualFAB(BuildContext context) {
    // Se cat�logo vazio, mostrar FAB para adicionar primeiro produto
    if (_totalProdutos == 0) {
      // Se oculto, mostrar apenas bot�o pequeno para reexibir
      ...
      // FAB extendido com bot�o de fechar
      return Row(
        mainAxisSize: MainAxisSize.min,
        children: [
    ...
    // Normal: FAB com menu de a��es r�pidas
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // SEÇÃO 4: Resumo do Cat�logo (5 cards clic�veis)
                  if (isLoading)
                  ...
                  // SEÇÃO 5: A��es R�pidas + Produtos em Destaque (2 colunas)
                  ...
                  // SEÇÃO 7: Mapa do M�dulo (todos os menus dispon�veis)
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Buscar produto, c�digo, categoria...',
                  hintStyle: TextStyle(
  ...
  /// Vers�o expandida para Row (desktop)
        ...
        children: [
          ...
          Center(
            child: TextButton.icon(
              ...
              label: Text('Ver Hist�rico Completo', style: TextStyle(fontSize: 11)),
  ...
  /// SEÇÃO 6: Categorias com Chips e bot�o + Nova
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      'As categorias aparecer�o aqui quando voc� adicionar produtos',
                      style: TextStyle(
                        color: ThemeColors.of(context).textTertiary,
                        fontSize: 12,
                      ),
  ...
  /// SEÇÃO 7: Mapa do M�dulo - Todos os menus dispon�veis em cards pequenos
  Widget _buildMapaModulo(BuildContext context) {
    final isMobile = ResponsiveHelper.isMobile(context);
    final isTablet = ResponsiveHelper.isTablet(context);

    // Lista de todos os menus/telas dispon�veis no m�dulo
    final menus = [
      _ModuloMenuItem(
        titulo: 'Dashboard',
        subtitulo: 'Vis�o geral',
      ...
      _ModuloMenuItem(
        titulo: 'Estoque',
        subtitulo: 'Gest�o de invent�rio',
      ...
      _ModuloMenuItem(
        ...
        onTap: () {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Relat�rios em desenvolvimento'),
        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              // Calcular tamanho do card baseado na largura dispon�vel
              ...
              final cardHeight = cardWidth * 0.85; // Propor��o mais quadrada
...
/// Classe auxiliar para itens do mapa do m�dulo
