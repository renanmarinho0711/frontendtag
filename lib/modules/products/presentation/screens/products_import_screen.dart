...
/// Tela de importa��o em massa de produtos
...
class _ProdutosImportarScreenState extends ConsumerState<ProdutosImportarScreen> 
        ...
        children: [
          Row(
            children: [
              ...
              _buildStepIndicator(context, 4, 'Conclu�do', _step >= 4),
            ],
          ),
          if (_step == 3) ...[
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: AppSpacing.sm),
          _buildInfoItem(context, 'codigo', 'C�digo de barras (m�nimo 8 d�gitos)'),
          _buildInfoItem(context, 'nome', 'Nome do produto (obrigat�rio)'),
          _buildInfoItem(context, 'preco', 'Pre�o unit�rio (formato: 9.99)'),
          ...
          _buildInfoItem(context, 'descricao', 'Descri��o do produto (opcional)'),
        ],
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: _buildStatCard(context, 'V�lidos',
                '$_validosNoPreview',
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              _buildFieldChip(context, 'C�digo', item.codigo),
              _buildFieldChip(context, 'Pre�o', 'R\$ ${item.preco}'),
          ...
          children: [
            Expanded(
              child: OutlinedButton.icon(
                ...
                icon: const Icon(Icons.download_rounded),
                label: const Text('Baixar Relat�rio'),
                style: OutlinedButton.styleFrom(
                  padding: EdgeInsets.symmetric(
                    vertical: AppSizes.paddingLg.get(isMobile, isTablet),
                  ),
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      ...
                      action: SnackBarAction(
                        ...
                        onPressed: () {
                          // Navega para a tela de vincula��o em lote
  ...
  void _selecionarArquivo() async {
    ...
    try {
      ...
      if (file.bytes == null) {
        _showErrorSnackBar('N�o foi poss�vel ler o arquivo');
        return;
      }
      ...
      if (file.extension?.toLowerCase() == 'csv') {
        ...
        _showErrorSnackBar('Por enquanto, apenas arquivos CSV s�o suportados');
        return;
      }
      
      if (records.isEmpty) {
        _showErrorSnackBar('O arquivo n�o cont�m dados v�lidos');
        return;
      }
      
      // Processa dados atrav�s do provider
