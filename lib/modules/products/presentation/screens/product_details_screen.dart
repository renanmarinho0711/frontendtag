...
class _ProdutosDetalhesScreenState extends ConsumerState<ProdutosDetalhesScreen> 
      ...
      child: Column(
        ...
        children: [
          _buildInfoCard(context, title: 'Dados Cadastrais',
            items: [
              _buildInfoItem(context, 'Cãdigo de Barras', _product.codigo, Icons.qr_code_rounded),
              ...
              _buildInfoItem(context, 'Dimensães', '15x15x30 cm', Icons.square_foot_rounded),
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () {},
                    icon: const Icon(Icons.add_rounded),
                    label: const Text('Criar Estratãgia'),
                    style: ElevatedButton.styleFrom(
  ...
  void _showEstoqueDialog({required bool isEntrada}) {
    ...
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(isEntrada ? 'Entrada de Estoque' : 'Saãda de Estoque'),
        content: TextField(
          controller: controller,
  ...
  void _showVendasDialog() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Relatãrio de Vendas'),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: const Text('Produto excluãdo com sucesso'),
