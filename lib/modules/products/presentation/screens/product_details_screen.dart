...
/// Implementa��o conforme PROMOT PRODUTOS.txt
/// Hero section, Quick actions, Tabs (Informa��es, Estoque, Hist�rico, Estrat�gias)
...
class _ProdutosDetalhesScreenState extends ConsumerState<ProdutosDetalhesScreen> 
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        headerSliverBuilder: (context, innerBoxIsScrolled) => [
          // Header com bot�es Voltar, Editar e Menu
          SliverAppBar(
            floating: true,
            pinned: true,
            elevation: 0,
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: AppGradients.fromBaseCol(context)o(context)r(_product.cor),
      ...
      child: Column(
        ...
        children: [
          _buildInfoCard(context, title: 'Dados Cadastrais',
            items: [
              _buildInfoItem(context, 'C�digo de Barras', _product.codigo, Icons.qr_code_rounded),
              ...
              _buildInfoItem(context, 'Dimens�es', '15x15x30 cm', Icons.square_foot_rounded),
          ...
          _buildInfoCard(context, title: 'Datas',
            items: [
              ...
              _buildInfoItem(context, '�ltima Atualiza��o', DateFormat('dd/MM/yyyy HH:mm').format(DateTime.now()), Icons.update_rounded),
            ],
            isMobile: isMobile,
            isTablet: isTablet,
          ),
          SizedBox(height: AppSizes.paddingBase.get(isMobile, isTablet)),
          _buildInfoCard(context, title: 'Descri��o',
            items: [
              Text(
                _product.descricao ?? 'Sem descri��o dispon�vel.',
                style: TextStyle(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Gr�fico de Movimenta��es (placeholder)
          Container(
            height: 200,
            padding: EdgeInsets.all(AppSizes.paddingMd.get(isMobile, isTablet)),
            decoration: BoxDecoration(
  ...
  void _showUnbindTagDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Deseja remover a vincula��o da tag "${_product.tag}" deste produto?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text('Cancelar'),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(context);
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Pre�o atualizado com sucesso')),
              );
            },
            child: Text('Salvar'),
          ),
  ...
  void _showEstoqueDialog({required bool isEntrada}) {
    ...
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(isEntrada ? 'Entrada de Estoque' : 'Sa�da de Estoque'),
        content: TextField(
          controller: controller,
  ...
  void _showVendasDialog() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('Relat�rio de Vendas'),
        content: Text('Funcionalidade em desenvolvimento.\n\nEm breve voc� poder� visualizar o hist�rico de vendas deste produto.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text('Fechar'),
