...
/// Tela de adiãão de novo produto com Wizard de 3 passos
/// Conforme PROMOT PRODUTOS.txt:
/// - Passo 1: Informações Básicas (Cãdigo, Nome, Categoria, Descrição)
...
class _ProdutosAdicionarScreenState extends ConsumerState<ProdutosAdicionarScreen> 
  ...
  List<String> get _categoriasFallback => ['Bebidas', 'Mercearia', 'Perecãveis', 'Limpeza', 'Higiene'];
  ...
  void initState() {
    ...
    // Focus Automático no primeiro campo e carrega categorias apãs build
              ...
              child: Column(
                children: [
                  ...
                  _buildTextField(context, controller: _codigoController,
                    ...
                    label: 'Cãdigo de Barras *',
                    hint: 'Mãnimo 8 dígitos',
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildResumoItem(context, 'Cãdigo de Barras', _codigoController.text, Icons.qr_code_rounded),
          ...
          Container(
            ...
            child: CheckboxListTile(
              ...
              title: Text(
                'Vincular etiqueta ESL apãs criar',
