...
/// Tela de adi��o de novo produto com Wizard de 3 passos
/// Conforme PROMOT PRODUTOS.txt:
/// - Passo 1: Informa��es B�sicas (C�digo, Nome, Categoria, Descri��o)
/// - Passo 2: Pre�o (Pre�o de venda, Pre�o por kg, Custo)
/// - Passo 3: Confirmar (Resumo + op��o de vincular tag)
class ProdutosAdicionarScreen extends ConsumerStatefulWidget {
  final VoidCallback? onBack;
  final ProductModel? initialProduct; // Para duplica��o de produtos
...
class _ProdutosAdicionarScreenState extends ConsumerState<ProdutosAdicionarScreen> 
  ...
  List<String> get _categoriasFallback => ['Bebidas', 'Mercearia', 'Perec�veis', 'Limpeza', 'Higiene'];
  ...
  void initState() {
    ...
    // Inicializa com dados do produto inicial (duplica��o)
    ...
    // Listeners para detectar altera��es
    ...
    // Focus autom�tico no primeiro campo e carrega categorias ap�s build
    ...
    try {
      ...
      if (suggestedState.status == LoadingStatus.success && 
        ...
        setState(() {
          ...
          // Se a categoria atual n�o existir nas carregadas, define a primeira
      ...
      // Fallback silencioso - usa categorias padr�o do CategoryThemes
  ...
  /// Constr�i os chips de categoria usando dados do backend ou fallback
  ...
  void _nextStep() {
    if (_currentStep < _totalSteps - 1) {
      if (_currentStep == 0 && !_step1Valid) {
        _showValidationError('Complete todos os campos obrigat�rios do Passo 1');
        return;
      }
      if (_currentStep == 1 && !_step2Valid) {
        _showValidationError('Informe um pre�o v�lido maior que zero');
        return;
      }
  ...
  Widget _buildProgressIndicator(BuildContext context) {
    ...
    final steps = ['Informa��es', 'Pre�o', 'Confirmar'];
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Toque para abrir a c�mera ou digite manualmente',
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(context, controller: _descricaoController,
                    ...
                    hint: 'Descri��o detalhada do produto',
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Container(
                      padding: AppSizes.productEditIconPadding.toEdgeInsetsAll(isMobile, isTablet),
                      decoration: BoxDecoration(
                        gradient: ModuleGradients.precificaca(context)o(context),
                        borderRadius: isMobile ? AppRadius.sm : AppRadius.sm,
                      ),
                      child: Icon(
                ...
                const SizedBox(height: AppSpacing.sm),
                Text(
                  'Este � o pre�o que ser� exibido na etiqueta ESL',
                  style: _responsiveTextStyle(AppTextStyles.caption.copyWith(
                    color: ThemeColors.of(context).textSecondary,
                  )),
                ),
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildResumoItem(context, 'C�digo de Barras', _codigoController.text, Icons.qr_code_rounded),
                ...
                _buildResumoItem(context, 'Pre�o', 'R\$ ${preco.toStringAsFixed(2)}', Icons.attach_money_rounded),
                if (precoKg != null)
                  _buildResumoItem(context, 'Pre�o/Kg', 'R\$ ${precoKg.toStringAsFixed(2)}', Icons.monitor_weight_rounded),
                if (_descricaoController.text.isNotEmpty)
                  _buildResumoItem(context, 'Descri��o', _descricaoController.text, Icons.description_rounded),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: CheckboxListTile(
              ...
              title: Text(
                'Vincular etiqueta ESL ap�s criar',
                style: _responsiveTextStyle(AppTextStyles.body.copyWith(
                  fontWeight: FontWeight.w600,
                )),
              ),
              subtitle: Text(
                'Abrir tela de vincula��o de tags automaticamente',
                style: _responsiveTextStyle(AppTextStyles.caption.copyWith(
                  color: ThemeColors.of(context).textSecondary,
                )),
              ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.check_rounded, color: ThemeColors.of(context).blueMain),
                const SizedBox(width: AppSpacing.md),
                Expanded(
                  child: Text(
  ...
  Widget _buildDiscardDialog(BuildContext context) {
    return AlertDialog(
      ...
      content: const Text(
        'Voc� tem dados n�o salvos. Deseja descartar todas as altera��es?',
        textAlign: TextAlign.center,
      ),
      actions: [
        TextButton(
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            const SizedBox(width: AppSpacing.md),
            const Expanded(
              child: Text('Scanner de c�digo de barras em desenvolvimento. Digite o c�digo manualmente.'),
            ),
          ],
        ),
        backgroundColor: ThemeColors.of(context).blueMain,
