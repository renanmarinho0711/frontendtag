...
class _ProdutosListaScreenState extends ConsumerState<ProdutosListaScreen> 
  ...
  void _showBatchBindTagsDialog() {
    // Navega para tela de associa��o QR com contexto de batch
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  success 
                    ? 'Pre�o atualizado para ${productIds.length} produtos'
                    : 'Erro ao atualizar pre�os',
                ),
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      deletedCount > 0 
                        ? '$deletedCount produtos exclu�dos'
  ...
  void _onScroll() {
    // Scroll para carregar mais (pagina��o infinita)
  ...
  List<ProductModel> _sortProducts(List<ProductModel> products) {
    ...
    switch (_sortMode) {
      ...
      case 'preco_decrescente':
        ...
        break;
      case 'recentes':
        // Mant�m ordem original (mais recentes primeiro)
        break;
    }
    return sorted;
  }
  ...
  Widget build(BuildContext context) {
            ...
            RefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  if (hasError)
                    SliverToBoxAdapter(child: _buildErrorState(context, state.error)),
    ...
    // Modo standalone com Navigator pr�prio
    return PopScope(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Gest�o de cat�logo e precifica��o',
                  style: TextStyle(
                    fontSize: AppTextStyles.fontSizeSmAlt.get(isMobile, isTablet),
                    color: AppGradients.overlayWhite8(context)0(context),
                    letterSpacing: 0.2,
                  ),
                  overflow: TextOverflow.ellipsis,
                ),
          ...
          if (!isMobile) ...[
            _buildCompactStat(context, '$_totalProdutos',
              Icons.inventory_2_rounded,
              ThemeColors.of(context).infoLight,
              () => _applyQuickFilter('total'),
            ),
            const SizedBox(width: AppSpacing.sm),
            _buildCompactStat(context, '$_produtosComTag',
              Icons.label_rounded,
              ThemeColors.of(context).success,
              () => _applyQuickFilter('com_tag'),
            ),
            const SizedBox(width: AppSpacing.sm),
            _buildCompactStat(context, '$_produtosSemTag',
  ...
  Widget _buildCompactStat(BuildContext context, String value, IconData icon, Color color, VoidCallback onTap) {
    final isMobile = MediaQuery.of(context).size.width < 600;
    final isTablet = MediaQuery.of(context).size.width >= 600 && 
                     MediaQuery.of(context).size.width < 900;
  ...
  Widget _buildInfoCard(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: AppGradients.strategyDetai(context)l(context),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Gerencie seu cat�logo completo de produtos com controle de pre�os, estoque, categorias e associa��o autom�tica com etiquetas eletr�nicas.',
                  style: TextStyle(
            ...
            children: [
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  items: ['Todas', 'Bebidas', 'Mercearia', 'Perec�veis', 'Limpeza', 'Higiene']
      ...
      child: Wrap(
        ...
        children: [
          if (state.filterCategoria != 'Todas')
            _buildFilterChip(context, 'Categoria: ${state.filterCategoria}',
              () => _productsNotifier.setFilterCategoria('Todas'),
            ),
          if (state.filterStatus != 'Todos')
            _buildFilterChip(context, 'Status: ${state.filterStatus}',
  ...
  Widget _buildProductsList(BuildContext context, bool isLoading, List<ProductModel> products) {
    final isMobile = MediaQuery.of(context).size.width < 600;
    final isTablet = MediaQuery.of(context).size.width >= 600 && 
                     MediaQuery.of(context).size.width < 900;
          ...
          (context, index) {
            if (index < sortedProducts.length) {
              return RepaintBoundary(
                child: _buildProductCard(context, sortedProducts[index], index),
              );
            } else if (_isLoadingMore) {
              // Indicador de loading na pagina��o
              return Container(
  ...
  Widget _buildProductCard(BuildContext context, ProductModel produto, int index) {
    final isMobile = MediaQuery.of(context).size.width < 600;
    final isTablet = MediaQuery.of(context).size.width >= 600 && 
                     MediaQuery.of(context).size.width < 900;
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  // Checkbox 24x24 quando em modo de sele��o
                  if (_isSelectionMode) ...[
                    SizedBox(
                      width: 24,
                      height: 24,
                                ...
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    ...
                                    errorBuilder: (_, __, ___) => Container(
                                      ...
                                      height: 200,
                                      decoration: BoxDecoration(
                                        gradient: AppGradients.fromBaseCol(context)o(context)r(produto.cor),
                                        borderRadius: BorderRadius.circular(12),
                                      ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      // Status de sincroniza��o Minew
                      if (produto.syncWithMinew) ...[
                        SizedBox(height: AppSizes.paddingXxs.get(isMobile, isTablet)),
                        _buildMinewSyncBadge(context, produto, isMobile, isTablet),
                      ],
                  ...
                  _buildProductMenu(context, produto),
                ],
              ),
            ),
          ),
  ...
  Widget _buildProductMenu(BuildContext context, ProductModel produto) {
    final isMobile = MediaQuery.of(context).size.width < 600;
    final isTablet = MediaQuery.of(context).size.width >= 600 && 
                     MediaQuery.of(context).size.width < 900;
  ...
  /// Constr�i badge de status de sincroniza��o Minew
  Widget _buildMinewSyncBadge(BuildContext context, ProductModel produto, bool isMobile, bool isTablet) {
    final Color bgColor;
  ...
  void _showUnbindTagDialog(ProductModel produto) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Deseja remover a vincula��o da tag "${produto.tag}" do produto "${produto.nome}"?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Cancelar'),
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              // Implementa��o da desvincula��o via provider
              if (produto.tag != null) {
  ...
  void _duplicateProduct(ProductModel produto) async {
    ...
    // Navega para edi��o para o usu�rio ajustar antes de salvar
    Navigator.of(context).push(
      MaterialPageRoute(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Bot�es de a��o
            if (isInitialEmpty) ...[
              // Bot�o principal - Importar
              SizedBox(
                width: isMobile ? double.infinity : 280,
                child: ElevatedButton.icon(
                  onPressed: () {
                    // Navegar para importa��o
                    Navigator.of(context).push(
                      MaterialPageRoute(
              ...
              // Bot�o secund�rio - Adicionar manualmente
              SizedBox(
                width: isMobile ? double.infinity : 280,
              ...
              // Bot�es para resultado de busca vazio
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  OutlinedButton.icon(
  ...
  void _showDeleteDialog(ProductModel produto) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Confirmar Exclus�o', style: TextStyle(fontSize: AppTextStyles.fontSizeXlAlt.get(isMobile, isTablet))),
        content: Text(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Text('Produto Exclu�do!', style: TextStyle(fontWeight: FontWeight.bold, fontSize: AppTextStyles.fontSizeBase.get(isMobile, isTablet))),
  ...
  Widget _buildSelectionHeader(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: AppGradients.greenProduc(context)t(context),
        borderRadius: AppRadius.lg,
        boxShadow: AppShadows.elevatedCard,
      ),
      child: Row(
        children: [
          ...
          if (selectedCount < totalProducts)
            ...
            TextButton.icon(
              ...
              icon: Icon(Icons.deselect_rounded, color: ThemeColors.of(context).surface, size: 18),
              label: Text(
                'Limpar',
                style: TextStyle(
                  color: ThemeColors.of(context).surface,
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        child: Row(
          children: [
            // Vincular Tags
            _buildBatchActionButton(context, icon: Icons.link_rounded,
              label: 'Vincular',
              color: ThemeColors.of(context).brandPrimaryGreen,
            ...
            const SizedBox(width: AppSpacing.sm),
            // Editar Pre�os
            _buildBatchActionButton(context, icon: Icons.attach_money_rounded,
              label: 'Pre�os',
            ...
            const SizedBox(width: AppSpacing.sm),
            // Alterar Categoria
            _buildBatchActionButton(context, icon: Icons.category_rounded,
              label: 'Categoria',
            ...
            const Spacer(),
            // Excluir
            _buildBatchActionButton(context, icon: Icons.delete_rounded,
              label: 'Excluir',
...
// Dialog para edi��o de pre�o em lote
...
class _BatchPriceDialogState extends State<_BatchPriceDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Editar Pre�os em Lote'),
      content: Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: _priceMode == 'fixed' ? 'Novo Pre�o (R\$)' : 'Porcentagem (%)',
...
// Dialog para altera��o de categoria em lote
