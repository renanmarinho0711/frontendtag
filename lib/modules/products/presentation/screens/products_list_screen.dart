...
class _ProdutosListaScreenState extends ConsumerState<ProdutosListaScreen> 
  ...
  void _showBatchChangeCategoryDialog() {
    ...
    // Extrai categorias ãnicas dos produtos carregados
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      deletedCount > 0 
                        ? '$deletedCount produtos excluãdos'
  ...
  List<ProductModel> _sortProducts(List<ProductModel> products) {
    ...
    switch (_sortMode) {
      ...
      case 'preco_decrescente':
        ...
        break;
      case 'recentes':
        // Mantãm ordem original (mais recentes primeiro)
        break;
    }
    return sorted;
  }

  // Estatãsticas do provider
            ...
            children: [
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  items: ['Todas', 'Bebidas', 'Mercearia', 'Perecãveis', 'Limpeza', 'Higiene']
  ...
  void _duplicateProduct(ProductModel produto) async {
    // Cria cãpia do produto com novo ID
    final duplicatedProduct = ProductModel(
      id: '', // Serã gerado pelo backend
      codigo: '${produto.código}_copy',
      nome: 'Cãpia de ${produto.nome}',
      preco: produto.preco,
        ...
        child: Column(
          ...
          children: [
            ...
            if (isInitialEmpty) ...[
              ...
              // Botães para resultado de busca vazio
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  OutlinedButton.icon(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Text('Produto Excluãdo!', style: TextStyle(fontWeight: FontWeight.bold, fontSize: AppTextStyles.fontSizeBase.get(isMobile, isTablet))),
