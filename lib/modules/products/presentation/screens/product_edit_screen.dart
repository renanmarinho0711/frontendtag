...
class _ProdutosEditarScreenState extends ConsumerState<ProdutosEditarScreen> 
  ...
  Widget _buildTagCard(BuildContext context) {
    ...
    return Container(
      padding: AppSizes.productEditCardPadding.toEdgeInsetsAll(isMobile, isTablet),
      decoration: BoxDecoration(
        gradient: hasTag ? AppGradients.succes(context)s(context) : AppGradients.aler(context)t(context),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildTagInfo(context, 'Status', '🟢 Online'),
                  const SizedBox(height: AppSpacing.sm),
                  _buildTagInfo(context, 'Última Sincroniza��o', 
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: ['Bebidas', 'Mercearia', 'Perec�veis', 'Limpeza', 'Higiene']
          ...
          Row(
            children: [
              ...
              if (_historicoPrecos.isNotEmpty)
                Text(
                  '${_historicoPrecos.length} altera��es',
                  style: _responsiveTextStyle(AppTextStyles.caption.copyWith(
                    color: ThemeColors.of(context).textSecondary,
                  )),
                ),
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text(
                    _expandirHistorico 
                        ? 'Ver Menos' 
                        : 'Ver Hist�rico Completo (${_historicoPrecos.length})',
                  ),
                  style: OutlinedButton.styleFrom(
                    padding: EdgeInsets.symmetric(
                      vertical: AppSizes.formButtonPaddingVertical.get(isMobile, isTablet),
  ...
  Widget _buildDiscardDialog(BuildContext context) {
    return AlertDialog(
      ...
      content: const Text(
        'Voc� tem altera��es n�o salvas. Deseja descartar todas as altera��es?',
  ...
  Future<void> _salvarProduto() async {
    ...
    try {
      ...
      await Future.delayed(const Duration(seconds: 1)); // Simula��o
  ...
  void _desassociarTag() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'O produto ficar� sem uma tag associada e n�o ser� atualizado automaticamente.',
          textAlign: TextAlign.center,
        ),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(context);
              // TODO: Implementar desassocia��o via provider
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
