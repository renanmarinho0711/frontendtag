...
class _ProdutosAssociarQRScreenState extends ConsumerState<ProdutosAssociarQRScreen> 
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text(isTag ? 'Inserir Tag' : 'Inserir Cãdigo'),
          ],
        ),
        content: Column(
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                hintText: isTag ? 'MAC da tag (ex: AA:BB:CC:DD:EE:FF)' : 'Cãdigo de barras (EAN)',
  ...
  Future<void> _importarProdutoGlobal(GlobalProduct globalProduct, double preco) async {
    ...
    try {
      // Obtãm storeId do contexto atual via provider
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'O código "$código" não foi encontrado na sua loja nem no catálogo global.',
        ...
        actions: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              Navigator.pop(context);
              // Navega para tela de cadastro com código prã-preenchido
  ...
  Future<void> _desvincularTag(ProductModel produto) async {
    final confirmar = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Deseja desvincular a tag do produto "${produto.nome}"?\n\nA tag ficarã disponível para vincular a outro produto.',
          textAlign: TextAlign.center,
        ),
        actions: [
          TextButton(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: AppSpacing.lg),
          // Conteãdo baseado no passo atual
    ...
    return Column(
      children: [
        ...
        QrScanArea(
          ...
          label: 'Posicione a tag na ãrea de leitura',
          primaryColor: ThemeColors.of(context).blueMaterial,
