...
/// Widget de Scanner de C�digo de Barras usando a c�mera do dispositivo
/// 
...
///     print('C�digo detectado: $barcode');
...
class _BarcodeScannerWidgetState extends State<BarcodeScannerWidget>
  ...
  void _onBarcodeDetected(BarcodeCapture capture) {
    if (_hasDetected) return; // Evita m�ltiplas detec��es
