...
class ProductCard extends StatelessWidget {
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  _buildProductIcon(context, isMobile, isTablet),
                  SizedBox(width: AppSizes.paddingMd.get(isMobile, isTablet)),
                  Expanded(
                    child: _buildProductInfo(context, isMobile, isTablet, hasTag),
                  ),
                  _buildPriceSection(context, isMobile, isTablet),
  ...
  Widget _buildProductIcon(BuildContext context, bool isMobile, bool isTablet) {
    return Container(
  ...
  Widget _buildProductInfo(BuildContext context, bool isMobile, bool isTablet, bool hasTag) {
    return Column(
      ...
      children: [
        ...
        _buildTagBadge(context, hasTag, isMobile, isTablet),
      ],
    );
  }

  Widget _buildTagBadge(BuildContext context, bool hasTag, bool isMobile, bool isTablet) {
    if (hasTag) {
      return Container(
        padding: EdgeInsets.symmetric(
          horizontal: AppSizes.paddingXsAlt3.get(isMobile, isTablet),
  ...
  Widget _buildPriceSection(BuildContext context, bool isMobile, bool isTablet) {
    return Column(
