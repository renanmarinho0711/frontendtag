...
/// @deprecated Use [ProdutoRepository] ao inv�s desta classe.
/// Esta classe usava dados mockados locais.
/// A aplica��o agora usa ProdutoRepository para comunica��o com o backend.
/// 
/// ATEN��O: Esta classe ser� removida em vers�es futuras.
/// Migre para: `import 'package:tagbean/features/products/data/repositories/products_repository.dart';`
@Deprecated('Use ProdutoRepository para comunica��o com o backend. Esta classe ser� removida.')
class ProdutoService {
  ...
  // Produtos iniciais para demonstra��o
