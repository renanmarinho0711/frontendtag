...
class ProductModel {
  ...
  const ProductModel({
    ...
    this.cor = ThemeColors.of(context).blueMaterial,
...
class StockItemModel {
  ...
  Color get statusColor {
    if (esgotado || estoqueAtual <= 0) return ThemeColors.of(context).error;
    if (emAlerta || estoqueAtual <= estoqueMinimo) return ThemeColors.of(context).warning;
    return ThemeColors.of(context).success;
  }
