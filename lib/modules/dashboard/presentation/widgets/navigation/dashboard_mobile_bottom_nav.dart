...
/// 
/// Extra�do de dashboard_screen.dart para modulariza��o
class DashboardMobileBottomNav extends StatelessWidget {
  ...
  /// Auto-scroll para o item selecionado com navega��o inteligente
  /// Quando clicar no �ltimo vis�vel � direita/esquerda, avan�a 3 itens
  void _autoScrollToItem(int index) {
    ...
    const visibleItems = 4; // n�mero aproximado de itens vis�veis

    // Verificar se clicou em um dos �ltimos vis�veis � direita
    final currentOffset = scrollController.offset;
    final maxScroll = scrollController.position.maxScrollExtent;
    final viewportWidth = scrollController.position.viewportDimension;
    
    // Calcular posi��o do item
    final itemOffset = index * itemWidth;
    
    // Se clicar em um item n�o totalmente vis�vel � direita, avan�ar 3 itens
    ...
    // Se clicar em um item n�o totalmente vis�vel � esquerda, retroceder 3 itens
    ...
    // Caso contr�rio, centralizar o item selecionado
    else {
