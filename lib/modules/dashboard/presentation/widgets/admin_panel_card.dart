...
/// Mostra op��es de gest�o baseadas na role do usu�rio:
/// - PlatformAdmin: Gerenciar Clientes, Todas as Lojas, Todos os Usu�rios
/// - ClientAdmin: Gerenciar Lojas, Gerenciar Usu�rios
/// - StoreManager: Gerenciar Usu�rios da Loja
    ...
    actions.add(
      Expanded(
        child: _buildActionButton(
          ...
          subtitle: isPlatformAdmin ? 'Vis�o global' : 'Lojas da empresa',
          onTap: onGerenciarLojas,
        ),
      ),
    );
