            ...
            Column(
              ...
              children: [
                ...
                _buildHorizontalActionCard(
                  ...
                  gradient: [ThemeColors.of(context).blueCyan, ThemeColors.of(context).blueMaterial],
                ...
                _buildHorizontalActionCard(
                  ...
                  gradient: [ThemeColors.of(context).tealMain, ThemeColors.of(context).greenMaterial],
                  onTap: onSincronizar,
                ),
                SizedBox(height: AppSizes.paddingBase.get(isMobile, isTablet)),
                _buildHorizontalActionCard(
                  ...
                  label: 'Relat�rios',
                  subtitle: 'Visualizar an�lises e m�tricas',
