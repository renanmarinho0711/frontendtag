...
/// Mostra o estado geral do sistema em um �nico olhar
    ...
    return Wrap(
      ...
      children: [
        ...
        _buildStatusCard(
          ...
          title: 'Produtos',
          subtitle: produtosSemPreco > 0 ? '$produtosSemPreco sem pre�o' : 'Todos OK',
      ...
      child: Row(
        ...
        Expanded(
          child: _buildStatusCard(
            ...
            iconColor: produtosSemPreco > 0 ? ThemeColors.of(context).orangeMaterial : ThemeColors.of(context).greenMaterial,
            title: 'Produtos',
            subtitle: produtosSemPreco > 0 ? '$produtosSemPreco sem pre�o' : 'Todos com pre�o',
            actionLabel: produtosSemPreco > 0 ? 'Corrigir' : null,
            onAction: produtosSemPreco > 0 ? onCorrigirProdutos : null,
          ),
        ),
