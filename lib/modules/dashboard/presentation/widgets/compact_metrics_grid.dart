...
class CompactMetricsGrid extends ConsumerWidget {
  ...
  /// Formata n�mero para exibi��o (ex: 1234 -> 1.234)
  ...
  /// Constr�i a lista de estat�sticas a partir dos dados reais
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Construir estat�sticas a partir dos dados reais
