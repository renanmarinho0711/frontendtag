...
/// Card de Primeiros Passos - Guia usu�rios novos pelo sistema
/// Substitui o card de "Atalhos R�pidos" que tinha conflitos com o navegador
class OnboardingStepsCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Se est� carregando ou tem erro, n�o mostrar
    ...
    // Se todos os passos estiverem conclu�dos, n�o mostrar o card
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              // Bot�o de a��o para pr�ximo passo
              if (isNext) ...[
