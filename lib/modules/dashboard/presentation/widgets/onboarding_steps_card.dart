...
/// Substitui o card de "Atalhos Rãpidos" que tinha conflitos com o navegador
class OnboardingStepsCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Se estã carregando ou tem erro, não mostrar
    ...
    // Se todos os passos estiverem concluãdos, não mostrar o card
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              // Botão de Ação para prãximo passo
              if (isNext) ...[
