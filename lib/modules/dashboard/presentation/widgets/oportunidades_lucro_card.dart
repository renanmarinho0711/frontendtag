...
/// Card de Oportunidades de Lucro (Sugest�es IA reestruturado)
/// Mostra oportunidades de ajuste de pre�o identificadas pela IA
class OportunidadesLucroCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Obt�m dados de sugest�es da IA
