...
/// Enumera��o para severidade de alertas
enum AlertaSeveridade {
  critico, // Vermelho - A��o imediata
...
/// Card de alertas acion�veis com hierarquia de cores e a��es diretas
...
class AlertasAcionaveisCard extends ConsumerStatefulWidget {
  ...
  // Callbacks para a��es de navega��o
...
class _AlertasAcionaveisCardState extends ConsumerState<AlertasAcionaveisCard> {
  ...
  List<AlertaAcionavel> _buildAlertasFromProvider(List<DashboardAlert> providerAlerts) {
    ...
    for (final alert in providerAlerts) {
      ...
      } else if (alertType.contains('price') || alertType.contains('preco') || alertType.contains('pre�o')) {
    ...
    // Erros de Sync - CR�TICO
    if (errosSync > 0) {
      alertas.add(AlertaAcionavel(
        id: 'sync_error',
        severidade: AlertaSeveridade.critico,
        titulo: '$errosSync erros de sincroniza��o',
    ...
    // Produtos sem pre�o - ATEN��O
    if (produtosSemPreco > 0) {
      alertas.add(AlertaAcionavel(
        id: 'sem_preco',
        severidade: AlertaSeveridade.atencao,
        titulo: '$produtosSemPreco produtos sem pre�o',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${alertasAtivos.length} ${alertasAtivos.length == 1 ? 'item requer' : 'itens requerem'} aten��o',
                        style: TextStyle(
                          fontSize: 12,
          ...
          // Lista de alertas
          ...alertasVisiveis.map((alerta) => _buildAlertaItem(context, alerta, isMobile, isTablet)),
  ...
  Widget _buildAlertaItem(BuildContext context, AlertaAcionavel alerta, bool isMobile, bool isTablet) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Flexible(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(icone, color: ThemeColors.of(context).surface, size: 14),
          ...
          // Bot�es de a��o em container flex�vel
          Flexible(
            flex: 0,
            child: Row(
              mainAxisSize: MainAxisSize.min,
