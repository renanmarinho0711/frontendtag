...
/// Card de alertas acioníveis com hierarquia de cores e ações diretas
/// Sã aparece se houver alertas - Mostra no máximo 3 alertas crãticos primeiro
...
class _AlertasAcionaveisCardState extends ConsumerState<AlertasAcionaveisCard> {
  ...
  List<AlertaAcionavel> _buildAlertasFromProvider(List<DashboardAlert> providerAlerts) {
    // Converte os alertas do provider para o novo formato acionível
    ...
    // Ordena por severidade (crãtico primeiro)
  ...
  Widget build(BuildContext context) {
    ...
    // Obtãm alertas do provider ou usa customizados
    ...
    // Se não hã alertas, não mostra o card
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Botães de Ação em container flexãvel
          Flexible(
            flex: 0,
            child: Row(
              mainAxisSize: MainAxisSize.min,
