...
/// Acelera opera��es para usu�rios frequentes
class AtalhosRapidosCard extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _buildShortcut(context, 'Ctrl+P', 'Novo Produto', onNovoProduto),
              _buildShortcut(context, 'Ctrl+T', 'Nova Tag', onNovaTag),
              _buildShortcut(context, 'Ctrl+V', 'Vincular', onVincular),
              _buildShortcut(context, 'Ctrl+S', 'Sincronizar', onSincronizar),
              _buildShortcut(context, 'Ctrl+B', 'Buscar', onBuscar),
              _buildShortcut(context, 'F5', 'Atualizar', onAtualizar),
            ],
          ),
        ],
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _buildGesture(context, Icons.swipe_right_rounded, 'Deslizar ?', 'Menu'),
              _buildGesture(context, Icons.swipe_down_rounded, 'Deslizar ?', 'Atualizar'),
              _buildGesture(context, Icons.touch_app_rounded, '2 toques', 'Busca'),
            ],
          ),
        ],
      ),
  ...
  Widget _buildShortcut(BuildContext context, String keys, String action, VoidCallback? onTap) {
    return InkWell(
      onTap: onTap,
  ...
  Widget _buildGesture(BuildContext context, IconData icon, String gesture, String action) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
      child: Row(
        mainAxisSize: MainAxisSize.min,
  ...
  void _showAllShortcuts(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            Icon(Icons.keyboard_rounded, color: ThemeColors.of(context).greenMaterial),
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildShortcutCategory('Navega��o', [
                ('Ctrl+1-9', 'Ir para se��o'),
                ('Ctrl+D', 'Dashboard'),
                ('Esc', 'Fechar di�logo'),
              ]),
              const Divider(height: 24),
              _buildShortcutCategory('A��es R�pidas', [
                ('Ctrl+P', 'Novo Produto'),
                ('Ctrl+T', 'Nova Tag'),
                ('Ctrl+V', 'Vincular Tag'),
                ('Ctrl+S', 'Sincronizar'),
