...
/// Detecta situa��es e sugere pr�ximos passos automaticamente
class FluxosInteligentesCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final fluxos = _getFluxosPendentes(dashboardState);
    
    // Se n�o h� fluxos, n�o mostrar o card
    if (fluxos.isEmpty) {
  ...
  List<_FluxoInteligente> _getFluxosPendentes(DashboardState state) {
    ...
    if (produtosSemTag > 0) {
      fluxos.add(_FluxoInteligente(
        ...
        descricao: 'Vincule tags para exibir pre�os nos displays',
        acoes: [
    ...
    if (tagsNaoVinculadas > 0) {
      fluxos.add(_FluxoInteligente(
        ...
        titulo: '$tagsNaoVinculadas ${tagsNaoVinculadas == 1 ? "tag n�o vinculada" : "tags n�o vinculadas"}',
    ...
    if (importacoesComErro > 0) {
      fluxos.add(_FluxoInteligente(
        ...
        titulo: 'Importa��o com $importacoesComErro ${importacoesComErro == 1 ? "erro" : "erros"}',
        descricao: 'Alguns produtos n�o foram importados corretamente',
        acoes: [
    ...
    if (produtosSemPreco > 0) {
      fluxos.add(_FluxoInteligente(
        ...
        titulo: '$produtosSemPreco ${produtosSemPreco == 1 ? "produto" : "produtos"} sem pre�o definido',
        descricao: 'Defina pre�os para exibir nos displays',
        acoes: [
          _FluxoAcao('Definir Pre�os', null, principal: true),
