...
/// Card de Atividade Recente - Mostra hist�rico de a��es no sistema
...
class _RecentActivityDashboardCardState extends ConsumerState<RecentActivityDashboardCard> {
  ...
  Widget build(BuildContext context) {
    ...
    // Converte relat�rios de auditoria em atividades
  ...
  /// Converte dados de auditoria em formato de atividades para exibi��o
  ...
  IconData _getIconForType(String tipo) {
    ...
    } else if (tipoLower.contains('pre�o') || tipoLower.contains('price') || tipoLower.contains('precifica')) {
      return Icons.attach_money_rounded;
    } else if (tipoLower.contains('estrat�gia') || tipoLower.contains('strategy')) {
    ...
    } else if (tipoLower.contains('login') || tipoLower.contains('auth') || tipoLower.contains('usu�rio')) {
  ...
  Color _getColorForType(String tipo, bool hasProblems) {
    ...
    } else if (tipoLower.contains('pre�o') || tipoLower.contains('price')) {
      return ThemeColors.of(context).greenMaterial;
    } else {
      return ThemeColors.of(context).blueMaterial;
    }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'As a��es do sistema aparecer�o aqui',
            style: TextStyle(
              fontSize: 11,
