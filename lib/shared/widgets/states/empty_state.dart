...
class EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = iconColor ?? ThemeColors.of(context).grey400;
...
/// verṣo compacta do EmptyState para listas inline
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(icon, size: 20, color: ThemeColors.of(context).grey400),
