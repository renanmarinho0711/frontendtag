  ...
  Widget build(BuildContext context) {
    ...
    final gradient = widget.gradientColors != null
        ...
        : LinearGradient(
            ...
            colors: [baseColor, Color.alphaBlend(baseColor.withValues(alpha: 0.8), colors.surface)],
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: widget.isDisabled ? colors.grey200 : null,
            ...
            boxShadow: widget.isDisabled
                ...
                : [
                    ...
                    BoxShadow(
                      ...
                      color: Color.alphaBlend(baseColor.withValues(alpha: _isPressed ? 0.2 : 0.3), colors.surface),
            ...
            children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: widget.isDisabled ? colors.surfaceOverlay50 : colors.surfaceOverlay20,
                    ...
                    child: Icon(
                      ...
                      color: widget.isDisabled ? colors.grey600 : colors.surface,
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: widget.isDisabled ? colors.grey700 : colors.surface,
...
class InfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cardColors = _getColors(themeColors);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: cardColors.$2),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: Color.alphaBlend(cardColors.$3.withValues(alpha: 0.2), themeColors.surface),

              borderRadius: BorderRadius.circular(8),

            ),

            child: Icon(icon, color: cardColors.$3, size: 20),
                ...
                if (description != null) ...[
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: Color.alphaBlend(cardColors.$3.withValues(alpha: 0.8), themeColors.surface),
          ...
          if (onDismiss != null)
            ...
            IconButton(
              ...
              icon: Icon(Icons.close, size: 18, color: cardColors.$3),
  ...
  (Color, Color, Color) _getColors(ThemeColorsData colors) {
