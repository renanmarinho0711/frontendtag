...
/// Banner de dica que pode ser dispensado pelo usuário
      ...
      child: FadeTransition(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: Color.alphaBlend(colors.surface.withValues(alpha: 0.92), color),

            borderRadius: BorderRadius.circular(12),

            border: Border.all(color: Color.alphaBlend(colors.surface.withValues(alpha: 0.7), color)),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color.alphaBlend(colors.surface.withValues(alpha: 0.85), color),
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Color.alphaBlend(colors.surfaceOverlay10, color),
              ...
              IconButton(
                ...
                icon: Icon(Icons.close_rounded, size: 18, color: Color.alphaBlend(colors.surface.withValues(alpha: 0.4), color)),
...
/// Card de onboarding para novos Usuários
...
class OnboardingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = gradientColors ?? [colors.moduleDashboard, colors.moduleDashboardDark];
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          BoxShadow(
            ...
            color: Color.alphaBlend(colors.surface.withValues(alpha: 0.7), gradient.first),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: colors.surfacePastel,

              borderRadius: BorderRadius.circular(16),

            ),

            child: Icon(icon, size: 40, color: colors.surface),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: Color.alphaBlend(colors.neutralBlack.withValues(alpha: 0.1), colors.surface),
                  ...
                  child: TextButton(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Color.alphaBlend(colors.neutralBlack.withValues(alpha: 0.2), colors.surface),
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      ...
                      BoxShadow(
                        ...
                        color: Color.alphaBlend(colors.surfaceOverlay60, colors.primary),
