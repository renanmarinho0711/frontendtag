...
class _AppPasswordFieldState extends State<AppPasswordField> {
  ...
  Color _getStrengthColor() {
    if (_passwordStrength < 0.3) return ThemeColors.of(context).redMain;
    if (_passwordStrength < 0.6) return ThemeColors.of(context).orangeMaterial;
    if (_passwordStrength < 0.8) return ThemeColors.of(context).yellowGold;
