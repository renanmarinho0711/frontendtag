...
/// Mixin para funcionalidades comuns de formulrios
  ...
  Widget? buildFormError() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: ThemeColors.of(context).redPastel,
        borderRadius: BorderRadius.circular(8),
        border: Border.all(color: Color.alphaBlend(ThemeColors.of(context).surface.withValues(alpha: 0.7), ThemeColors.of(context).redMain)),
      ),
      child: Row(
        children: [
          Icon(Icons.error_outline, color: ThemeColors.of(context).redMain, size: 20),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
              formError!,
              style: TextStyle(color: ThemeColors.of(context).redMain),
            ),
          ),
          IconButton(
