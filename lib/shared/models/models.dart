// Model base para entidades com ID
...
class Produto extends BaseModel {
  ...
  factory Produto.fromJson(Map<String, dynamic> json) {
    return Produto(
      ...
      codigo: json['codigo'] ?? json['barcode'] ?? '',
      ...
      codigoBarras: json['codigoBarras'] ?? json['barcode'],
      estoque: json['estoque'] ?? json['stock'],
      ativo: json['ativo'] ?? json['isActive'] ?? true,
      imageUrl: json['imageUrl'] as String?,
      boundTagCount: json['boundTagCount'] as int?,
