...
class _CategoriasListaScreenState extends ConsumerState<CategoriasListaScreen>
  ...
  // NOTA: Mtodos removidos: _getIconData, _buildSearchBar, _buildSortButton (cdigo morto)
            ...
            trailing: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: IconButton(
                    icon: Icon(Icons.check_rounded, color: ThemeColors.of(context).error, size: 20),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Categoria "${categoria.nome}" excluda'),
