...
class _CategoriasMenuScreenState extends ConsumerState<CategoriasMenuScreen> with ResponsiveCache {
  ...
  Widget build(BuildContext context) {
    ...
    // Responsividade disponvel via ResponsiveHelper se necessrio
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  'Organize produtos em categorias para facilitar a gesto e navegao do seu catálogo.',
  ...
  Widget _buildStatsCards() {
    ...
    final estatisticas = [
      ...
      {'label': 'Bebidas', 'valor': '247', 'icon': Icons.local_drink_rounded, 'cor': ThemeColors.of(context).primary, 'mudanca': '+5', 'tipo': 'aumento'},
      ...
      {'label': 'Perecveis', 'valor': '189', 'icon': Icons.dining_rounded, 'cor': ThemeColors.of(context).success, 'mudanca': '+7', 'tipo': 'aumento'},
      ...
      itemBuilder: (context, index) {
        ...
        final opcoes = [
...

          {
            ...
            'titulo': 'Administrao Completa',

            'subtitulo': 'Controle total e avanado',
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: (opcao['gradiente'] as List<dynamic>).cast<Color>(),
        ...
        boxShadow: [
          ...
          BoxShadow(
            ...
            color: ((opcao['gradiente'] as List<dynamic>).cast<Color>()[0]).withValues(alpha: 0.3),
          ...
          onTap: () {
            ...
            if (opcao['destino'] != null) {
              ...
              _navigatorKey.currentState?.push(
                ...
                MaterialPageRoute(builder: (context) => opcao['destino'] as Widget),
