...
class PrecificacaoAjusteFixoScreen extends ConsumerStatefulWidget {
  const PrecificacaoAjusteFixoScreen({super.key});

  @override
  ConsumerState<PrecificacaoAjusteFixoScreen> createState() => _PrecificacaoAjusteFixoScreenState();
}

class _PrecificacaoAjusteFixoScreenState extends ConsumerState<PrecificacaoAjusteFixoScreen>
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              labelText: 'Valor do Ajuste em R\$',
              ...
              helperText: _tipoAjuste == 0
                  ? 'Valor que será adicionado a cada produto'
                  : 'Valor que será subtraãdo de cada produto',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: AppSizes.spacingSm.get(isMobile, isTablet)),
          _buildSelecaoOption('Por faixa de preço', 2, Icons.price_change_rounded),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            if (isSelected)
              Icon(Icons.check_circle_rounded, color: ThemeColors.of(context).primary, size: 20),
          ],
        ),
      ),
    );
