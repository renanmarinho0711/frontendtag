  ...
  Widget _buildParametrosCard(RealtimeRankingState state) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(children: [Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: ThemeColors.of(context).blueMain.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(12)), child: const Icon(Icons.tune_rounded, color: ThemeColors.of(context).blueMain, size: 22)), const SizedBox(width: 14), const Expanded(child: Text('Par�metros de Exibi��o', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, letterSpacing: -0.5)))]),
          const SizedBox(height: 24),
          Row(children: [const Icon(Icons.refresh_rounded, size: 24, color: ThemeColors.of(context).blueMain), const SizedBox(width: 12), const Expanded(child: Text('Intervalo de Atualiza��o', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600))), Container(padding: EdgeInsets.symmetric(horizontal: AppSizes.mediumPadding.get(isMobile, isTablet), vertical: 6), decoration: BoxDecoration(color: ThemeColors.of(context).blueMain.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)), child: Text('${state.intervaloAtualizacao} min', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: ThemeColors.of(context).blueMain)))]),
          ...
          const SizedBox(height: 24),
          Row(children: [const Icon(Icons.analytics_rounded, size: 24, color: ThemeColors.of(context).blueCyan), const SizedBox(width: 12), const Expanded(child: Text('Tipo de Ranking', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600))), Container(padding: EdgeInsets.symmetric(horizontal: AppSizes.mediumPadding.get(isMobile, isTablet), vertical: 6), decoration: BoxDecoration(color: ThemeColors.of(context).blueCyan.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)), child: DropdownButton<String>(value: state.tipoRanking, underline: const SizedBox(), items: ['Vendas', 'Faturamento', 'Quantidade', 'Margem'].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(), onChanged: (value) => ref.read(realtimeRankingProvider.notifier).setTipoRanking(value!), style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: ThemeColors.of(context).blueCyan)))]),
        ],
      ),
    );
  }
