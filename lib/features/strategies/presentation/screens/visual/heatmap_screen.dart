      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: ThemeColors.of(context).greenMainLight, borderRadius: BorderRadius.circular(isMobile ? 6 : 8), border: Border.all(color: ThemeColors.of(context).greenMain, width: 2)),
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              Icon(Icons.check_circle_rounded, size: AppSizes.iconTiny.get(isMobile, isTablet), color: ThemeColors.of(context).greenMainDark),
