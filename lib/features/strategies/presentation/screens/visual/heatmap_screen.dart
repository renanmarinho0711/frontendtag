...
class _MapaCalorConfigScreenState extends ConsumerState<MapaCalorConfigScreen>
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: ThemeColors.of(context).successLight, borderRadius: BorderRadius.circular(isMobile ? 6 : 8), border: Border.all(color: ThemeColors.of(context).success, width: 2)),
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              Icon(Icons.check_circle_rounded, size: AppSizes.iconTiny.get(isMobile, isTablet), color: ThemeColors.of(context).successDark),
      ...
      child: Column(
        ...
        children: [
          Row(mainAxisSize: MainAxisSize.min, children: [
            Container(padding: EdgeInsets.all(AppSizes.paddingBase.get(isMobile, isTablet)), decoration: BoxDecoration(color: ThemeColors.of(context).infoLight, borderRadius: BorderRadius.circular(AppSizes.paddingBase.get(isMobile, isTablet))), child: Icon(Icons.tune_rounded, color: ThemeColors.of(context).info, size: AppSizes.iconMediumAlt.get(isMobile, isTablet))),
          ...
          Row(mainAxisSize: MainAxisSize.min, children: [
            Icon(Icons.speed_rounded, size: AppSizes.iconMediumLarge.get(isMobile, isTablet), color: ThemeColors.of(context).info),
            SizedBox(width: AppSizes.paddingBase.get(isMobile, isTablet)),
            ...
            Container(padding: EdgeInsets.symmetric(horizontal: AppSizes.paddingBase.get(isMobile, isTablet), vertical: AppSizes.paddingXsAlt.get(isMobile, isTablet)), decoration: BoxDecoration(color: ThemeColors.of(context).infoLight, borderRadius: BorderRadius.circular(AppSizes.paddingBase.get(isMobile, isTablet))), child: Text('< ${state.limiteZonaFria.toStringAsFixed(0)}%', style: TextStyle(fontSize: ResponsiveHelper.getResponsiveFontSize(context, baseFontSize: 16, mobileFontSize: 15, tabletFontSize: 15), overflow: TextOverflow.ellipsis, fontWeight: FontWeight.bold, color: ThemeColors.of(context).info))),
          ]),
          ...
          Slider(value: state.limiteZonaFria, min: 10, max: 60, divisions: 50, label: '${state.limiteZonaFria.toStringAsFixed(0)}%', onChanged: (value) => ref.read(heatmapProvider.notifier).setLimiteZonaFria(value), activeColor: ThemeColors.of(context).info),
          SizedBox(height: AppSizes.paddingXl.get(isMobile, isTablet)),
          Row(mainAxisSize: MainAxisSize.min, children: [
            Icon(Icons.wb_incandescent_rounded, size: AppSizes.iconMediumLarge.get(isMobile, isTablet), color: ThemeColors.of(context).warning),
            SizedBox(width: AppSizes.paddingBase.get(isMobile, isTablet)),
            ...
            Container(padding: EdgeInsets.symmetric(horizontal: AppSizes.paddingBase.get(isMobile, isTablet), vertical: AppSizes.paddingXsAlt.get(isMobile, isTablet)), decoration: BoxDecoration(color: ThemeColors.of(context).warningLight, borderRadius: BorderRadius.circular(AppSizes.paddingBase.get(isMobile, isTablet))), child: DropdownButton<String>(value: state.intensidadePiscar, underline: const SizedBox(), items: ['Baixa', 'M?dia', 'Alta', 'Muito Alta'].map((e) => DropdownMenuItem(value: e, child: Text(e, style: TextStyle(fontSize: ResponsiveHelper.getResponsiveFontSize(context, baseFontSize: 14, mobileFontSize: 13, tabletFontSize: 13), overflow: TextOverflow.ellipsis)))).toList(), onChanged: (value) => ref.read(heatmapProvider.notifier).setIntensidadePiscar(value!), style: TextStyle(fontSize: ResponsiveHelper.getResponsiveFontSize(context, baseFontSize: 14, mobileFontSize: 13, tabletFontSize: 13), fontWeight: FontWeight.bold, color: ThemeColors.of(context).warning))),
          ]),
          SizedBox(height: AppSizes.paddingXl.get(isMobile, isTablet)),
          Row(mainAxisSize: MainAxisSize.min, children: [
  ...
  Widget _buildSwitchOption(String title, String subtitle, IconData icon, bool value, Function(bool) onChanged) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: value ? ThemeColors.of(context).errorLight : ThemeColors.of(context).textSecondary, borderRadius: BorderRadius.circular(AppSizes.paddingBase.get(isMobile, isTablet)), border: Border.all(color: value ? ThemeColors.of(context).errorLight : ThemeColors.of(context).textSecondary)),
      child: Row(mainAxisSize: MainAxisSize.min, children: [
  ...
  Widget _buildZonaCard(HeatmapZoneModel zona, int index) {
    ...
    return TweenAnimationBuilder(
      ...
      child: Container(
        padding: EdgeInsets.all(AppSizes.cardPadding.get(isMobile, isTablet)),
        decoration: BoxDecoration(color: ThemeColors.of(context).surface, borderRadius: BorderRadius.circular(isMobile ? 14 : (isTablet ? 15 : 16)), border: Border.all(color: zona.corLight, width: 2), boxShadow: [BoxShadow(color: zona.corLight, blurRadius: isMobile ? 15 : 20, offset: Offset(0, isMobile ? 4 : 6))]),
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Row(mainAxisSize: MainAxisSize.min, children: [
