          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildSummaryItem(
                  'Vendas',
                  (_dadosAtuais['variacaoVendas']).toString(),
                ...
                _buildSummaryItem(
                  'Impacto',
                  (_dadosAtuais['variacaoFaturamento']).toString(),
  ...
  Widget _buildMetricsGrid() {
    ...
    return GridView.count(
      ...
      children: [
        ...
        _buildMetricCard(
          'Faturamento',
          (_dadosAtuais['totalFaturamento']).toString(),
        ...
        _buildMetricCard(
          ...
          (_dadosAtuais['variacaoConversão']).toString(),
        ),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildComparisonRow('Vendas', _calcularVariacaoAnterior('vendas'), (_dadosAtuais['variacaoVendas']).toString(), true),
          SizedBox(
            height: AppSizes.paddingBase.get(isMobile, isTablet),
          ),
          _buildComparisonRow('Faturamento', _calcularVariacaoAnterior('faturamento'), (_dadosAtuais['variacaoFaturamento']).toString(), true),
          SizedBox(
            height: AppSizes.paddingBase.get(isMobile, isTablet),
          ),
          _buildComparisonRow('Ticket Mãdio', _calcularVariacaoAnterior('ticket'), (_dadosAtuais['variacaoTicket']).toString(), true),
          SizedBox(
            height: AppSizes.paddingBase.get(isMobile, isTablet),
          ),
          _buildComparisonRow('Conversão', _calcularVariacaoAnterior('conversão'), (_dadosAtuais['variacaoConversão']).toString(), true),
        ],
      ),
    );
  }
