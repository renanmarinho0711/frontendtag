...
class _EstrategiasMenuScreenState extends ConsumerState<EstrategiasMenuScreen>
  ...
  Widget? _getTelaConfiguracao(String nome) {
    switch (nome) {
      ...
      case 'Precificao por Temperatura':
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Inteligncia artificial em precificao',
                  style: TextStyle(
                    fontSize: ResponsiveHelper.getResponsiveFontSize(
                      context,
                      baseFontSize: 12,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Utilize a inteligncia artificial para criar estratgias automticas de precificao baseadas em eventos, calendrio, temperatura, horrios e muito mais.',
                  style: TextStyle(
                    fontSize: ResponsiveHelper.getResponsiveFontSize(
                      context,
                      baseFontSize: 12,
