...
class StrategiesRepository {
  ...
  StrategyModel _parseStrategy(Map<String, dynamic> data) {
    ...
    return StrategyModel(
      ...
      primaryColorKey: themeData['colorKey'] as String,
      gradient: themeData['gradientKeys'] as List<String>,
    ...
    switch (category) {
      case StrategyCategory.calendar:
        return {
          ...
          'colorKey': 'yellowGold',
          'gradientKeys': ['yellowGold', 'warning'],
        };
      ...
      case StrategyCategory.visual:
        return {
          ...
          'colorKey': 'blueCyan',
          'gradientKeys': ['blueCyan', 'primary'],
        };
      case StrategyCategory.crossSelling:
        return {
          'icon': Icons.compare_arrows_rounded,
          'colorKey': 'brownMain',
          'gradientKeys': ['brownMain', 'brownDark'],
        };
      case StrategyCategory.performance:
        return {
          'icon': Icons.trending_up_rounded,
          'colorKey': 'success',
          'gradientKeys': ['success', 'greenDark'],
        };
      case StrategyCategory.engagement:
        return {
          'icon': Icons.map_rounded,
          'colorKey': 'urgent',
          'gradientKeys': ['urgent', 'urgentDark'],
        };
    }
  }
