  ...
  void _processarCodigo(String codigo, bool isTag) {
    ...
    if (isTag) {
      ...
      if (produto.id.isNotEmpty) {
        ...
        // Produto no encontrado localmente - busca no catálogo global
        _buscarNoCatalogoGlobal(codigo);
      }
    }
  }

  /// Busca produto no catálogo global de produtos pelo cdigo de barras
      ...
      response.when(
        success: (globalProduct) {
          if (globalProduct != null && globalProduct.found) {
            ...
            // No encontrado nem no catálogo global
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Este produto ser adicionado ao seu catálogo local.',
