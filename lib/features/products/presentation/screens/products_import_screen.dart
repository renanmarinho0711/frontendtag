    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.sm),
          _buildInfoItem('código', 'Cdigo de barras (mnimo 8 dgitos)'),
          _buildInfoItem('nome', 'Nome do produto (obrigatrio)'),
          _buildInfoItem('preco', 'Preço unitrio (formato: 9.99)'),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Row(
            children: [
              Icon(Icons.description_rounded, color: ThemeColors.of(context).blueCyan),
              const SizedBox(width: AppSpacing.md),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
      ...
      SnackBar(
        content: Row(
          children: [
            Icon(Icons.check_rounded, color: ThemeColors.of(context).surface),
            const SizedBox(width: AppSpacing.md),
            const Text('Baixando relatrio de importação...'),
          ],
        ),
        backgroundColor: ThemeColors.of(context).greenMain,
        behavior: SnackBarBehavior.floating,
