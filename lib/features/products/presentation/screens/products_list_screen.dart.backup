...
class _ProdutosListaScreenState extends ConsumerState<ProdutosListaScreen> 
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  'Gerencie seu catálogo completo de produtos com controle de preços, estoque, categorias e associao automtica com etiquetas eletrnicas.',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text('ã', style: TextStyle(color: ThemeColors.of(context).textSecondary, fontSize: 12)),
  ...
  /// Constri badge de status de sincronização Minew
  ...
  void _duplicateProduct(ProductModel produto) async {
    ...
    // Navega para edio para o usuário ajustar antes de salvar
...
// Dialog para edio de preço em lote
