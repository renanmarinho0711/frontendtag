...
/// Implementao conforme PROMOT PRODUTOS.txt
/// Hero section, Quick actions, Tabs (Informaes, Estoque, Histrico, Estratgias)
...
class _ProdutosDetalhesScreenState extends ConsumerState<ProdutosDetalhesScreen> 
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: AppGradients.fromBaseColor(context, _product.cor),
      ...
      child: Column(
        ...
        children: [
          _buildInfoCard(
            ...
            items: [
              _buildInfoItem('Cdigo de Barras', _product.codigo, Icons.qr_code_rounded),
              ...
              _buildInfoItem('Dimenses', '15x15x30 cm', Icons.square_foot_rounded),
          ...
          _buildInfoCard(
            ...
            items: [
              ...
              _buildInfoItem('ltima Atualizao', DateFormat('dd/MM/yyyy HH:mm').format(DateTime.now()), Icons.update_rounded),
            ],
            isMobile: isMobile,
            isTablet: isTablet,
          ),
          ...
          _buildInfoCard(
            ...
            items: [
              Text(
                _product.descricao ?? 'Sem descrio disponvel.',
                style: TextStyle(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Grfico de Movimentaes (placeholder)
          Container(
            height: 200,
            padding: EdgeInsets.all(AppSizes.paddingMd.get(isMobile, isTablet)),
            decoration: BoxDecoration(
  ...
  void _showUnbindTagDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Deseja remover a vinculao da tag "${_product.tag}" deste produto?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text('Cancelar'),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(context);
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Preo atualizado com sucesso')),
              );
            },
            child: Text('Salvar'),
          ),
  ...
  void _showEstoqueDialog({required bool isEntrada}) {
    ...
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(isEntrada ? 'Entrada de Estoque' : 'Sada de Estoque'),
        content: TextField(
          controller: controller,
  ...
  void _showVendasDialog() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('Relatrio de Vendas'),
        content: Text('Funcionalidade em desenvolvimento.\n\nEm breve voc poder visualizar o histrico de vendas deste produto.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text('Fechar'),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Produto excludo com sucesso'),
