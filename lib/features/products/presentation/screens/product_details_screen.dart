...
/// Hero section, Quick actions, Tabs (Informações, Estoque, Histórico, Estratgias)
...
class _ProdutosDetalhesScreenState extends ConsumerState<ProdutosDetalhesScreen> 
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            items: [
              ...
              _buildInfoItem('Última Atualizao', DateFormat('dd/MM/yyyy HH:mm').format(DateTime.now()), Icons.update_rounded),
            ],
            isMobile: isMobile,
            isTablet: isTablet,
          ),
          ...
          _buildInfoCard(
            ...
            items: [
              Text(
                _product.descricao ?? 'Sem descrição disponvel.',
                style: TextStyle(
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () {},
                    icon: const Icon(Icons.add_rounded),
                    label: const Text('Criar Estratgia'),
                    style: ElevatedButton.styleFrom(
  ...
  void _showVendasDialog() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Relatrio de Vendas'),
        content: const Text('Funcionalidade em desenvolvimento.\n\nEm breve voc poder visualizar o histórico de vendas deste produto.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: const Text('Produto excludo com sucesso'),
