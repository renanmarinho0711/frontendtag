...
/// - Passo 1: Informações Bsicas (Cdigo, Nome, Categoria, Descrição)
  ...
  void _nextStep() {
    if (_currentStep < _totalSteps - 1) {
      ...
      if (_currentStep == 1 && !_step2Valid) {
        _showValidationError('Informe um preço vlido maior que zero');
        return;
      }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: AppSpacing.sm),
                Text(
                  'Este  o preço que ser exibido na etiqueta ESL',
                  style: _responsiveTextStyle(AppTextStyles.caption.copyWith(
                    color: ThemeColors.of(context).textSecondary,
                  )),
                ),
