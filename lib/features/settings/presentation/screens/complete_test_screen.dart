  ...
  Widget _buildRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SizedBox(width: 70, child: Text('$label:', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 11))),
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('$_passed de $_total testes passaram', style: TextStyle(fontSize: 18)),
