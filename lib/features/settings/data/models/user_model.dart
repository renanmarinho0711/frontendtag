...
extension UserRoleExtension on UserRole {
  ...
  Color get color {
    switch (this) {
      case UserRole.platformAdmin:
        return AppThemeColors.roleSuperAdmin; // Pink - destaque máximo
      case UserRole.clientAdmin:
        return AppThemeColors.roleAdmin; // Purple
      case UserRole.storeManager:
        return AppThemeColors.roleManager; // Blue
      case UserRole.operator:
        return AppThemeColors.roleOperator; // Green
      case UserRole.viewer:
        return AppThemeColors.roleViewer; // Grey
    }
  }

  /// Obtém a cor dinâmica da role (requer BuildContext)
  Color dynamicColor(BuildContext context) {
    ...
    switch (this) {
      ...
      case UserRole.storeManager:
        return colors.roleManager;
      case UserRole.operator:
        return colors.roleOperator;
      case UserRole.viewer:
        return colors.roleViewer;
    }
  }
  ...
  String get description {
    switch (this) {
      ...
      case UserRole.viewer:
        return 'Apenas visualização. Sem permissão para editar.';
    }
  }
...
/// Nível de acesso do usuário - LEGADO (manter compatibilidade)
...
extension UserLevelExtension on UserLevel {
  ...
  /// Obtém a cor dinâmica do nível (requer BuildContext)
  Color dynamicColor(BuildContext context) {
    final colors = ThemeColors.of(context);
    switch (this) {
      case UserLevel.admin:
...
extension UserStatusExtension on UserStatus {
  ...
  Color get color {
    switch (this) {
      ...
      case UserStatus.inactive:
        return AppThemeColors.statusInactive;
      case UserStatus.pending:
        return AppThemeColors.statusPending;
      case UserStatus.blocked:
        return AppThemeColors.statusBlocked;
    }
  }
...
class SettingsUserModel {
  ...
  Color get avatarColor => role.color;
