...
class _AppBarUserMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (context) => [
        _buildMenuItem(context, Icons.person_rounded, 'Meu Perfil', 'profile'),
        _buildMenuItem(context, Icons.help_rounded, 'Ajuda & Suporte', 'help'),
        const PopupMenuDivider(),
        _buildMenuItem(context, Icons.logout_rounded, 'Sair', 'logout', isDestructive: true),
      ],
      onSelected: (value) {
        switch (value) {
          case 'profile':
...
/// Boto de seleo de tema na AppBar
