...
/// Card de Prxima Ação Sugerida - IA sugere o prximo passo baseado no estado do sistema
/// Lgica de prioridade:
...
/// 6. Nenhuma estratgia ? "Ative estratgias de precificação"
  ...
  Map<String, dynamic>? _determineNextAction(BuildContext context, DashboardData data) {
    ...
    if (productsWithoutPrice > 0) {
      return {
        ...
        'description': 'Voc tem $productsWithoutPrice produtos sem preço definido. '
            'Produtos sem preço no sero exibidos nas etiquetas.',
    ...
    if (data.strategiesStats.activeCount == 0) {
      return {
        ...
        'description': 'Nenhuma estratgia de precificação est ativa. '
            'Ative estratgias para otimizar seus preços automaticamente.',
