...
class AtalhosRapidosCard extends StatelessWidget {
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _buildShortcut('Ctrl+P', 'Novo Produto', onNovoProduto, context),

              _buildShortcut('Ctrl+T', 'Nova Tag', onNovaTag, context),

              _buildShortcut('Ctrl+V', 'Vincular', onVincular, context),

              _buildShortcut('Ctrl+S', 'Sincronizar', onSincronizar, context),

              _buildShortcut('Ctrl+B', 'Buscar', onBuscar, context),

              _buildShortcut('F5', 'Atualizar', onAtualizar, context),
  ...
  Widget _buildShortcut(String keys, String action, VoidCallback? onTap, BuildContext context) {
