  ...
  List<_FluxoInteligente> _getFluxosPendentes(BuildContext context, DashboardState state) {
    ...
    if (produtosSemTag > 0) {
      fluxos.add(_FluxoInteligente(
        ...
        descricao: 'Vincule tags para exibir preos nos displays',
        acoes: [
    ...
    if (importacoesComErro > 0) {
      fluxos.add(_FluxoInteligente(
        ...
        titulo: 'Importao com $importacoesComErro ${importacoesComErro == 1 ? "erro" : "erros"}',
    ...
    if (produtosSemPreco > 0) {
      fluxos.add(_FluxoInteligente(
        ...
        titulo: '$produtosSemPreco ${produtosSemPreco == 1 ? "produto" : "produtos"} sem preo definido',
        descricao: 'Defina preos para exibir nos displays',
        acoes: [
          _FluxoAcao('Definir Preos', null, principal: true),
