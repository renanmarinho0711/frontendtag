...
class AcoesFrequentesCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Obtm dados para badges dinmicos
    final dashboardState = ref.watch(dashboardProvider);
    final storeStats = dashboardState.data.storeStats;
    // Produtos sem tag = total - vinculados (boundTagsCount representa quantas tags esto vinculadas)
