  ...
  factory StrategiesStats.fromJson(Map<String, dynamic> json) {
    ...
    return StrategiesStats(
      ...
      strategies: (json['strategies'] as List? ?? [])
          ...
          .map((s) => StrategyDetails.fromJson(s as Map<String, dynamic>))
...
class DashboardData {
  ...
  factory DashboardData.fromJson(Map<String, dynamic> json) {
    ...
    return DashboardData(
      ...
      storeStats: StoreStats.fromJson(json['storeStats'] as Map<String, dynamic>? ?? {}),

      strategiesStats: StrategiesStats.fromJson(json['strategiesStats'] as Map<String, dynamic>? ?? {}),
