...
/// Status de importa��o
enum ImportStatus {
  pending('Pendente', 'orangeMaterial'),
  processing('Processando', 'primary'),
  completed('Concluído', 'success'),
  completedWithErrors('Concluído c/ Erros', 'amberMain'),
  failed('Falhou', 'error'),
  partial('Parcial', 'amberMain');

  const ImportStatus(this.label, this.colorKey);
...
class BatchOperationModel {
  ...
  factory BatchOperationModel.simple({
    ...
    return BatchOperationModel(
      ...
      gradientColors: const [ThemeColors.of(context).primary, ThemeColors.of(context).blueCyan],
