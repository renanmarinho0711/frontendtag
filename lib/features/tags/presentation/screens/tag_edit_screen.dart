        ...
        SizedBox(
          ...
          child: OutlinedButton.icon(
            ...
            style: OutlinedButton.styleFrom(
              ...
              foregroundColor: ThemeColors.of(context).errorMain,
              side: BorderSide(color: ThemeColors.of(context).errorMain),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(
                    AppSizes.paddingBase.get(isMobile, isTablet)),
              ),
  ...
  Future<void> _testarSincronizacao() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Erro ao testar sincronizao: $e'),
                ...
                : _error != null
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.error_outline_rounded, size: 64, color: ThemeColors.of(context).errorMain),
                            const SizedBox(height: 16),
                            Text(_error!, style: TextStyle(color: ThemeColors.of(context).errorMain)),
                            const SizedBox(height: 16),
                            ElevatedButton.icon(
