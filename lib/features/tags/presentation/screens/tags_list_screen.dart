...
class _EtiquetasListaScreenState extends ConsumerState<EtiquetasListaScreen>
  ...
  Future<void> _loadTags() async {
    // Obtm storeId do WorkContext do usurio logado
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Gerencie suas etiquetas eletrnicas (ESLs) com controle completo de status, bateria, sincronizao e associao com produtos.',
                  style: TextStyle(
