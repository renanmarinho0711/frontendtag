...
class _EtiquetasMenuScreenState extends ConsumerState<EtiquetasMenuScreen> 
  ...
  /// Obtm o storeId do usuário logado
  String get _storeId {
  ...
  Widget build(BuildContext context) {
    ...
    // Obtm histórico de importações do backend
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              // Histórico de importações do backend
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Crie, personalize e imprima etiquetas eletrnicas com layouts customizados, formatos variados e importação em lote.',
                  style: TextStyle(
                    fontSize: ResponsiveHelper.getResponsiveFontSize(
                      context,
                      baseFontSize: 12,
  ...
  /// Constri item do histórico a partir do modelo TagImportHistory
