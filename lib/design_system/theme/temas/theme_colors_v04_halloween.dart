...
/// ==============================================================================
/// TEMA: HALLOWEEN - Tema Halloween
/// ==============================================================================
///
/// Conceito Visual:
/// Laranja, roxo e preto para o clima de Halloween
...
class AppThemeColors {
  ...
  static const Color backgroundLight = Color(0xFF2D1B3D);
  ...
  static const Color surfaceVariant = Color(0xFF3D2550);

  /// Fundo de inputs (Campos de texto). Cinza clarÃ­ssimo para conforto visual.
  static const Color inputBackground = Color(0xFF3D2550);

  /// Fundo secundÃ¡rio para Ã¡reas de separaÃ§Ã£o. Cinza claro e neutro.
  static const Color backgroundMedium = Color(0xFF4A2F5E);
  ...
  static const Color borderLight = Color(0xFF4A2F5E);
  ...
  static const Color infoDark = Color(0xFFFF6F00);
  ...
  static const Color successText = Color(0xFFE65100);
  ...
  static const Color primaryDashboard = Color(0xFFFF6F00);
  static const Color primaryDashboardDark = Color(0xFFE65100);

  // AppBar
  static const Color dashboardAppBarBackground = Color(0xFF2D1B3D);
  static const Color dashboardAppBarShadow = Color(0x1A0D9488);

  // Menu Lateral (Drawer)
  static const Color dashboardDrawerBackground1 = Color(0xFF2D1B3D);
  static const Color dashboardDrawerBackground2 = Color(0xFF3D2550);

  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFFFF6F00);
  static const Color dashboardDrawerHeaderIconBg = Color(0xFF4A2F5E);
  static const Color dashboardDrawerHeaderText = Color(0xFFE0E0E0);
  static const Color dashboardDrawerHeaderTextSecondary = Color(0xFFB0B0B0);
  static const Color dashboardDrawerItemSelected = Color(0xFF4A2F5E);
  static const Color dashboardDrawerItemUnselected = transparent;
  static const Color dashboardDrawerItemTextSelected = Color(0xFFFF6F00);
  static const Color dashboardDrawerItemTextUnselected = Color(0xFFB0B0B0);

  // Bottom Navigation
  static const Color dashboardBottomNavBackground = Color(0xFF2D1B3D);
  static const Color dashboardBottomNavShadow = Color(0x1A0D9488);
  static const Color dashboardBottomNavIconSelected = Color(0xFFFF6F00);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFFFF6F00);
  static const Color dashboardBottomNavTextUnselected = Color(0xFF94A3B8);

  // Navigation Rail
  static const Color dashboardRailBackground = Color(0xFF2D1B3D);
  static const Color dashboardRailShadow = Color(0x1A0D9488);
  static const Color dashboardRailToggleBackground = Color(0xFF3D2550);
  static const Color dashboardRailToggleIcon = Color(0xFFB0B0B0);
  static const Color dashboardRailItemIconSelected = Color(0xFF2D1B3D);
  static const Color dashboardRailItemIconUnselected = Color(0xFFB0B0B0);
  static const Color dashboardRailItemTextSelected = Color(0xFFFF6F00);
  static const Color dashboardRailItemTextUnselected = Color(0xFFB0B0B0);

  static const Color dashboardLogoIconColor = Color(0xFFFF6F00);

  // Barra de Busca
  static const Color dashboardSearchBackground = Color(0xFF3D2550);
  static const Color dashboardSearchHint = Color(0xFF94A3B8);
  static const Color dashboardSearchIcon = Color(0xFFB0B0B0);

  // NotificaÃ§Ãµes e Badges
  static const Color dashboardNotificationBackground = Color(0xFF4A2F5E);
  static const Color dashboardNotificationBadge = Color(0xFFEF4444);
  static const Color dashboardNotificationIcon = Color(0xFFFF6F00);

  // Status de ConexÃ£o
  static const Color dashboardConnectionBackground = Color(0xFF4A2F5E);
  ...
  static const Color dashboardConnectionText = Color(0xFFE0E0E0);

  // User Menu
  static const Color dashboardUserMenuBackground1 = Color(0xFF2D1B3D);
  static const Color dashboardUserMenuBackground2 = Color(0xFF3D2550);
  static const Color dashboardUserMenuAvatarBg = Color(0xFFFF6F00);
  static const Color dashboardUserMenuAvatarText = Color(0xFF2D1B3D);
  static const Color dashboardUserMenuText = Color(0xFFE0E0E0);
  static const Color dashboardUserMenuTextSecondary = Color(0xFFB0B0B0);
  static const Color dashboardUserMenuIcon = Color(0xFFB0B0B0);
  ...
  static const Color dashboardWelcomeText = Color(0xFFE0E0E0);
  static const Color dashboardWelcomeTextSecondary = Color(0xFFB0B0B0);
  static const Color dashboardWelcomeTextTertiary = Color(0xFF94A3B8);
  static const Color dashboardWelcomeIcon = Color(0xFFFF6F00);

  // ===========================================================================
  // 7. CARDS E MÃ‰TRICAS (KPIs) - DINÃ‚MICOS E LEVES
  // ===========================================================================

  static const Color dashboardMetricsCardBackground = Color(0xFF2D1B3D);
  ...
  static const Color dashboardMetricsValueText = Color(0xFFE0E0E0);
  static const Color dashboardMetricsLabelText = Color(0xFFB0B0B0);

  // Cards GenÃ©ricos
  static const Color dashboardCardBackground = Color(0xFF2D1B3D);
  static const Color dashboardCardShadow = Color(0x1A0D9488);
  static const Color dashboardCardTitle = Color(0xFFE0E0E0);
  static const Color dashboardCardSubtitle = Color(0xFFB0B0B0);

  // ===========================================================================
  // 8. CORES DE MÃ“DULOS - "PALETA MODERNA E DINÃ‚MICA"
  // ===========================================================================

  static const Color moduleDashboard = Color(0xFFFF6F00);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFFE65100);
  ...
  static const Color moduleEstrategias = Color(0xFF76FF03);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFF64DD17);
  ...
  static const Color moduleImportacao = Color(0xFFFF6F00);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFFE65100);
  ...
  static const Color moduleConfiguracoes = Color(0xFFB0B0B0);   // Cinza mÃ©dio
  ...
  static const List<Color> estrategiasGradient = [Color(0xFF76FF03), Color(0xFF64DD17)];
  ...
  static const List<Color> importacaoGradient = [Color(0xFFFF6F00), Color(0xFFE65100)];
  static const List<Color> relatÃ³riosGradient = [Color(0xFF059669), Color(0xFF047857)];
  static const List<Color> configuracoesGradient = [Color(0xFFB0B0B0), Color(0xFF475569)];
  ...
  static const List<Color> infoGradient = [Color(0xFF9C27B0), Color(0xFFFF6F00)];
  ...
  static const Color surfaceLow = Color(0xFF3D2550);
  static const Color surfaceHigh = Color(0xFF2D1B3D);
  static const Color surfaceTinted = Color(0xFF4A2F5E);
  static const Color surfaceTintedDark = Color(0xFFE2E8F0);

  // Menu de UsuÃ¡rio
  static const Color userMenuBackgroundStart = Color(0xFF2D1B3D);
  static const Color userMenuBackgroundEnd = Color(0xFF3D2550);
  static const Color userMenuAvatarBackground = Color(0xFFFF6F00);
  static const Color userMenuAvatarText = Color(0xFF2D1B3D);
  static const Color userMenuHighlight = Color(0xFF4A2F5E);
  static const Color menuItemHover = Color(0xFF3D2550);
  static const Color avatarBackground = Color(0xFFFF6F00);
  static const Color avatarText = Color(0xFF2D1B3D);
  static const Color destructive = Color(0xFFEF4444);

  // Ãcones
  static const Color iconDefault = Color(0xFFB0B0B0);
  ...
  static const Color categoryHortifruti = Color(0xFF76FF03);
  static const Color categoryHortifrutiDark = Color(0xFF64DD17);

  static const Color categoryFrios = Color(0xFFFF6F00);
  static const Color categoryFriosDark = Color(0xFFE65100);
  ...
  static const Color erpSankhya = Color(0xFF76FF03);
  static const Color erpOmie = Color(0xFFFF6F00);
  static const Color erpBling = Color(0xFFB0B0B0);
  ...
  static const Color roleViewer = Color(0xFFB0B0B0);
  ...
  static const Color grey50 = Color(0xFF3D2550);
  static const Color grey100 = Color(0xFF4A2F5E);
  ...
  static const Color greySlate = Color(0xFFB0B0B0);
  static const Color greyDarkSlate = Color(0xFFE0E0E0);

  static const Color grey500Overlay10 = Color(0x1A64748B);

  // BÃ¡sicos
  static const Color neutralWhite = Color(0xFF2D1B3D);
  static const Color neutralBlack = Color(0xFFE0E0E0);
  ...
  static const Color materialTeal = Color(0xFFFF6F00);
  ...
  static const Color white = Color(0xFF2D1B3D);
  static const Color white70 = Color(0xB3FFFFFF);
  static const Color white60 = Color(0x99FFFFFF);
  static const Color white90 = Color(0xE6FFFFFF);
  static const Color white80 = Color(0xCCFFFFFF);

  static const Color black = Color(0xFFE0E0E0);
  ...
  static const Color brandPrimaryTeal = Color(0xFFFF6F00);
  static const Color brandPrimaryTealDark = Color(0xFFE65100);
  static const Color brandPrimaryTealLight = Color(0xFFFF8F00);
  static const Color brandAccentLime = Color(0xFF76FF03);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFFFF6F00), Color(0xFF1E3A3A)],
  );
  ...
  static const Color categoryProdutos = Color(0xFFFF6F00);
  static const Color categoryProdutosDark = Color(0xFFE65100);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFF76FF03);
  static const Color categoryStatsDark = Color(0xFF64DD17);

  static const Color categoryImportExport = Color(0xFFFF6F00);
  static const Color categoryImportExportDark = Color(0xFFE65100);
  ...
  static const Color exportProdutos = Color(0xFF76FF03);
  static const Color exportProdutosDark = Color(0xFF64DD17);
  ...
  static const Color statTagsBackground = Color(0xFF4A2F5E);
  static const Color statTagsIcon = Color(0xFF10B981);
  static const Color statTagsBorder = Color(0xFFA7F3D0);

  static const Color statVendasBackground = Color(0xFF3D2550);
  ...
  static const Color statInsightsIcon = Color(0xFF76FF03);
  ...
  static const Color quickActionTemplateIcon = Color(0xFF2D1B3D);
  ...
  static const Color quickActionUploadIcon = Color(0xFF2D1B3D);
  ...
  static const Color quickActionHistoricoIcon = Color(0xFF2D1B3D);
  ...
  static const Color strategyCardSugestoesIcon = Color(0xFF76FF03);
  static const Color strategyCardSugestoesBorder = Color(0xFFD9F99D);

  static const Color strategyCardSecondaryBackground = Color(0xFF4A2F5E);
  ...
  static const Color statsOverviewBackground1 = Color(0xFF2D1B3D);
  static const Color statsOverviewBackground2 = Color(0xFF3D2550);

  static const Color quickActionsReportsBackground1 = Color(0xFF2D1B3D);
  static const Color quickActionsReportsBackground2 = Color(0xFF3D2550);

  static const Color quickActionsImportBackground1 = Color(0xFF2D1B3D);
  static const Color quickActionsImportBackground2 = Color(0xFF3D2550);
  ...
  static const Color quickActionAgendar = Color(0xFF76FF03);
  ...
  static const Color adminPanelBackground1 = Color(0xFF2D1B3D);
  static const Color adminPanelBackground2 = Color(0xFF3D2550);

  static const Color adminPanelButtonLojas = Color(0xFF9C27B0);
  static const Color adminPanelButtonUsuarios = Color(0xFF10B981);
  static const Color adminPanelButtonConfig = Color(0xFFB0B0B0);

  // ===========================================================================
  // PRIMEIROS PASSOS (Onboarding Light) - GUIA SUAVE
  // ===========================================================================

  static const Color onboardingBackground1 = Color(0xFF4A2F5E);
  static const Color onboardingBackground2 = Color(0xFFE2E8F0);
  static const Color onboardingBorder = Color(0xFFCBD5E1);

  static const Color onboardingIcon = Color(0xFFFF6F00);
  static const Color onboardingProgress = Color(0xFFE65100);

  static const Color onboardingStepCompleted = Color(0xFFFF6F00);
  ...
  static const Color nextStepBackground1 = Color(0xFF4A2F5E);
  static const Color nextStepBackground2 = Color(0xFFE2E8F0);
  static const Color nextStepBorder = Color(0xFFCBD5E1);
  static const Color nextStepIcon = Color(0xFFFF6F00);
  static const Color nextStepTitle = Color(0xFFE0E0E0);
  ...
  static const Color statTagsESLBackground = Color(0xFF4A2F5E);
  ...
  static const Color reportOperacional = Color(0xFFFF6F00);
  static const Color reportOperacionalDark = Color(0xFFE65100);

  static const Color reportVendas = Color(0xFF10B981);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFF76FF03);
  static const Color reportPerformanceDark = Color(0xFF64DD17);
  ...
  static const Color pricingIndividual = Color(0xFF76FF03);
  static const Color pricingIndividualDark = Color(0xFF64DD17);
  static const Color pricingMarginReview = Color(0xFF9C27B0);
  static const Color pricingMarginReviewDark = Color(0xFF7B1FA2);
  static const Color pricingDynamic = Color(0xFFFF6F00);
  static const Color pricingDynamicDark = Color(0xFFE65100);
  ...
  static const Color syncSettings = Color(0xFFFF6F00);
  static const Color syncSettingsDark = Color(0xFFE65100);
  ...
  static const Color tipCardBg = Color(0xFF4A2F5E);
  static const Color tipCardBorder = Color(0xFFA7F3D0);
  static const Color tipCardText = Color(0xFFE65100);
  ...
  static const Color successCardText = Color(0xFFE65100);
  ...
  static const Color syncedBg = Color(0xFF4A2F5E);
  ...
  static const Color notSyncedBg = Color(0xFF3D2550);
  ...
  static const Color darkSurface = Color(0xFF2D1B3D);
  static const Color darkBackground = Color(0xFF3D2550);
  static const Color darkCard = Color(0xFF2D1B3D);
  static const Color darkDialog = Color(0xFF2D1B3D);
  static const Color darkInput = Color(0xFF3D2550);
  static const Color darkDropdown = Color(0xFF2D1B3D);
  ...
  static const Color statusBlueGrey = Color(0xFFB0B0B0);
  static const Color statusBlueGreyLight = Color(0xFF94A3B8);
  static const Color statusBlueGreyBg = Color(0xFF3D2550);

  static const Color gradientDarkTeal = Color(0xFFFF6F00);
  static const Color gradientDarkTealLight = Color(0xFFFF8F00);
  ...
  static const Color gradientSugestoesStart = Color(0xFF76FF03);
  ...
  static const Color strategyOrangeDark = Color(0xFF64DD17);
  ...
  static const Color greenGradientEnd = Color(0xFFFF8F00);
  ...
  static const Color blueIndigo = Color(0xFFE65100);
  ...
  static const Color primaryPastel = Color(0xFF4A2F5E);
  ...
  static const Color suggestionAumentosBackground = Color(0xFF4A2F5E);
  static const Color suggestionAumentosText = Color(0xFFE0E0E0);
  ...
  static const Color mintPastel = Color(0xFF4A2F5E);
  static const Color pinkPastel = Color(0xFFFDF2F8);
  static const Color bluePastel = Color(0xFFF0FDFF);
  static const Color surfacePastel = Color(0xFF3D2550);
