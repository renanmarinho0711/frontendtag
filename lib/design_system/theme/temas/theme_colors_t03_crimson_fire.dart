...
/// ==============================================================================
/// TEMA: CRIMSON FIRE - Vermelho Carmesim
/// ==============================================================================
///
/// Conceito Visual:
/// Fundo branco, cards vermelho intenso, energia mÃ¡xima
...
class AppThemeColors {
  ...
  static const Color infoIcon = Color(0xFFEA580C);
  static const Color infoDark = Color(0xFFDC2626);
  ...
  static const Color successText = Color(0xFFB91C1C);
  ...
  static const Color primaryDashboard = Color(0xFFDC2626);
  static const Color primaryDashboardDark = Color(0xFFB91C1C);
  ...
  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFFDC2626);
  ...
  static const Color dashboardDrawerItemTextSelected = Color(0xFFDC2626);
  ...
  static const Color dashboardBottomNavIconSelected = Color(0xFFDC2626);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFFDC2626);
  ...
  static const Color dashboardNotificationIcon = Color(0xFFDC2626);
  ...
  static const Color dashboardUserMenuAvatarBg = Color(0xFFDC2626);
  ...
  static const Color dashboardUserMenuIcon = Color(0xFF64748B);
  ...
  static const Color dashboardWelcomeIcon = Color(0xFFDC2626);
  ...
  static const Color dashboardMetricsBlue = Color(0xFFEA580C);
  ...
  static const Color dashboardMetricsLabelText = Color(0xFF64748B);
  ...
  static const Color dashboardCardSubtitle = Color(0xFF64748B);

  // ===========================================================================
  // 8. CORES DE MÃ“DULOS - "PALETA MODERNA E DINÃ‚MICA"
  // ===========================================================================

  static const Color moduleDashboard = Color(0xFFDC2626);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFFB91C1C);

  static const Color moduleProdutos = Color(0xFFEA580C);        // Fresh Cyan
  ...
  static const Color moduleEstrategias = Color(0xFFEAB308);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFF65A30D);

  static const Color moduleSincronizacao = Color(0xFFEA580C);   // Fresh Cyan
  static const Color moduleSincronizacaoDark = Color(0xFFC2410C);
  ...
  static const Color moduleImportacao = Color(0xFFDC2626);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFFB91C1C);
  ...
  static const Color moduleConfiguracoes = Color(0xFF64748B);   // Cinza mÃ©dio
  ...
  static const List<Color> produtosGradient = [Color(0xFFEA580C), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF10B981), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFFEAB308), Color(0xFF65A30D)];
  static const List<Color> sincronizacaoGradient = [Color(0xFFEA580C), Color(0xFFC2410C)];
  ...
  static const List<Color> importacaoGradient = [Color(0xFFDC2626), Color(0xFFB91C1C)];
  ...
  static const List<Color> infoGradient = [Color(0xFFEA580C), Color(0xFFDC2626)];
  ...
  static const Color surfaceTinted = Color(0xFFF1F5F9);
  ...
  static const Color userMenuAvatarBackground = Color(0xFFDC2626);
  ...
  static const Color avatarBackground = Color(0xFFDC2626);
  ...
  static const Color connectionSyncing = Color(0xFFEA580C);
  ...
  static const Color erpSyncing = Color(0xFFEA580C);
  ...
  static const Color categoryBebidas = Color(0xFFEA580C);
  ...
  static const Color categoryLimpeza = Color(0xFFEA580C);
  static const Color categoryLimpezaDark = Color(0xFFC2410C);

  static const Color categoryHigiene = Color(0xFFEC4899);
  static const Color categoryHigieneDark = Color(0xFFDB2777);

  static const Color categoryHortifruti = Color(0xFFEAB308);
  static const Color categoryHortifrutiDark = Color(0xFF65A30D);

  static const Color categoryFrios = Color(0xFFDC2626);
  static const Color categoryFriosDark = Color(0xFFB91C1C);
  ...
  static const Color erpSAP = Color(0xFFEA580C);
  static const Color erpTOTVS = Color(0xFFEA580C);
  static const Color erpOracle = Color(0xFFEF4444);
  static const Color erpSenior = Color(0xFF10B981);
  static const Color erpSankhya = Color(0xFFEAB308);
  static const Color erpOmie = Color(0xFFDC2626);
  ...
  static const Color roleManager = Color(0xFFEA580C);
  ...
  static const Color info = Color(0xFFEA580C);
  ...
  static const Color materialBlue = Color(0xFFEA580C);
  ...
  static const Color materialTeal = Color(0xFFDC2626);
  ...
  static const Color blue = Color(0xFFEA580C);
  ...
  static const Color brandPrimaryTeal = Color(0xFFDC2626);
  static const Color brandPrimaryTealDark = Color(0xFFB91C1C);
  static const Color brandPrimaryTealLight = Color(0xFFEF4444);
  static const Color brandAccentLime = Color(0xFFEAB308);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFFDC2626), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFFEA580C);
  ...
  static const Color categoryProdutos = Color(0xFFDC2626);
  static const Color categoryProdutosDark = Color(0xFFB91C1C);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFFEAB308);
  static const Color categoryStatsDark = Color(0xFF65A30D);

  static const Color categoryImportExport = Color(0xFFDC2626);
  static const Color categoryImportExportDark = Color(0xFFB91C1C);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFFEA580C);
  ...
  static const Color exportProdutos = Color(0xFFEAB308);
  ...
  static const Color importHistorico = Color(0xFFEA580C);
  static const Color importHistoricoDark = Color(0xFFC2410C);

  // Stats Cards - Fundos claros e frescos
  static const Color statTagsBackground = Color(0xFFF1F5F9);
  ...
  static const Color quickActionHistoricoBackground = Color(0xFFEA580C);
  static const Color quickActionHistoricoIcon = Color(0xFFFFFFFF);
  static const Color quickActionHistoricoBorder = Color(0xFFC2410C);

  // Cards de AÃ§Ãµes - EstratÃ©gias
  static const Color strategyCardSugestoesBackground = Color(0xFFF7FEE7);
  static const Color strategyCardSugestoesIcon = Color(0xFFEAB308);
  ...
  static const Color quickActionExportarTudo = Color(0xFFEA580C);
  static const Color quickActionAgendar = Color(0xFFEAB308);
  ...
  static const Color adminPanelButtonLojas = Color(0xFFEA580C);
  ...
  static const Color onboardingBackground1 = Color(0xFFF1F5F9);
  static const Color onboardingBackground2 = Color(0xFFE2E8F0);
  static const Color onboardingBorder = Color(0xFFCBD5E1);

  static const Color onboardingIcon = Color(0xFFDC2626);
  static const Color onboardingProgress = Color(0xFFB91C1C);

  static const Color onboardingStepCompleted = Color(0xFFDC2626);
  static const Color onboardingStepPending = Color(0xFFEA580C);
  ...
  static const Color nextStepIcon = Color(0xFFDC2626);
  ...
  static const Color statProdutosIcon = Color(0xFFEA580C);
  ...
  static const Color statSyncIcon = Color(0xFFEA580C);
  ...
  static const Color reportOperacional = Color(0xFFDC2626);
  static const Color reportOperacionalDark = Color(0xFFB91C1C);

  static const Color reportVendas = Color(0xFF10B981);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFFEAB308);
  static const Color reportPerformanceDark = Color(0xFF65A30D);

  static const Color reportauditoria = Color(0xFFEA580C);
  ...
  static const Color pricingPercentage = Color(0xFFEA580C);
  ...
  static const Color pricingIndividual = Color(0xFFEAB308);
  static const Color pricingIndividualDark = Color(0xFF65A30D);
  static const Color pricingMarginReview = Color(0xFFEA580C);
  static const Color pricingMarginReviewDark = Color(0xFFC2410C);
  static const Color pricingDynamic = Color(0xFFDC2626);
  static const Color pricingDynamicDark = Color(0xFFB91C1C);
  static const Color pricingHistory = Color(0xFFEA580C);
  ...
  static const Color syncSettings = Color(0xFFDC2626);
  static const Color syncSettingsDark = Color(0xFFB91C1C);
  ...
  static const Color tipCardText = Color(0xFFB91C1C);
  ...
  static const Color successCardText = Color(0xFFB91C1C);
  ...
  static const Color syncedBg = Color(0xFFF1F5F9);
  ...
  static const Color statusBlueGrey = Color(0xFF64748B);
  static const Color statusBlueGreyLight = Color(0xFF94A3B8);
  static const Color statusBlueGreyBg = Color(0xFFF9FAFB);

  static const Color gradientDarkTeal = Color(0xFFDC2626);
  static const Color gradientDarkTealLight = Color(0xFFEF4444);
  ...
  static const Color gradientSugestoesStart = Color(0xFFEAB308);
  ...
  static const Color strategyOrangeDark = Color(0xFF65A30D);
  ...
  static const Color greenTeal = Color(0xFFEA580C);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFFEF4444);
  ...
  static const Color blueMain = Color(0xFFEA580C);
  static const Color blueCyan = Color(0xFFEA580C);
  static const Color blueMaterial = Color(0xFFEA580C);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFFB91C1C);

  static const Color cyanMain = Color(0xFFEA580C);
  static const Color cyanDark = Color(0xFFC2410C);
  static const Color tealMain = Color(0xFFEA580C);
  static const Color cyanGradientStart = Color(0xFF22D3EE);
  static const Color cyanGradientEnd = Color(0xFFC2410C);
  ...
  static const Color primaryPastel = Color(0xFFF1F5F9);
  ...
  static const Color infoModuleIcon = Color(0xFFEA580C);

  static const Color suggestionCardStart = Color(0xFF10B981);
  static const Color suggestionCardEnd = Color(0xFF059669);
  static const Color suggestionAumentosBackground = Color(0xFFF1F5F9);
  ...
  static const Color mintPastel = Color(0xFFF1F5F9);
