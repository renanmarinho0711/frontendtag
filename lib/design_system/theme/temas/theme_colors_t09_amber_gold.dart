...
/// ==============================================================================
/// TEMA: AMBER GOLD - Ã‚mbar Dourado
/// ==============================================================================
///
/// Conceito Visual:
/// Fundo branco, cards Ã¢mbar sÃ³lido, luxo e sofisticaÃ§Ã£o
...
class AppThemeColors {
  ...
  static const Color infoIcon = Color(0xFFF97316);
  static const Color infoDark = Color(0xFFF59E0B);
  ...
  static const Color successText = Color(0xFFD97706);
  ...
  static const Color primaryDashboard = Color(0xFFF59E0B);
  static const Color primaryDashboardDark = Color(0xFFD97706);
  ...
  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFFF59E0B);
  ...
  static const Color dashboardDrawerItemTextSelected = Color(0xFFF59E0B);
  ...
  static const Color dashboardBottomNavIconSelected = Color(0xFFF59E0B);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFFF59E0B);
  ...
  static const Color dashboardRailItemTextSelected = Color(0xFFF59E0B);
  static const Color dashboardRailItemTextUnselected = Color(0xFF64748B);

  static const Color dashboardLogoIconColor = Color(0xFFF59E0B);
  ...
  static const Color dashboardNotificationIcon = Color(0xFFF59E0B);
  ...
  static const Color dashboardUserMenuAvatarBg = Color(0xFFF59E0B);
  ...
  static const Color dashboardWelcomeIcon = Color(0xFFF59E0B);
  ...
  static const Color dashboardMetricsBlue = Color(0xFFF97316);
  ...
  static const Color moduleDashboard = Color(0xFFF59E0B);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFFD97706);

  static const Color moduleProdutos = Color(0xFFF97316);        // Fresh Cyan
  ...
  static const Color moduleSincronizacao = Color(0xFFF97316);   // Fresh Cyan
  ...
  static const Color moduleImportacao = Color(0xFFF59E0B);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFFD97706);
  ...
  static const List<Color> produtosGradient = [Color(0xFFF97316), Color(0xFF0D6F8B)];
  ...
  static const List<Color> sincronizacaoGradient = [Color(0xFFF97316), Color(0xFF0891B2)];
  ...
  static const List<Color> importacaoGradient = [Color(0xFFF59E0B), Color(0xFFD97706)];
  ...
  static const List<Color> infoGradient = [Color(0xFFF97316), Color(0xFFF59E0B)];
  ...
  static const Color userMenuAvatarBackground = Color(0xFFF59E0B);
  ...
  static const Color avatarBackground = Color(0xFFF59E0B);
  ...
  static const Color connectionSyncing = Color(0xFFF97316);
  ...
  static const Color erpSyncing = Color(0xFFF97316);
  ...
  static const Color categoryBebidas = Color(0xFFF97316);
  ...
  static const Color categoryLimpeza = Color(0xFFF97316);
  ...
  static const Color categoryFrios = Color(0xFFF59E0B);
  static const Color categoryFriosDark = Color(0xFFD97706);
  ...
  static const Color erpSAP = Color(0xFFF97316);
  static const Color erpTOTVS = Color(0xFFF97316);
  ...
  static const Color erpOmie = Color(0xFFF59E0B);
  ...
  static const Color roleManager = Color(0xFFF97316);
  ...
  static const Color materialBlue = Color(0xFFF97316);
  ...
  static const Color materialTeal = Color(0xFFF59E0B);
  ...
  static const Color blue = Color(0xFFF97316);
  ...
  static const Color brandPrimaryTeal = Color(0xFFF59E0B);
  static const Color brandPrimaryTealDark = Color(0xFFD97706);
  static const Color brandPrimaryTealLight = Color(0xFFFBBF24);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFFF59E0B), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFFF97316);
  ...
  static const Color categoryProdutos = Color(0xFFF59E0B);
  static const Color categoryProdutosDark = Color(0xFFD97706);
  ...
  static const Color categoryImportExport = Color(0xFFF59E0B);
  static const Color categoryImportExportDark = Color(0xFFD97706);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFFF97316);
  ...
  static const Color importHistorico = Color(0xFFF97316);
  ...
  static const Color statLogsIcon = Color(0xFFF97316);
  static const Color statLogsBorder = Color(0xFF99F6E4);

  // Cards de AÃ§Ãµes RÃ¡pidas - CORES VIBRANTES
  static const Color quickActionTemplateBackground = Color(0xFFF97316);
  ...
  static const Color quickActionHistoricoBackground = Color(0xFFF97316);
  ...
  static const Color quickActionExportarTudo = Color(0xFFF97316);
  ...
  static const Color adminPanelButtonLojas = Color(0xFFF97316);
  ...
  static const Color onboardingIcon = Color(0xFFF59E0B);
  static const Color onboardingProgress = Color(0xFFD97706);

  static const Color onboardingStepCompleted = Color(0xFFF59E0B);
  static const Color onboardingStepPending = Color(0xFFF97316);
  ...
  static const Color nextStepIcon = Color(0xFFF59E0B);
  ...
  static const Color statProdutosIcon = Color(0xFFF97316);
  ...
  static const Color statSyncIcon = Color(0xFFF97316);
  ...
  static const Color reportOperacional = Color(0xFFF59E0B);
  static const Color reportOperacionalDark = Color(0xFFD97706);
  ...
  static const Color reportauditoria = Color(0xFFF97316);
  ...
  static const Color pricingPercentage = Color(0xFFF97316);
  ...
  static const Color pricingMarginReview = Color(0xFFF97316);
  static const Color pricingMarginReviewDark = Color(0xFF0891B2);
  static const Color pricingDynamic = Color(0xFFF59E0B);
  static const Color pricingDynamicDark = Color(0xFFD97706);
  static const Color pricingHistory = Color(0xFFF97316);
  ...
  static const Color syncSettings = Color(0xFFF59E0B);
  static const Color syncSettingsDark = Color(0xFFD97706);
  ...
  static const Color tipCardText = Color(0xFFD97706);
  ...
  static const Color successCardText = Color(0xFFD97706);
  ...
  static const Color gradientDarkTeal = Color(0xFFF59E0B);
  static const Color gradientDarkTealLight = Color(0xFFFBBF24);
  ...
  static const Color greenTeal = Color(0xFFF97316);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFFFBBF24);
  ...
  static const Color blueMain = Color(0xFFF97316);
  static const Color blueCyan = Color(0xFFF97316);
  static const Color blueMaterial = Color(0xFFF97316);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFFD97706);

  static const Color cyanMain = Color(0xFFF97316);
  static const Color cyanDark = Color(0xFF0891B2);
  static const Color tealMain = Color(0xFFF97316);
  ...
  static const Color infoModuleIcon = Color(0xFFF97316);
