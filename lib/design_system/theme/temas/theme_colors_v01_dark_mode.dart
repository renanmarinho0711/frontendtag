...
/// ==============================================================================
/// TEMA: DARK MODE - Tema Escuro Profissional
/// ==============================================================================
///
/// Conceito Visual:
/// Tema dark com fundos escuros, cards vibrantes e alto contraste
...
class AppThemeColors {
  ...
  static const Color backgroundLight = Color(0xFF1A1F2E);
  ...
  static const Color inputBackground = Color(0xFF242938);

  /// Fundo secundÃ¡rio para Ã¡reas de separaÃ§Ã£o. Cinza claro e neutro.
  static const Color backgroundMedium = Color(0xFF2C3142);

  /// Fundo escuro para contraste suave, mantendo leveza.
  static const Color backgroundDark = Color(0xFF353B4F);
  ...
  static const Color border = Color(0xFF353B4F);

  /// Borda clara para Ã¡reas menos destacadas.
  static const Color borderLight = Color(0xFF2C3142);

  /// Borda mÃ©dia para elementos interativos.
  static const Color borderMedium = Color(0xFFCBD5E1);

  /// Borda escura para destaque sutil.
  static const Color borderDark = Color(0xFFB8BABD);

  /// Divisor padrÃ£o: cinza claro para separar conteÃºdo.
  static const Color divider = Color(0xFF353B4F);
  ...
  // --- ERRO ---
  static const Color errorBackground = Color(0xFF3A1F1F);
  static const Color errorLight = Color(0xFFFCA5A5);
  static const Color errorDark = Color(0xFFB91C1C);
  static const Color errorBorder = Color(0xFFFECACA);
  static const Color errorText = Color(0xFF991B1B);
  static const Color errorMain = Color(0xFFFF5252);
  ...
  static const Color infoIcon = Color(0xFFBB86FC);
  static const Color infoDark = Color(0xFF00D9FF);

  // --- SUCESSO ---
  static const Color successBackground = Color(0xFF1B3A29);
  static const Color successLight = Color(0xFF6EE7B7);
  static const Color successDark = Color(0xFF059669);
  static const Color successBorder = Color(0xFFA7F3D0);
  static const Color success = Color(0xFF00E676);
  static const Color successGlow = Color(0x4D10B981);
  static const Color successText = Color(0xFF00A8CC);
  static const Color successIcon = Color(0xFF00E676);
  ...
  static const Color primaryDashboard = Color(0xFF00D9FF);
  static const Color primaryDashboardDark = Color(0xFF00A8CC);

  // AppBar
  static const Color dashboardAppBarBackground = Color(0xFF1A1F2E);
  static const Color dashboardAppBarShadow = Color(0x1A0D9488);

  // Menu Lateral (Drawer)
  static const Color dashboardDrawerBackground1 = Color(0xFF1A1F2E);
  static const Color dashboardDrawerBackground2 = Color(0xFF242938);

  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFF00D9FF);
  static const Color dashboardDrawerHeaderIconBg = Color(0xFF2C3142);
  static const Color dashboardDrawerHeaderText = Color(0xFFE8EAED);
  static const Color dashboardDrawerHeaderTextSecondary = Color(0xFFB8BABD);
  static const Color dashboardDrawerItemSelected = Color(0xFF2C3142);
  static const Color dashboardDrawerItemUnselected = transparent;
  static const Color dashboardDrawerItemTextSelected = Color(0xFF00D9FF);
  static const Color dashboardDrawerItemTextUnselected = Color(0xFFB8BABD);

  // Bottom Navigation
  static const Color dashboardBottomNavBackground = Color(0xFF1A1F2E);
  static const Color dashboardBottomNavShadow = Color(0x1A0D9488);
  static const Color dashboardBottomNavIconSelected = Color(0xFF00D9FF);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF9AA0A6);
  static const Color dashboardBottomNavTextSelected = Color(0xFF00D9FF);
  static const Color dashboardBottomNavTextUnselected = Color(0xFF9AA0A6);

  // Navigation Rail
  static const Color dashboardRailBackground = Color(0xFF1A1F2E);
  static const Color dashboardRailShadow = Color(0x1A0D9488);
  static const Color dashboardRailToggleBackground = Color(0xFF242938);
  static const Color dashboardRailToggleIcon = Color(0xFFB8BABD);
  static const Color dashboardRailItemIconSelected = Color(0xFF1A1F2E);
  static const Color dashboardRailItemIconUnselected = Color(0xFFB8BABD);
  static const Color dashboardRailItemTextSelected = Color(0xFF00D9FF);
  static const Color dashboardRailItemTextUnselected = Color(0xFFB8BABD);

  static const Color dashboardLogoIconColor = Color(0xFF00D9FF);

  // Barra de Busca
  static const Color dashboardSearchBackground = Color(0xFF242938);
  static const Color dashboardSearchHint = Color(0xFF9AA0A6);
  static const Color dashboardSearchIcon = Color(0xFFB8BABD);

  // NotificaÃ§Ãµes e Badges
  static const Color dashboardNotificationBackground = Color(0xFF2C3142);
  static const Color dashboardNotificationBadge = Color(0xFFFF5252);
  static const Color dashboardNotificationIcon = Color(0xFF00D9FF);

  // Status de ConexÃ£o
  static const Color dashboardConnectionBackground = Color(0xFF2C3142);
  static const Color dashboardConnectionBorder = Color(0xFFCBD5E1);
  static const Color dashboardConnectionDot = Color(0xFF00E676);
  static const Color dashboardConnectionDotGlow = Color(0x4D10B981);
  static const Color dashboardConnectionText = Color(0xFFE8EAED);

  // User Menu
  static const Color dashboardUserMenuBackground1 = Color(0xFF1A1F2E);
  static const Color dashboardUserMenuBackground2 = Color(0xFF242938);
  static const Color dashboardUserMenuAvatarBg = Color(0xFF00D9FF);
  static const Color dashboardUserMenuAvatarText = Color(0xFF1A1F2E);
  static const Color dashboardUserMenuText = Color(0xFFE8EAED);
  static const Color dashboardUserMenuTextSecondary = Color(0xFFB8BABD);
  static const Color dashboardUserMenuIcon = Color(0xFFB8BABD);
  static const Color dashboardUserMenuIconDestructive = Color(0xFFFF5252);
  static const Color dashboardUserMenuTextDestructive = Color(0xFFFF5252);

  // Texto de Boas Vindas
  static const Color dashboardWelcomeText = Color(0xFFE8EAED);
  static const Color dashboardWelcomeTextSecondary = Color(0xFFB8BABD);
  static const Color dashboardWelcomeTextTertiary = Color(0xFF9AA0A6);
  static const Color dashboardWelcomeIcon = Color(0xFF00D9FF);

  // ===========================================================================
  // 7. CARDS E MÃ‰TRICAS (KPIs) - DINÃ‚MICOS E LEVES
  // ===========================================================================

  static const Color dashboardMetricsCardBackground = Color(0xFF1A1F2E);
  ...
  static const Color dashboardMetricsBlue = Color(0xFFBB86FC);
  static const Color dashboardMetricsPurple = Color(0xFF8B5CF6);
  static const Color dashboardMetricsRed = Color(0xFFFF5252);
  static const Color dashboardMetricsGreen = Color(0xFF00E676);
  static const Color dashboardMetricsOrange = Color(0xFFFFB300);

  // Fundos Sutis para Cards
  static const Color dashboardMetricsBlueLight = Color(0xFF1E3A5F);
  static const Color dashboardMetricsBlueVeryLight = Color(0xFF2A4A6F);
  ...
  static const Color dashboardMetricsRedLight = Color(0xFF3A1F1F);
  static const Color dashboardMetricsRedVeryLight = Color(0xFFFEE2E2);
  static const Color dashboardMetricsGreenLight = Color(0xFF1B3A29);
  ...
  static const Color dashboardMetricsValueText = Color(0xFFE8EAED);
  static const Color dashboardMetricsLabelText = Color(0xFFB8BABD);

  // Cards GenÃ©ricos
  static const Color dashboardCardBackground = Color(0xFF1A1F2E);
  static const Color dashboardCardShadow = Color(0x1A0D9488);
  static const Color dashboardCardTitle = Color(0xFFE8EAED);
  static const Color dashboardCardSubtitle = Color(0xFFB8BABD);

  // ===========================================================================
  // 8. CORES DE MÃ“DULOS - "PALETA MODERNA E DINÃ‚MICA"
  // ===========================================================================

  static const Color moduleDashboard = Color(0xFF00D9FF);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFF00A8CC);

  static const Color moduleProdutos = Color(0xFFBB86FC);        // Fresh Cyan
  static const Color moduleProdutosDark = Color(0xFF0D6F8B);

  static const Color moduleEtiquetas = Color(0xFF00E676);       // Emerald Green
  static const Color moduleEtiquetasDark = Color(0xFF0B7A57);

  static const Color moduleEstrategias = Color(0xFFFF4081);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFFF50057);

  static const Color moduleSincronizacao = Color(0xFFBB86FC);   // Fresh Cyan
  static const Color moduleSincronizacaoDark = Color(0xFF9965F4);

  static const Color modulePrecificacao = Color(0xFFFFB300);    // Amber
  static const Color modulePrecificacaoDark = Color(0xFFD97706);

  static const Color moduleCategorias = Color(0xFF00E676);      // Emerald Green
  static const Color moduleCategoriasDark = Color(0xFF0B7A57);

  static const Color moduleImportacao = Color(0xFF00D9FF);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFF00A8CC);
  ...
  static const Color moduleConfiguracoes = Color(0xFFB8BABD);   // Cinza mÃ©dio
  ...
  static const List<Color> produtosGradient = [Color(0xFFBB86FC), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF00E676), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFFFF4081), Color(0xFFF50057)];
  static const List<Color> sincronizacaoGradient = [Color(0xFFBB86FC), Color(0xFF9965F4)];
  static const List<Color> precificacaoGradient = [Color(0xFFFFB300), Color(0xFFD97706)];
  static const List<Color> categoriasGradient = [Color(0xFF00E676), Color(0xFF0B7A57)];
  static const List<Color> importacaoGradient = [Color(0xFF00D9FF), Color(0xFF00A8CC)];
  static const List<Color> relatÃ³riosGradient = [Color(0xFF059669), Color(0xFF047857)];
  static const List<Color> configuracoesGradient = [Color(0xFFB8BABD), Color(0xFF475569)];

  static const List<Color> successGradient = [Color(0xFF00E676), Color(0xFF059669)];
  static const List<Color> warningGradient = [Color(0xFFFFB300), Color(0xFFD97706)];
  static const List<Color> errorGradient = [Color(0xFFFF5252), Color(0xFFDC2626)];
  static const List<Color> infoGradient = [Color(0xFFBB86FC), Color(0xFF00D9FF)];

  // ===========================================================================
  // 10. ELEMENTOS DE UI GERAIS - "INTERATIVIDADE E FEEDBACK"
  // ===========================================================================

  static const Color disabledButton = Color(0xFF353B4F);
  static const Color disabledText = Color(0xFF9AA0A6);
  static const Color disabled = Color(0xFFCBD5E1);

  static const Color surfaceLow = Color(0xFF242938);
  static const Color surfaceHigh = Color(0xFF1A1F2E);
  static const Color surfaceTinted = Color(0xFF2C3142);
  static const Color surfaceTintedDark = Color(0xFF353B4F);

  // Menu de UsuÃ¡rio
  static const Color userMenuBackgroundStart = Color(0xFF1A1F2E);
  static const Color userMenuBackgroundEnd = Color(0xFF242938);
  static const Color userMenuAvatarBackground = Color(0xFF00D9FF);
  static const Color userMenuAvatarText = Color(0xFF1A1F2E);
  static const Color userMenuHighlight = Color(0xFF2C3142);
  static const Color menuItemHover = Color(0xFF242938);
  static const Color avatarBackground = Color(0xFF00D9FF);
  static const Color avatarText = Color(0xFF1A1F2E);
  static const Color destructive = Color(0xFFFF5252);

  // Ãcones
  static const Color iconDefault = Color(0xFFB8BABD);
  static const Color iconLight = Color(0xFF9AA0A6);
  static const Color iconOnSurface = Color(0xFF059669);
  static const Color errorIcon = Color(0xFFFF5252);

  // ===========================================================================
  // 10.1. CORES CONDICIONAIS E ESTADOS DINÃ‚MICOS
  // ===========================================================================

  static const Color connectionOnline = Color(0xFF00E676);
  static const Color connectionOffline = Color(0xFFFF5252);
  static const Color connectionPending = Color(0xFFFFB300);
  static const Color connectionSyncing = Color(0xFFBB86FC);

  static const Color batteryHigh = Color(0xFF00E676);
  static const Color batteryMedium = Color(0xFFFFB300);
  static const Color batteryLow = Color(0xFFFF5252);
  static const Color batteryCritical = Color(0xFFDC2626);

  static const Color erpConnected = Color(0xFF00E676);
  static const Color erpDisconnected = Color(0xFFFF5252);
  static const Color erpError = Color(0xFFDC2626);
  static const Color erpSyncing = Color(0xFFBB86FC);

  static const Color tagOnline = Color(0xFF00E676);
  static const Color tagOffline = Color(0xFFFF5252);
  static const Color tagPending = Color(0xFFFFB300);
  static const Color tagError = Color(0xFFDC2626);

  static const Color productActive = Color(0xFF00E676);
  static const Color productInactive = Color(0xFF9AA0A6);
  static const Color productOutOfStock = Color(0xFFFF5252);
  static const Color productLowStock = Color(0xFFFFB300);

  // ===========================================================================
  // 11. CORES DE CATEGORIAS - "VARIEDADE MODERNA"
  // ===========================================================================

  static const Color categoryBebidas = Color(0xFFBB86FC);
  static const Color categoryBebidasDark = Color(0xFF0D6F8B);

  static const Color categoryMercearia = Color(0xFFFFB300);
  static const Color categoryMerceariaDark = Color(0xFFD97706);

  static const Color categoryPereciveis = Color(0xFF00E676);
  static const Color categoryPereciveisDark = Color(0xFF0B7A57);

  static const Color categoryLimpeza = Color(0xFFBB86FC);
  static const Color categoryLimpezaDark = Color(0xFF9965F4);

  static const Color categoryHigiene = Color(0xFFEC4899);
  static const Color categoryHigieneDark = Color(0xFFDB2777);

  static const Color categoryHortifruti = Color(0xFFFF4081);
  static const Color categoryHortifrutiDark = Color(0xFFF50057);

  static const Color categoryFrios = Color(0xFF00D9FF);
  static const Color categoryFriosDark = Color(0xFF00A8CC);
  ...
  static const Color erpSAP = Color(0xFFBB86FC);
  static const Color erpTOTVS = Color(0xFFBB86FC);
  static const Color erpOracle = Color(0xFFFF5252);
  static const Color erpSenior = Color(0xFF00E676);
  static const Color erpSankhya = Color(0xFFFF4081);
  static const Color erpOmie = Color(0xFF00D9FF);
  static const Color erpBling = Color(0xFFB8BABD);

  // ===========================================================================
  // 13. ROLES E STATUS DE USUÃRIO - CORES FUNCIONAIS
  // ===========================================================================

  static const Color roleSuperAdmin = Color(0xFFFF5252);
  static const Color roleAdmin = Color(0xFF00E676);
  static const Color roleManager = Color(0xFFBB86FC);
  static const Color roleOperator = Color(0xFFFFB300);
  static const Color roleViewer = Color(0xFFB8BABD);
  static const Color rolePlus = Color(0xFF6366F1);

  static const Color statusActive = Color(0xFF00E676);
  static const Color statusInactive = Color(0xFF9AA0A6);
  static const Color statusPending = Color(0xFFFFB300);
  static const Color statusBlocked = Color(0xFFFF5252);
  ...
  static const Color grey50 = Color(0xFF242938);
  static const Color grey100 = Color(0xFF2C3142);
  static const Color grey200 = Color(0xFF353B4F);
  static const Color grey300 = Color(0xFFCBD5E1);
  static const Color grey400 = Color(0xFF9AA0A6);
  static const Color grey500 = Color(0xFFB8BABD);
  static const Color grey600 = Color(0xFF475569);
  static const Color grey700 = Color(0xFF334155);
  static const Color grey800 = Color(0xFFE8EAED);
  static const Color grey900 = Color(0xFF0F172A);
  static const Color greySlate = Color(0xFFB8BABD);
  static const Color greyDarkSlate = Color(0xFFE8EAED);

  static const Color grey500Overlay10 = Color(0x1A64748B);

  // BÃ¡sicos
  static const Color neutralWhite = Color(0xFF1A1F2E);
  static const Color neutralBlack = Color(0xFFE8EAED);
  ...
  static const Color info = Color(0xFFBB86FC);
  ...
  static const Color materialBlue = Color(0xFFBB86FC);
  static const Color materialPurple = Color(0xFF8B5CF6);
  static const Color materialRed = Color(0xFFFF5252);
  static const Color materialGreen = Color(0xFF00E676);
  static const Color materialOrange = Color(0xFFFFB300);
  static const Color materialTeal = Color(0xFF00D9FF);

  // Shades Auxiliares
  static const Color blue50 = Color(0xFF1E3A5F);
  static const Color blue100 = Color(0xFF2A4A6F);
  static const Color blue200 = Color(0xFF99F6E4);
  static const Color blue = Color(0xFFBB86FC);

  static const Color red50 = Color(0xFF3A1F1F);
  static const Color red100 = Color(0xFFFEE2E2);
  static const Color red200 = Color(0xFFFECACA);
  static const Color red400 = Color(0xFFF87171);
  static const Color red = Color(0xFFFF5252);

  static const Color orange50 = Color(0xFF3D2E1F);
  static const Color orange100 = Color(0xFF3D2E1F);

  static const Color green50 = Color(0xFF1B3A29);
  static const Color green200 = Color(0xFFA7F3D0);
  static const Color green = Color(0xFF00E676);
  static const Color green700 = Color(0xFF047857);

  static const Color white = Color(0xFF1A1F2E);
  static const Color white70 = Color(0xB3FFFFFF);
  static const Color white60 = Color(0x99FFFFFF);
  static const Color white90 = Color(0xE6FFFFFF);
  static const Color white80 = Color(0xCCFFFFFF);

  static const Color black = Color(0xFFE8EAED);
  ...
  static const Color brandPrimaryTeal = Color(0xFF00D9FF);
  static const Color brandPrimaryTealDark = Color(0xFF00A8CC);
  static const Color brandPrimaryTealLight = Color(0xFF66E3FF);
  static const Color brandAccentLime = Color(0xFFFF4081);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFF00D9FF), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFFBB86FC);
  static const Color categoryVisualizarDark = Color(0xFF0D6F8B);

  static const Color categoryNova = Color(0xFF00E676);
  static const Color categoryNovaDark = Color(0xFF0B7A57);

  static const Color categoryProdutos = Color(0xFF00D9FF);
  static const Color categoryProdutosDark = Color(0xFF00A8CC);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFFFF4081);
  static const Color categoryStatsDark = Color(0xFFF50057);

  static const Color categoryImportExport = Color(0xFF00D9FF);
  static const Color categoryImportExportDark = Color(0xFF00A8CC);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFFBB86FC);
  static const Color importProdutosDark = Color(0xFF0D6F8B);

  static const Color importTags = Color(0xFF00E676);
  static const Color importTagsDark = Color(0xFF0B7A57);

  static const Color exportProdutos = Color(0xFFFF4081);
  static const Color exportProdutosDark = Color(0xFFF50057);

  static const Color exportTags = Color(0xFF22C55E);
  static const Color exportTagsDark = Color(0xFF16A34A);

  static const Color batchOperations = Color(0xFFFFB300);
  static const Color batchOperationsDark = Color(0xFFD97706);

  static const Color importHistorico = Color(0xFFBB86FC);
  static const Color importHistoricoDark = Color(0xFF9965F4);

  // Stats Cards - Fundos claros e frescos
  static const Color statTagsBackground = Color(0xFF2C3142);
  static const Color statTagsIcon = Color(0xFF00E676);
  static const Color statTagsBorder = Color(0xFFA7F3D0);

  static const Color statVendasBackground = Color(0xFF242938);
  ...
  static const Color statInsightsIcon = Color(0xFFFF4081);
  static const Color statInsightsBorder = Color(0xFFD9F99D);

  static const Color statLogsBackground = Color(0xFF1E3A5F);
  static const Color statLogsIcon = Color(0xFFBB86FC);
  static const Color statLogsBorder = Color(0xFF99F6E4);

  // Cards de AÃ§Ãµes RÃ¡pidas - CORES VIBRANTES
  static const Color quickActionTemplateBackground = Color(0xFFBB86FC);
  static const Color quickActionTemplateIcon = Color(0xFF1A1F2E);
  static const Color quickActionTemplateBorder = Color(0xFF0D6F8B);

  static const Color quickActionUploadBackground = Color(0xFF00E676);
  static const Color quickActionUploadIcon = Color(0xFF1A1F2E);
  static const Color quickActionUploadBorder = Color(0xFF0B7A57);

  static const Color quickActionHistoricoBackground = Color(0xFFBB86FC);
  static const Color quickActionHistoricoIcon = Color(0xFF1A1F2E);
  static const Color quickActionHistoricoBorder = Color(0xFF9965F4);

  // Cards de AÃ§Ãµes - EstratÃ©gias
  static const Color strategyCardSugestoesBackground = Color(0xFFF7FEE7);
  static const Color strategyCardSugestoesIcon = Color(0xFFFF4081);
  static const Color strategyCardSugestoesBorder = Color(0xFFD9F99D);

  static const Color strategyCardSecondaryBackground = Color(0xFF2C3142);
  static const Color strategyCardSecondaryIcon = Color(0xFF00E676);
  ...
  static const Color statsOverviewBackground1 = Color(0xFF1A1F2E);
  static const Color statsOverviewBackground2 = Color(0xFF242938);

  static const Color quickActionsReportsBackground1 = Color(0xFF1A1F2E);
  static const Color quickActionsReportsBackground2 = Color(0xFF242938);

  static const Color quickActionsImportBackground1 = Color(0xFF1A1F2E);
  static const Color quickActionsImportBackground2 = Color(0xFF242938);
  ...
  static const Color statsOverviewImportBackground1 = Color(0xFF1E3A5F);
  static const Color statsOverviewImportBackground2 = Color(0xFF2A4A6F);

  // ===========================================================================
  // AÃ‡Ã•ES RÃPIDAS - BOTÃ•ES VIBRANTES E FUNCIONAIS
  // ===========================================================================

  static const Color quickActionExportarTudo = Color(0xFFBB86FC);
  static const Color quickActionAgendar = Color(0xFFFF4081);
  static const Color quickActionEmail = Color(0xFF00E676);

  // ===========================================================================
  // PAINEL ADMINISTRATIVO - CORES CLARAS E PROFISSIONAIS
  // ===========================================================================

  static const Color adminPanelBackground1 = Color(0xFF1A1F2E);
  static const Color adminPanelBackground2 = Color(0xFF242938);

  static const Color adminPanelButtonLojas = Color(0xFFBB86FC);
  static const Color adminPanelButtonUsuarios = Color(0xFF00E676);
  static const Color adminPanelButtonConfig = Color(0xFFB8BABD);

  // ===========================================================================
  // PRIMEIROS PASSOS (Onboarding Light) - GUIA SUAVE
  // ===========================================================================

  static const Color onboardingBackground1 = Color(0xFF2C3142);
  static const Color onboardingBackground2 = Color(0xFF353B4F);
  static const Color onboardingBorder = Color(0xFFCBD5E1);

  static const Color onboardingIcon = Color(0xFF00D9FF);
  static const Color onboardingProgress = Color(0xFF00A8CC);

  static const Color onboardingStepCompleted = Color(0xFF00D9FF);
  static const Color onboardingStepPending = Color(0xFFBB86FC);
  static const Color onboardingStepPendingBg = Color(0xFF1E3A5F);

  // ===========================================================================
  // PRÃ“XIMO PASSO - INDICAÃ‡ÃƒO CLARA
  // ===========================================================================

  static const Color nextStepBackground1 = Color(0xFF2C3142);
  static const Color nextStepBackground2 = Color(0xFF353B4F);
  static const Color nextStepBorder = Color(0xFFCBD5E1);
  static const Color nextStepIcon = Color(0xFF00D9FF);
  static const Color nextStepTitle = Color(0xFFE8EAED);

  // Stats ImportaÃ§Ã£o - CORES FUNCIONAIS
  static const Color statProdutosBackground = Color(0xFF1E3A5F);
  static const Color statProdutosIcon = Color(0xFFBB86FC);
  static const Color statProdutosBorder = Color(0xFF99F6E4);

  static const Color statTagsESLBackground = Color(0xFF2C3142);
  static const Color statTagsESLIcon = Color(0xFF00E676);
  static const Color statTagsESLBorder = Color(0xFFA7F3D0);

  static const Color statSyncBackground = Color(0xFF1E3A5F);
  static const Color statSyncIcon = Color(0xFFBB86FC);
  static const Color statSyncBorder = Color(0xFF99F6E4);

  static const Color statPendentesBackground = Color(0xFFFFFBEB);
  static const Color statPendentesIcon = Color(0xFFFFB300);
  static const Color statPendentesBorder = Color(0xFFFDE68A);

  // RelatÃ³rios - CORES DINÃ‚MICAS
  static const Color reportOperacional = Color(0xFF00D9FF);
  static const Color reportOperacionalDark = Color(0xFF00A8CC);

  static const Color reportVendas = Color(0xFF00E676);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFFFF4081);
  static const Color reportPerformanceDark = Color(0xFFF50057);

  static const Color reportauditoria = Color(0xFFBB86FC);
  ...
  static const Color pricingPercentage = Color(0xFFBB86FC);
  static const Color pricingPercentageDark = Color(0xFF0D6F8B);
  static const Color pricingFixedValue = Color(0xFF00E676);
  static const Color pricingFixedValueDark = Color(0xFF0B7A57);
  static const Color pricingIndividual = Color(0xFFFF4081);
  static const Color pricingIndividualDark = Color(0xFFF50057);
  static const Color pricingMarginReview = Color(0xFFBB86FC);
  static const Color pricingMarginReviewDark = Color(0xFF9965F4);
  static const Color pricingDynamic = Color(0xFF00D9FF);
  static const Color pricingDynamicDark = Color(0xFF00A8CC);
  static const Color pricingHistory = Color(0xFFBB86FC);
  static const Color pricingHistoryDark = Color(0xFF0D6F8B);

  static const Color syncComplete = Color(0xFF00E676);
  ...
  static const Color syncSettings = Color(0xFF00D9FF);
  static const Color syncSettingsDark = Color(0xFF00A8CC);
  ...
  static const Color alertWarningIcon = Color(0xFFFFB300);
  static const Color alertRedMain = Color(0xFFFF5252);

  static const Color infoCardBg = Color(0xFF1E3A5F);
  static const Color infoCardBorder = Color(0xFF99F6E4);
  static const Color infoCardText = Color(0xFF0F766E);

  static const Color tipCardBg = Color(0xFF2C3142);
  static const Color tipCardBorder = Color(0xFFA7F3D0);
  static const Color tipCardText = Color(0xFF00A8CC);
  ...
  static const Color successCardBg = Color(0xFF1B3A29);
  static const Color successCardBorder = Color(0xFFA7F3D0);
  static const Color successCardText = Color(0xFF00A8CC);

  static const Color errorCardBg = Color(0xFF3A1F1F);
  static const Color errorCardBorder = Color(0xFFFECACA);
  static const Color errorCardText = Color(0xFF991B1B);

  static const Color syncedBg = Color(0xFF2C3142);
  static const Color syncedBorder = Color(0xFFA7F3D0);
  static const Color syncedIcon = Color(0xFF00E676);

  static const Color syncPendingBg = Color(0xFFFFFBEB);
  static const Color syncPendingBorder = Color(0xFFFDE68A);
  static const Color syncPendingIcon = Color(0xFFFFB300);

  static const Color syncErrorBg = Color(0xFF3A1F1F);
  static const Color syncErrorBorder = Color(0xFFFECACA);
  static const Color syncErrorIcon = Color(0xFFFF5252);

  static const Color notSyncedBg = Color(0xFF242938);
  static const Color notSyncedBorder = Color(0xFF353B4F);
  static const Color notSyncedIcon = Color(0xFF9AA0A6);
  ...
  static const Color darkBackground = Color(0xFF242938);
  static const Color darkCard = Color(0xFF1A1F2E);
  static const Color darkDialog = Color(0xFF1A1F2E);
  static const Color darkInput = Color(0xFF242938);
  static const Color darkDropdown = Color(0xFF1A1F2E);
  ...
  static const Color statusBlueGrey = Color(0xFFB8BABD);
  static const Color statusBlueGreyLight = Color(0xFF9AA0A6);
  static const Color statusBlueGreyBg = Color(0xFF242938);

  static const Color gradientDarkTeal = Color(0xFF00D9FF);
  static const Color gradientDarkTealLight = Color(0xFF66E3FF);
  ...
  static const Color gradientSugestoesStart = Color(0xFFFF4081);
  static const Color gradientSugestoesEnd = Color(0xFF00E676);

  static const Color gradientDarkStart = Color(0xFF00E676);
  ...
  static const Color strategyOrangeDark = Color(0xFFF50057);
  ...
  static const Color greenMain = Color(0xFF00E676);
  static const Color greenTeal = Color(0xFFBB86FC);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFF66E3FF);
  static const Color greenMaterial = Color(0xFF00E676);
  static const Color successMaterial = Color(0xFF00E676);
  static const Color greenDark = Color(0xFF059669);
  static const Color greenLightMaterial = Color(0xFF6EE7B7);

  static const Color blueMain = Color(0xFFBB86FC);
  static const Color blueCyan = Color(0xFFBB86FC);
  static const Color blueMaterial = Color(0xFFBB86FC);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFF00A8CC);

  static const Color cyanMain = Color(0xFFBB86FC);
  static const Color cyanDark = Color(0xFF9965F4);
  static const Color tealMain = Color(0xFFBB86FC);
  static const Color cyanGradientStart = Color(0xFF22D3EE);
  static const Color cyanGradientEnd = Color(0xFF9965F4);
  ...
  static const Color orangeAmber = Color(0xFFFFB300);

  static const Color yellowGold = Color(0xFFFFB300);
  static const Color amberMain = Color(0xFFFFB300);
  static const Color amberDark = Color(0xFFD97706);
  static const Color amberLight = Color(0xFFFCD34D);

  static const Color redMain = Color(0xFFFF5252);
  ...
  static const Color infoPastel = Color(0xFF1E3A5F);
  static const Color successPastel = Color(0xFF1B3A29);
  static const Color warningPastel = Color(0xFFFFFBEB);
  static const Color errorPastel = Color(0xFF3A1F1F);
  static const Color redPastel = Color(0xFF3A1F1F);
  static const Color primaryPastel = Color(0xFF2C3142);

  static const Color alertWarningBackground = Color(0xFFFFFBEB);
  static const Color alertErrorBackground = Color(0xFF3A1F1F);
  ...
  static const Color alertErrorCardBackground = Color(0xFF3A1F1F);
  ...
  static const Color infoModuleBackground = Color(0xFF1E3A5F);
  static const Color infoModuleBackgroundAlt = Color(0xFF2A4A6F);
  static const Color infoModuleBorder = Color(0xFF99F6E4);
  static const Color infoModuleText = Color(0xFF0F766E);
  static const Color infoModuleIcon = Color(0xFFBB86FC);

  static const Color suggestionCardStart = Color(0xFF00E676);
  static const Color suggestionCardEnd = Color(0xFF059669);
  static const Color suggestionAumentosBackground = Color(0xFF2C3142);
  static const Color suggestionAumentosText = Color(0xFFE8EAED);
  ...
  static const Color mintPastel = Color(0xFF2C3142);
  static const Color pinkPastel = Color(0xFFFDF2F8);
  static const Color bluePastel = Color(0xFF1E3A5F);
  static const Color surfacePastel = Color(0xFF242938);
