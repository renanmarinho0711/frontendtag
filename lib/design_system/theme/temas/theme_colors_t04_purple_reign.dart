...
/// ==============================================================================
/// TEMA: PURPLE REIGN - Roxo Imperial
/// ==============================================================================
///
/// Conceito Visual:
/// Fundo branco, cards roxo vibrante, elegÃ¢ncia moderna
...
class AppThemeColors {
  ...
  static const Color infoIcon = Color(0xFFD946EF);
  static const Color infoDark = Color(0xFF9333EA);
  ...
  static const Color successText = Color(0xFF7E22CE);
  ...
  static const Color primaryDashboard = Color(0xFF9333EA);
  static const Color primaryDashboardDark = Color(0xFF7E22CE);
  ...
  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFF9333EA);
  ...
  static const Color dashboardDrawerItemTextSelected = Color(0xFF9333EA);
  ...
  static const Color dashboardBottomNavIconSelected = Color(0xFF9333EA);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFF9333EA);
  ...
  static const Color dashboardRailItemTextSelected = Color(0xFF9333EA);
  static const Color dashboardRailItemTextUnselected = Color(0xFF64748B);

  static const Color dashboardLogoIconColor = Color(0xFF9333EA);
  ...
  static const Color dashboardNotificationIcon = Color(0xFF9333EA);
  ...
  static const Color dashboardUserMenuAvatarBg = Color(0xFF9333EA);
  ...
  static const Color dashboardWelcomeIcon = Color(0xFF9333EA);
  ...
  static const Color dashboardMetricsBlue = Color(0xFFD946EF);
  ...
  static const Color moduleDashboard = Color(0xFF9333EA);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFF7E22CE);

  static const Color moduleProdutos = Color(0xFFD946EF);        // Fresh Cyan
  ...
  static const Color moduleEstrategias = Color(0xFF06B6D4);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFF65A30D);

  static const Color moduleSincronizacao = Color(0xFFD946EF);   // Fresh Cyan
  static const Color moduleSincronizacaoDark = Color(0xFFC026D3);
  ...
  static const Color moduleImportacao = Color(0xFF9333EA);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFF7E22CE);
  ...
  static const List<Color> produtosGradient = [Color(0xFFD946EF), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF10B981), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFF06B6D4), Color(0xFF65A30D)];
  static const List<Color> sincronizacaoGradient = [Color(0xFFD946EF), Color(0xFFC026D3)];
  ...
  static const List<Color> importacaoGradient = [Color(0xFF9333EA), Color(0xFF7E22CE)];
  ...
  static const List<Color> infoGradient = [Color(0xFFD946EF), Color(0xFF9333EA)];
  ...
  static const Color userMenuAvatarBackground = Color(0xFF9333EA);
  ...
  static const Color avatarBackground = Color(0xFF9333EA);
  ...
  static const Color connectionSyncing = Color(0xFFD946EF);
  ...
  static const Color erpSyncing = Color(0xFFD946EF);
  ...
  static const Color categoryBebidas = Color(0xFFD946EF);
  ...
  static const Color categoryLimpeza = Color(0xFFD946EF);
  static const Color categoryLimpezaDark = Color(0xFFC026D3);

  static const Color categoryHigiene = Color(0xFFEC4899);
  static const Color categoryHigieneDark = Color(0xFFDB2777);

  static const Color categoryHortifruti = Color(0xFF06B6D4);
  static const Color categoryHortifrutiDark = Color(0xFF65A30D);

  static const Color categoryFrios = Color(0xFF9333EA);
  static const Color categoryFriosDark = Color(0xFF7E22CE);
  ...
  static const Color erpSAP = Color(0xFFD946EF);
  static const Color erpTOTVS = Color(0xFFD946EF);
  static const Color erpOracle = Color(0xFFEF4444);
  static const Color erpSenior = Color(0xFF10B981);
  static const Color erpSankhya = Color(0xFF06B6D4);
  static const Color erpOmie = Color(0xFF9333EA);
  ...
  static const Color roleManager = Color(0xFFD946EF);
  ...
  static const Color info = Color(0xFFD946EF);
  ...
  static const Color materialBlue = Color(0xFFD946EF);
  ...
  static const Color materialTeal = Color(0xFF9333EA);
  ...
  static const Color blue = Color(0xFFD946EF);
  ...
  static const Color brandPrimaryTeal = Color(0xFF9333EA);
  static const Color brandPrimaryTealDark = Color(0xFF7E22CE);
  static const Color brandPrimaryTealLight = Color(0xFFA855F7);
  static const Color brandAccentLime = Color(0xFF06B6D4);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFF9333EA), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFFD946EF);
  ...
  static const Color categoryProdutos = Color(0xFF9333EA);
  static const Color categoryProdutosDark = Color(0xFF7E22CE);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFF06B6D4);
  static const Color categoryStatsDark = Color(0xFF65A30D);

  static const Color categoryImportExport = Color(0xFF9333EA);
  static const Color categoryImportExportDark = Color(0xFF7E22CE);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFFD946EF);
  ...
  static const Color exportProdutos = Color(0xFF06B6D4);
  ...
  static const Color importHistorico = Color(0xFFD946EF);
  static const Color importHistoricoDark = Color(0xFFC026D3);
  ...
  static const Color quickActionHistoricoBackground = Color(0xFFD946EF);
  static const Color quickActionHistoricoIcon = Color(0xFFFFFFFF);
  static const Color quickActionHistoricoBorder = Color(0xFFC026D3);

  // Cards de AÃ§Ãµes - EstratÃ©gias
  static const Color strategyCardSugestoesBackground = Color(0xFFF7FEE7);
  static const Color strategyCardSugestoesIcon = Color(0xFF06B6D4);
  ...
  static const Color quickActionExportarTudo = Color(0xFFD946EF);
  static const Color quickActionAgendar = Color(0xFF06B6D4);
  ...
  static const Color adminPanelButtonLojas = Color(0xFFD946EF);
  ...
  static const Color onboardingIcon = Color(0xFF9333EA);
  static const Color onboardingProgress = Color(0xFF7E22CE);

  static const Color onboardingStepCompleted = Color(0xFF9333EA);
  static const Color onboardingStepPending = Color(0xFFD946EF);
  ...
  static const Color nextStepIcon = Color(0xFF9333EA);
  ...
  static const Color statProdutosIcon = Color(0xFFD946EF);
  ...
  static const Color statSyncIcon = Color(0xFFD946EF);
  ...
  static const Color reportOperacional = Color(0xFF9333EA);
  static const Color reportOperacionalDark = Color(0xFF7E22CE);

  static const Color reportVendas = Color(0xFF10B981);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFF06B6D4);
  static const Color reportPerformanceDark = Color(0xFF65A30D);

  static const Color reportauditoria = Color(0xFFD946EF);
  ...
  static const Color pricingPercentage = Color(0xFFD946EF);
  ...
  static const Color pricingIndividual = Color(0xFF06B6D4);
  static const Color pricingIndividualDark = Color(0xFF65A30D);
  static const Color pricingMarginReview = Color(0xFFD946EF);
  static const Color pricingMarginReviewDark = Color(0xFFC026D3);
  static const Color pricingDynamic = Color(0xFF9333EA);
  static const Color pricingDynamicDark = Color(0xFF7E22CE);
  static const Color pricingHistory = Color(0xFFD946EF);
  ...
  static const Color syncSettings = Color(0xFF9333EA);
  static const Color syncSettingsDark = Color(0xFF7E22CE);
  ...
  static const Color tipCardText = Color(0xFF7E22CE);
  ...
  static const Color successCardText = Color(0xFF7E22CE);
  ...
  static const Color gradientDarkTeal = Color(0xFF9333EA);
  static const Color gradientDarkTealLight = Color(0xFFA855F7);
  ...
  static const Color gradientSugestoesStart = Color(0xFF06B6D4);
  ...
  static const Color greenTeal = Color(0xFFD946EF);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFFA855F7);
  ...
  static const Color blueMain = Color(0xFFD946EF);
  static const Color blueCyan = Color(0xFFD946EF);
  static const Color blueMaterial = Color(0xFFD946EF);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFF7E22CE);

  static const Color cyanMain = Color(0xFFD946EF);
  static const Color cyanDark = Color(0xFFC026D3);
  static const Color tealMain = Color(0xFFD946EF);
  static const Color cyanGradientStart = Color(0xFF22D3EE);
  static const Color cyanGradientEnd = Color(0xFFC026D3);
  ...
  static const Color infoModuleIcon = Color(0xFFD946EF);
