...
/// ==============================================================================
/// TEMA: ENERGETIC SPORT - Tema Esportivo EnergÃ©tico
/// ==============================================================================
///
/// Conceito Visual:
/// Cores vibrantes e energÃ©ticas - verde limÃ£o, laranja, azul elÃ©trico
...
class AppThemeColors {
  ...
  static const Color inputBackground = Color(0xFFDCEDC8);

  /// Fundo secundÃ¡rio para Ã¡reas de separaÃ§Ã£o. Cinza claro e neutro.
  static const Color backgroundMedium = Color(0xFFC5E1A5);
  ...
  static const Color textPrimary = Color(0xFF33691E);
  ...
  static const Color borderLight = Color(0xFFC5E1A5);

  /// Borda mÃ©dia para elementos interativos.
  static const Color borderMedium = Color(0xFFCBD5E1);

  /// Borda escura para destaque sutil.
  static const Color borderDark = Color(0xFF558B2F);
  ...
  static const Color infoIcon = Color(0xFF00B0FF);
  static const Color infoDark = Color(0xFF8BC34A);
  ...
  static const Color successText = Color(0xFF689F38);
  ...
  static const Color warningIcon = Color(0xFFFFEA00);
  ...
  static const Color primaryDashboard = Color(0xFF8BC34A);
  static const Color primaryDashboardDark = Color(0xFF689F38);

  // AppBar
  static const Color dashboardAppBarBackground = Color(0xFFF1F8E9);
  static const Color dashboardAppBarShadow = Color(0x1A0D9488);

  // Menu Lateral (Drawer)
  static const Color dashboardDrawerBackground1 = Color(0xFFF1F8E9);
  static const Color dashboardDrawerBackground2 = Color(0xFFDCEDC8);

  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFF8BC34A);
  static const Color dashboardDrawerHeaderIconBg = Color(0xFFC5E1A5);
  static const Color dashboardDrawerHeaderText = Color(0xFF33691E);
  static const Color dashboardDrawerHeaderTextSecondary = Color(0xFF558B2F);
  static const Color dashboardDrawerItemSelected = Color(0xFFC5E1A5);
  static const Color dashboardDrawerItemUnselected = transparent;
  static const Color dashboardDrawerItemTextSelected = Color(0xFF8BC34A);
  static const Color dashboardDrawerItemTextUnselected = Color(0xFF558B2F);

  // Bottom Navigation
  static const Color dashboardBottomNavBackground = Color(0xFFF1F8E9);
  static const Color dashboardBottomNavShadow = Color(0x1A0D9488);
  static const Color dashboardBottomNavIconSelected = Color(0xFF8BC34A);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFF8BC34A);
  static const Color dashboardBottomNavTextUnselected = Color(0xFF94A3B8);

  // Navigation Rail
  static const Color dashboardRailBackground = Color(0xFFF1F8E9);
  static const Color dashboardRailShadow = Color(0x1A0D9488);
  static const Color dashboardRailToggleBackground = Color(0xFFDCEDC8);
  static const Color dashboardRailToggleIcon = Color(0xFF558B2F);
  static const Color dashboardRailItemIconSelected = Color(0xFFF1F8E9);
  static const Color dashboardRailItemIconUnselected = Color(0xFF558B2F);
  static const Color dashboardRailItemTextSelected = Color(0xFF8BC34A);
  static const Color dashboardRailItemTextUnselected = Color(0xFF558B2F);

  static const Color dashboardLogoIconColor = Color(0xFF8BC34A);

  // Barra de Busca
  static const Color dashboardSearchBackground = Color(0xFFDCEDC8);
  static const Color dashboardSearchHint = Color(0xFF94A3B8);
  static const Color dashboardSearchIcon = Color(0xFF558B2F);

  // NotificaÃ§Ãµes e Badges
  static const Color dashboardNotificationBackground = Color(0xFFC5E1A5);
  static const Color dashboardNotificationBadge = Color(0xFFEF4444);
  static const Color dashboardNotificationIcon = Color(0xFF8BC34A);

  // Status de ConexÃ£o
  static const Color dashboardConnectionBackground = Color(0xFFC5E1A5);
  ...
  static const Color dashboardConnectionText = Color(0xFF33691E);

  // User Menu
  static const Color dashboardUserMenuBackground1 = Color(0xFFF1F8E9);
  static const Color dashboardUserMenuBackground2 = Color(0xFFDCEDC8);
  static const Color dashboardUserMenuAvatarBg = Color(0xFF8BC34A);
  static const Color dashboardUserMenuAvatarText = Color(0xFFF1F8E9);
  static const Color dashboardUserMenuText = Color(0xFF33691E);
  static const Color dashboardUserMenuTextSecondary = Color(0xFF558B2F);
  static const Color dashboardUserMenuIcon = Color(0xFF558B2F);
  ...
  static const Color dashboardWelcomeText = Color(0xFF33691E);
  static const Color dashboardWelcomeTextSecondary = Color(0xFF558B2F);
  static const Color dashboardWelcomeTextTertiary = Color(0xFF94A3B8);
  static const Color dashboardWelcomeIcon = Color(0xFF8BC34A);

  // ===========================================================================
  // 7. CARDS E MÃ‰TRICAS (KPIs) - DINÃ‚MICOS E LEVES
  // ===========================================================================

  static const Color dashboardMetricsCardBackground = Color(0xFFF1F8E9);
  ...
  static const Color dashboardMetricsBlue = Color(0xFF00B0FF);
  ...
  static const Color dashboardMetricsOrange = Color(0xFFFFEA00);
  ...
  static const Color dashboardMetricsValueText = Color(0xFF33691E);
  static const Color dashboardMetricsLabelText = Color(0xFF558B2F);

  // Cards GenÃ©ricos
  static const Color dashboardCardBackground = Color(0xFFF1F8E9);
  static const Color dashboardCardShadow = Color(0x1A0D9488);
  static const Color dashboardCardTitle = Color(0xFF33691E);
  static const Color dashboardCardSubtitle = Color(0xFF558B2F);

  // ===========================================================================
  // 8. CORES DE MÃ“DULOS - "PALETA MODERNA E DINÃ‚MICA"
  // ===========================================================================

  static const Color moduleDashboard = Color(0xFF8BC34A);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFF689F38);

  static const Color moduleProdutos = Color(0xFF00B0FF);        // Fresh Cyan
  ...
  static const Color moduleEstrategias = Color(0xFFFF6D00);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFFFF5722);

  static const Color moduleSincronizacao = Color(0xFF00B0FF);   // Fresh Cyan
  static const Color moduleSincronizacaoDark = Color(0xFF0091EA);

  static const Color modulePrecificacao = Color(0xFFFFEA00);    // Amber
  ...
  static const Color moduleImportacao = Color(0xFF8BC34A);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFF689F38);
  ...
  static const Color moduleConfiguracoes = Color(0xFF558B2F);   // Cinza mÃ©dio
  ...
  static const List<Color> produtosGradient = [Color(0xFF00B0FF), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF00E676), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFFFF6D00), Color(0xFFFF5722)];
  static const List<Color> sincronizacaoGradient = [Color(0xFF00B0FF), Color(0xFF0091EA)];
  static const List<Color> precificacaoGradient = [Color(0xFFFFEA00), Color(0xFFD97706)];
  static const List<Color> categoriasGradient = [Color(0xFF00E676), Color(0xFF0B7A57)];
  static const List<Color> importacaoGradient = [Color(0xFF8BC34A), Color(0xFF689F38)];
  static const List<Color> relatÃ³riosGradient = [Color(0xFF059669), Color(0xFF047857)];
  static const List<Color> configuracoesGradient = [Color(0xFF558B2F), Color(0xFF475569)];

  static const List<Color> successGradient = [Color(0xFF00E676), Color(0xFF059669)];
  static const List<Color> warningGradient = [Color(0xFFFFEA00), Color(0xFFD97706)];
  static const List<Color> errorGradient = [Color(0xFFEF4444), Color(0xFFDC2626)];
  static const List<Color> infoGradient = [Color(0xFF00B0FF), Color(0xFF8BC34A)];
  ...
  static const Color surfaceLow = Color(0xFFDCEDC8);
  static const Color surfaceHigh = Color(0xFFF1F8E9);
  static const Color surfaceTinted = Color(0xFFC5E1A5);
  static const Color surfaceTintedDark = Color(0xFFE2E8F0);

  // Menu de UsuÃ¡rio
  static const Color userMenuBackgroundStart = Color(0xFFF1F8E9);
  static const Color userMenuBackgroundEnd = Color(0xFFDCEDC8);
  static const Color userMenuAvatarBackground = Color(0xFF8BC34A);
  static const Color userMenuAvatarText = Color(0xFFF1F8E9);
  static const Color userMenuHighlight = Color(0xFFC5E1A5);
  static const Color menuItemHover = Color(0xFFDCEDC8);
  static const Color avatarBackground = Color(0xFF8BC34A);
  static const Color avatarText = Color(0xFFF1F8E9);
  static const Color destructive = Color(0xFFEF4444);

  // Ãcones
  static const Color iconDefault = Color(0xFF558B2F);
  ...
  static const Color connectionPending = Color(0xFFFFEA00);
  static const Color connectionSyncing = Color(0xFF00B0FF);

  static const Color batteryHigh = Color(0xFF00E676);
  static const Color batteryMedium = Color(0xFFFFEA00);
  ...
  static const Color erpSyncing = Color(0xFF00B0FF);

  static const Color tagOnline = Color(0xFF00E676);
  static const Color tagOffline = Color(0xFFEF4444);
  static const Color tagPending = Color(0xFFFFEA00);
  ...
  static const Color productLowStock = Color(0xFFFFEA00);

  // ===========================================================================
  // 11. CORES DE CATEGORIAS - "VARIEDADE MODERNA"
  // ===========================================================================

  static const Color categoryBebidas = Color(0xFF00B0FF);
  static const Color categoryBebidasDark = Color(0xFF0D6F8B);

  static const Color categoryMercearia = Color(0xFFFFEA00);
  ...
  static const Color categoryLimpeza = Color(0xFF00B0FF);
  static const Color categoryLimpezaDark = Color(0xFF0091EA);

  static const Color categoryHigiene = Color(0xFFEC4899);
  static const Color categoryHigieneDark = Color(0xFFDB2777);

  static const Color categoryHortifruti = Color(0xFFFF6D00);
  static const Color categoryHortifrutiDark = Color(0xFFFF5722);

  static const Color categoryFrios = Color(0xFF8BC34A);
  static const Color categoryFriosDark = Color(0xFF689F38);
  ...
  static const Color erpSAP = Color(0xFF00B0FF);
  static const Color erpTOTVS = Color(0xFF00B0FF);
  static const Color erpOracle = Color(0xFFEF4444);
  static const Color erpSenior = Color(0xFF00E676);
  static const Color erpSankhya = Color(0xFFFF6D00);
  static const Color erpOmie = Color(0xFF8BC34A);
  static const Color erpBling = Color(0xFF558B2F);
  ...
  static const Color roleManager = Color(0xFF00B0FF);
  static const Color roleOperator = Color(0xFFFFEA00);
  static const Color roleViewer = Color(0xFF558B2F);
  ...
  static const Color statusPending = Color(0xFFFFEA00);
  ...
  static const Color grey50 = Color(0xFFDCEDC8);
  static const Color grey100 = Color(0xFFC5E1A5);
  static const Color grey200 = Color(0xFFE2E8F0);
  static const Color grey300 = Color(0xFFCBD5E1);
  static const Color grey400 = Color(0xFF94A3B8);
  static const Color grey500 = Color(0xFF558B2F);
  static const Color grey600 = Color(0xFF475569);
  static const Color grey700 = Color(0xFF334155);
  static const Color grey800 = Color(0xFF33691E);
  static const Color grey900 = Color(0xFF0F172A);
  static const Color greySlate = Color(0xFF558B2F);
  static const Color greyDarkSlate = Color(0xFF33691E);

  static const Color grey500Overlay10 = Color(0x1A64748B);

  // BÃ¡sicos
  static const Color neutralWhite = Color(0xFFF1F8E9);
  static const Color neutralBlack = Color(0xFF33691E);
  ...
  static const Color materialBlue = Color(0xFF00B0FF);
  ...
  static const Color materialOrange = Color(0xFFFFEA00);
  static const Color materialTeal = Color(0xFF8BC34A);
  ...
  static const Color blue = Color(0xFF00B0FF);
  ...
  static const Color white = Color(0xFFF1F8E9);
  static const Color white70 = Color(0xB3FFFFFF);
  static const Color white60 = Color(0x99FFFFFF);
  static const Color white90 = Color(0xE6FFFFFF);
  static const Color white80 = Color(0xCCFFFFFF);

  static const Color black = Color(0xFF33691E);
  ...
  static const Color brandPrimaryTeal = Color(0xFF8BC34A);
  static const Color brandPrimaryTealDark = Color(0xFF689F38);
  static const Color brandPrimaryTealLight = Color(0xFFAED581);
  static const Color brandAccentLime = Color(0xFFFF6D00);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFF8BC34A), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFF00B0FF);
  ...
  static const Color categoryProdutos = Color(0xFF8BC34A);
  static const Color categoryProdutosDark = Color(0xFF689F38);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFFFF6D00);
  static const Color categoryStatsDark = Color(0xFFFF5722);

  static const Color categoryImportExport = Color(0xFF8BC34A);
  static const Color categoryImportExportDark = Color(0xFF689F38);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFF00B0FF);
  ...
  static const Color exportProdutos = Color(0xFFFF6D00);
  static const Color exportProdutosDark = Color(0xFFFF5722);

  static const Color exportTags = Color(0xFF22C55E);
  static const Color exportTagsDark = Color(0xFF16A34A);

  static const Color batchOperations = Color(0xFFFFEA00);
  static const Color batchOperationsDark = Color(0xFFD97706);

  static const Color importHistorico = Color(0xFF00B0FF);
  static const Color importHistoricoDark = Color(0xFF0091EA);

  // Stats Cards - Fundos claros e frescos
  static const Color statTagsBackground = Color(0xFFC5E1A5);
  static const Color statTagsIcon = Color(0xFF00E676);
  static const Color statTagsBorder = Color(0xFFA7F3D0);

  static const Color statVendasBackground = Color(0xFFDCEDC8);
  ...
  static const Color statInsightsIcon = Color(0xFFFF6D00);
  static const Color statInsightsBorder = Color(0xFFD9F99D);

  static const Color statLogsBackground = Color(0xFFF0FDFA);
  static const Color statLogsIcon = Color(0xFF00B0FF);
  static const Color statLogsBorder = Color(0xFF99F6E4);

  // Cards de AÃ§Ãµes RÃ¡pidas - CORES VIBRANTES
  static const Color quickActionTemplateBackground = Color(0xFF00B0FF);
  static const Color quickActionTemplateIcon = Color(0xFFF1F8E9);
  ...
  static const Color quickActionUploadIcon = Color(0xFFF1F8E9);
  static const Color quickActionUploadBorder = Color(0xFF0B7A57);

  static const Color quickActionHistoricoBackground = Color(0xFF00B0FF);
  static const Color quickActionHistoricoIcon = Color(0xFFF1F8E9);
  static const Color quickActionHistoricoBorder = Color(0xFF0091EA);

  // Cards de AÃ§Ãµes - EstratÃ©gias
  static const Color strategyCardSugestoesBackground = Color(0xFFF7FEE7);
  static const Color strategyCardSugestoesIcon = Color(0xFFFF6D00);
  static const Color strategyCardSugestoesBorder = Color(0xFFD9F99D);

  static const Color strategyCardSecondaryBackground = Color(0xFFC5E1A5);
  ...
  static const Color statsOverviewBackground1 = Color(0xFFF1F8E9);
  static const Color statsOverviewBackground2 = Color(0xFFDCEDC8);

  static const Color quickActionsReportsBackground1 = Color(0xFFF1F8E9);
  static const Color quickActionsReportsBackground2 = Color(0xFFDCEDC8);

  static const Color quickActionsImportBackground1 = Color(0xFFF1F8E9);
  static const Color quickActionsImportBackground2 = Color(0xFFDCEDC8);
  ...
  static const Color quickActionExportarTudo = Color(0xFF00B0FF);
  static const Color quickActionAgendar = Color(0xFFFF6D00);
  ...
  static const Color adminPanelBackground1 = Color(0xFFF1F8E9);
  static const Color adminPanelBackground2 = Color(0xFFDCEDC8);

  static const Color adminPanelButtonLojas = Color(0xFF00B0FF);
  static const Color adminPanelButtonUsuarios = Color(0xFF00E676);
  static const Color adminPanelButtonConfig = Color(0xFF558B2F);

  // ===========================================================================
  // PRIMEIROS PASSOS (Onboarding Light) - GUIA SUAVE
  // ===========================================================================

  static const Color onboardingBackground1 = Color(0xFFC5E1A5);
  static const Color onboardingBackground2 = Color(0xFFE2E8F0);
  static const Color onboardingBorder = Color(0xFFCBD5E1);

  static const Color onboardingIcon = Color(0xFF8BC34A);
  static const Color onboardingProgress = Color(0xFF689F38);

  static const Color onboardingStepCompleted = Color(0xFF8BC34A);
  static const Color onboardingStepPending = Color(0xFF00B0FF);
  ...
  static const Color nextStepBackground1 = Color(0xFFC5E1A5);
  static const Color nextStepBackground2 = Color(0xFFE2E8F0);
  static const Color nextStepBorder = Color(0xFFCBD5E1);
  static const Color nextStepIcon = Color(0xFF8BC34A);
  static const Color nextStepTitle = Color(0xFF33691E);

  // Stats ImportaÃ§Ã£o - CORES FUNCIONAIS
  static const Color statProdutosBackground = Color(0xFFF0FDFF);
  static const Color statProdutosIcon = Color(0xFF00B0FF);
  static const Color statProdutosBorder = Color(0xFF99F6E4);

  static const Color statTagsESLBackground = Color(0xFFC5E1A5);
  ...
  static const Color pricingPercentage = Color(0xFF00B0FF);
  ...
  static const Color pricingIndividual = Color(0xFFFF6D00);
  static const Color pricingIndividualDark = Color(0xFFFF5722);
  static const Color pricingMarginReview = Color(0xFF00B0FF);
  static const Color pricingMarginReviewDark = Color(0xFF0091EA);
  static const Color pricingDynamic = Color(0xFF8BC34A);
  static const Color pricingDynamicDark = Color(0xFF689F38);
  static const Color pricingHistory = Color(0xFF00B0FF);
  ...
  static const Color syncSettings = Color(0xFF8BC34A);
  static const Color syncSettingsDark = Color(0xFF689F38);
  ...
  static const Color alertWarningIcon = Color(0xFFFFEA00);
  ...
  static const Color tipCardBg = Color(0xFFC5E1A5);
  static const Color tipCardBorder = Color(0xFFA7F3D0);
  static const Color tipCardText = Color(0xFF689F38);
  ...
  static const Color successCardText = Color(0xFF689F38);
  ...
  static const Color syncedBg = Color(0xFFC5E1A5);
  ...
  static const Color syncPendingIcon = Color(0xFFFFEA00);
  ...
  static const Color notSyncedBg = Color(0xFFDCEDC8);
  ...
  static const Color darkSurface = Color(0xFFF1F8E9);
  static const Color darkBackground = Color(0xFFDCEDC8);
  static const Color darkCard = Color(0xFFF1F8E9);
  static const Color darkDialog = Color(0xFFF1F8E9);
  static const Color darkInput = Color(0xFFDCEDC8);
  static const Color darkDropdown = Color(0xFFF1F8E9);
  ...
  static const Color statusYellow = Color(0xFFFFEA00);
  static const Color statusOrangeDark = Color(0xFFEA580C);
  static const Color statusRedDark = Color(0xFFDC2626);
  static const Color statusBlueGrey = Color(0xFF558B2F);
  static const Color statusBlueGreyLight = Color(0xFF94A3B8);
  static const Color statusBlueGreyBg = Color(0xFFDCEDC8);

  static const Color gradientDarkTeal = Color(0xFF8BC34A);
  static const Color gradientDarkTealLight = Color(0xFFAED581);
  ...
  static const Color gradientSugestoesStart = Color(0xFFFF6D00);
  ...
  static const Color strategyOrangeDark = Color(0xFFFF5722);
  ...
  static const Color greenTeal = Color(0xFF00B0FF);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFFAED581);
  ...
  static const Color blueMain = Color(0xFF00B0FF);
  static const Color blueCyan = Color(0xFF00B0FF);
  static const Color blueMaterial = Color(0xFF00B0FF);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFF689F38);

  static const Color cyanMain = Color(0xFF00B0FF);
  static const Color cyanDark = Color(0xFF0091EA);
  static const Color tealMain = Color(0xFF00B0FF);
  ...
  static const Color orangeAmber = Color(0xFFFFEA00);

  static const Color yellowGold = Color(0xFFFFEA00);
  static const Color amberMain = Color(0xFFFFEA00);
  ...
  static const Color primaryPastel = Color(0xFFC5E1A5);
  ...
  static const Color infoModuleIcon = Color(0xFF00B0FF);

  static const Color suggestionCardStart = Color(0xFF00E676);
  static const Color suggestionCardEnd = Color(0xFF059669);
  static const Color suggestionAumentosBackground = Color(0xFFC5E1A5);
  static const Color suggestionAumentosText = Color(0xFF33691E);
  ...
  static const Color gold = Color(0xFFFFEA00);
  ...
  static const Color mintPastel = Color(0xFFC5E1A5);
  static const Color pinkPastel = Color(0xFFFDF2F8);
  static const Color bluePastel = Color(0xFFF0FDFF);
  static const Color surfacePastel = Color(0xFFDCEDC8);
