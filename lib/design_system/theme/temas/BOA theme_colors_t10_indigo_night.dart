...
/// ==============================================================================
/// TEMA: INDIGO NIGHT - Índigo Noturno
/// ==============================================================================
///
/// Conceito Visual:
/// Fundo branco, cards índigo sólido, profundidade e mistério
...
class AppThemeColors {
  ...
  static const Color successText = Color(0xFF4F46E5);
  ...
  static const Color dashboardMetricsBlue = Color(0xFF8B5CF6);
  ...
  static const Color moduleDashboard = Color(0xFF6366F1);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFF4F46E5);

  static const Color moduleProdutos = Color(0xFF8B5CF6);        // Fresh Cyan
  ...
  static const Color moduleEstrategias = Color(0xFF22D3EE);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFF65A30D);

  static const Color moduleSincronizacao = Color(0xFF8B5CF6);   // Fresh Cyan
  ...
  static const Color moduleImportacao = Color(0xFF6366F1);      // Teal Fresh
  ...
  static const List<Color> produtosGradient = [Color(0xFF8B5CF6), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF10B981), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFF22D3EE), Color(0xFF65A30D)];
  static const List<Color> sincronizacaoGradient = [Color(0xFF8B5CF6), Color(0xFF0891B2)];
  ...
  static const List<Color> infoGradient = [Color(0xFF8B5CF6), Color(0xFF6366F1)];
  ...
  static const Color connectionSyncing = Color(0xFF8B5CF6);
  ...
  static const Color erpSyncing = Color(0xFF8B5CF6);
  ...
  static const Color categoryBebidas = Color(0xFF8B5CF6);
  ...
  static const Color categoryLimpeza = Color(0xFF8B5CF6);
  ...
  static const Color categoryHortifruti = Color(0xFF22D3EE);
  static const Color categoryHortifrutiDark = Color(0xFF65A30D);

  static const Color categoryFrios = Color(0xFF6366F1);
  static const Color categoryFriosDark = Color(0xFF4F46E5);
  ...
  static const Color erpSAP = Color(0xFF8B5CF6);
  static const Color erpTOTVS = Color(0xFF8B5CF6);
  static const Color erpOracle = Color(0xFFEF4444);
  static const Color erpSenior = Color(0xFF10B981);
  static const Color erpSankhya = Color(0xFF22D3EE);
  static const Color erpOmie = Color(0xFF6366F1);
  ...
  static const Color materialBlue = Color(0xFF8B5CF6);
  ...
  static const Color brandAccentLime = Color(0xFF22D3EE);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFF6366F1), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFF8B5CF6);
  ...
  static const Color categoryProdutos = Color(0xFF6366F1);
  static const Color categoryProdutosDark = Color(0xFF4F46E5);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFF22D3EE);
  static const Color categoryStatsDark = Color(0xFF65A30D);

  static const Color categoryImportExport = Color(0xFF6366F1);
  static const Color categoryImportExportDark = Color(0xFF4F46E5);

  // Importação e Exportação - CORES DINÂMICAS
  static const Color importProdutos = Color(0xFF8B5CF6);
  ...
  static const Color exportProdutos = Color(0xFF22D3EE);
  ...
  static const Color importHistorico = Color(0xFF8B5CF6);
  ...
  static const Color quickActionHistoricoBackground = Color(0xFF8B5CF6);
  ...
  static const Color strategyCardSugestoesIcon = Color(0xFF22D3EE);
  ...
  static const Color quickActionExportarTudo = Color(0xFF8B5CF6);
  static const Color quickActionAgendar = Color(0xFF22D3EE);
  ...
  static const Color adminPanelButtonLojas = Color(0xFF8B5CF6);
  ...
  static const Color onboardingIcon = Color(0xFF6366F1);
  static const Color onboardingProgress = Color(0xFF4F46E5);

  static const Color onboardingStepCompleted = Color(0xFF6366F1);
  static const Color onboardingStepPending = Color(0xFF8B5CF6);
  ...
  static const Color nextStepIcon = Color(0xFF6366F1);
  ...
  static const Color statProdutosIcon = Color(0xFF8B5CF6);
  ...
  static const Color statSyncIcon = Color(0xFF8B5CF6);
  ...
  static const Color reportOperacional = Color(0xFF6366F1);
  static const Color reportOperacionalDark = Color(0xFF4F46E5);

  static const Color reportVendas = Color(0xFF10B981);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFF22D3EE);
  static const Color reportPerformanceDark = Color(0xFF65A30D);

  static const Color reportAuditoria = Color(0xFF8B5CF6);
  ...
  static const Color pricingPercentage = Color(0xFF8B5CF6);
  ...
  static const Color pricingIndividual = Color(0xFF22D3EE);
  static const Color pricingIndividualDark = Color(0xFF65A30D);
  static const Color pricingMarginReview = Color(0xFF8B5CF6);
  static const Color pricingMarginReviewDark = Color(0xFF0891B2);
  static const Color pricingDynamic = Color(0xFF6366F1);
  static const Color pricingDynamicDark = Color(0xFF4F46E5);
  static const Color pricingHistory = Color(0xFF8B5CF6);
  ...
  static const Color syncSettings = Color(0xFF6366F1);
  static const Color syncSettingsDark = Color(0xFF4F46E5);
  ...
  static const Color tipCardText = Color(0xFF4F46E5);
  ...
  static const Color successCardText = Color(0xFF4F46E5);
  ...
  static const Color gradientDarkTeal = Color(0xFF6366F1);
  static const Color gradientDarkTealLight = Color(0xFF818CF8);
  ...
  static const Color gradientSugestoesStart = Color(0xFF22D3EE);
  ...
  static const Color greenTeal = Color(0xFF8B5CF6);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFF818CF8);
  ...
  static const Color blueMain = Color(0xFF8B5CF6);
  static const Color blueCyan = Color(0xFF8B5CF6);
  static const Color blueMaterial = Color(0xFF8B5CF6);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFF4F46E5);

  static const Color cyanMain = Color(0xFF8B5CF6);
  static const Color cyanDark = Color(0xFF0891B2);
  static const Color tealMain = Color(0xFF8B5CF6);
  ...
  static const Color infoModuleIcon = Color(0xFF8B5CF6);
