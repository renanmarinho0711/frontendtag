...
/// ==============================================================================
/// TEMA: LIME FRESH - Verde LimÃ£o Fresco
/// ==============================================================================
///
/// Conceito Visual:
/// Fundo branco, cards verde limÃ£o sÃ³lido, energia natural
...
class AppThemeColors {
  ...
  static const Color infoIcon = Color(0xFF22C55E);
  static const Color infoDark = Color(0xFFFACC15);
  ...
  static const Color successText = Color(0xFF65A30D);
  ...
  static const Color primaryDashboard = Color(0xFFFACC15);
  static const Color primaryDashboardDark = Color(0xFF65A30D);
  ...
  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFFFACC15);
  ...
  static const Color dashboardDrawerItemTextSelected = Color(0xFFFACC15);
  ...
  static const Color dashboardBottomNavIconSelected = Color(0xFFFACC15);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFFFACC15);
  ...
  static const Color dashboardRailItemTextSelected = Color(0xFFFACC15);
  static const Color dashboardRailItemTextUnselected = Color(0xFF64748B);

  static const Color dashboardLogoIconColor = Color(0xFFFACC15);
  ...
  static const Color dashboardNotificationIcon = Color(0xFFFACC15);
  ...
  static const Color dashboardUserMenuAvatarBg = Color(0xFFFACC15);
  ...
  static const Color dashboardWelcomeIcon = Color(0xFFFACC15);
  ...
  static const Color dashboardMetricsBlue = Color(0xFF22C55E);
  ...
  static const Color moduleDashboard = Color(0xFFFACC15);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFF65A30D);

  static const Color moduleProdutos = Color(0xFF22C55E);        // Fresh Cyan
  ...
  static const Color moduleEstrategias = Color(0xFFFACC15);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFF65A30D);

  static const Color moduleSincronizacao = Color(0xFF22C55E);   // Fresh Cyan
  ...
  static const Color moduleImportacao = Color(0xFFFACC15);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFF65A30D);
  ...
  static const List<Color> produtosGradient = [Color(0xFF22C55E), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF10B981), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFFFACC15), Color(0xFF65A30D)];
  static const List<Color> sincronizacaoGradient = [Color(0xFF22C55E), Color(0xFF0891B2)];
  ...
  static const List<Color> importacaoGradient = [Color(0xFFFACC15), Color(0xFF65A30D)];
  ...
  static const List<Color> infoGradient = [Color(0xFF22C55E), Color(0xFFFACC15)];
  ...
  static const Color userMenuAvatarBackground = Color(0xFFFACC15);
  ...
  static const Color avatarBackground = Color(0xFFFACC15);
  ...
  static const Color connectionSyncing = Color(0xFF22C55E);
  ...
  static const Color erpSyncing = Color(0xFF22C55E);
  ...
  static const Color categoryBebidas = Color(0xFF22C55E);
  ...
  static const Color categoryLimpeza = Color(0xFF22C55E);
  ...
  static const Color categoryHortifruti = Color(0xFFFACC15);
  static const Color categoryHortifrutiDark = Color(0xFF65A30D);

  static const Color categoryFrios = Color(0xFFFACC15);
  static const Color categoryFriosDark = Color(0xFF65A30D);
  ...
  static const Color erpSAP = Color(0xFF22C55E);
  static const Color erpTOTVS = Color(0xFF22C55E);
  static const Color erpOracle = Color(0xFFEF4444);
  static const Color erpSenior = Color(0xFF10B981);
  static const Color erpSankhya = Color(0xFFFACC15);
  static const Color erpOmie = Color(0xFFFACC15);
  ...
  static const Color roleManager = Color(0xFF22C55E);
  ...
  static const Color info = Color(0xFF22C55E);
  ...
  static const Color materialBlue = Color(0xFF22C55E);
  ...
  static const Color materialTeal = Color(0xFFFACC15);
  ...
  static const Color blue = Color(0xFF22C55E);
  ...
  static const Color brandPrimaryTeal = Color(0xFFFACC15);
  static const Color brandPrimaryTealDark = Color(0xFF65A30D);
  static const Color brandPrimaryTealLight = Color(0xFFA3E635);
  static const Color brandAccentLime = Color(0xFFFACC15);
  ...
  static const LinearGradient brandPrimaryGradient = LinearGradient(
    ...
    colors: [Color(0xFFFACC15), Color(0xFF65A30D)],
  );

  static const LinearGradient brandLoginGradient = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: [Color(0xFFFACC15), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFF22C55E);
  ...
  static const Color categoryProdutos = Color(0xFFFACC15);
  static const Color categoryProdutosDark = Color(0xFF65A30D);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFFFACC15);
  static const Color categoryStatsDark = Color(0xFF65A30D);

  static const Color categoryImportExport = Color(0xFFFACC15);
  static const Color categoryImportExportDark = Color(0xFF65A30D);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFF22C55E);
  ...
  static const Color exportProdutos = Color(0xFFFACC15);
  ...
  static const Color importHistorico = Color(0xFF22C55E);
  ...
  static const Color quickActionHistoricoBackground = Color(0xFF22C55E);
  ...
  static const Color strategyCardSugestoesIcon = Color(0xFFFACC15);
  ...
  static const Color quickActionExportarTudo = Color(0xFF22C55E);
  static const Color quickActionAgendar = Color(0xFFFACC15);
  ...
  static const Color adminPanelButtonLojas = Color(0xFF22C55E);
  ...
  static const Color onboardingIcon = Color(0xFFFACC15);
  static const Color onboardingProgress = Color(0xFF65A30D);

  static const Color onboardingStepCompleted = Color(0xFFFACC15);
  static const Color onboardingStepPending = Color(0xFF22C55E);
  ...
  static const Color nextStepIcon = Color(0xFFFACC15);
  ...
  static const Color statProdutosIcon = Color(0xFF22C55E);
  ...
  static const Color statSyncIcon = Color(0xFF22C55E);
  ...
  static const Color reportOperacional = Color(0xFFFACC15);
  static const Color reportOperacionalDark = Color(0xFF65A30D);

  static const Color reportVendas = Color(0xFF10B981);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFFFACC15);
  static const Color reportPerformanceDark = Color(0xFF65A30D);

  static const Color reportauditoria = Color(0xFF22C55E);
  ...
  static const Color pricingPercentage = Color(0xFF22C55E);
  ...
  static const Color pricingIndividual = Color(0xFFFACC15);
  static const Color pricingIndividualDark = Color(0xFF65A30D);
  static const Color pricingMarginReview = Color(0xFF22C55E);
  static const Color pricingMarginReviewDark = Color(0xFF0891B2);
  static const Color pricingDynamic = Color(0xFFFACC15);
  static const Color pricingDynamicDark = Color(0xFF65A30D);
  static const Color pricingHistory = Color(0xFF22C55E);
  ...
  static const Color syncSettings = Color(0xFFFACC15);
  static const Color syncSettingsDark = Color(0xFF65A30D);
  ...
  static const Color tipCardText = Color(0xFF65A30D);
  ...
  static const Color successCardText = Color(0xFF65A30D);
  ...
  static const Color gradientDarkTeal = Color(0xFFFACC15);
  static const Color gradientDarkTealLight = Color(0xFFA3E635);
  ...
  static const Color gradientSugestoesStart = Color(0xFFFACC15);
  ...
  static const Color greenTeal = Color(0xFF22C55E);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFFA3E635);
  ...
  static const Color blueMain = Color(0xFF22C55E);
  static const Color blueCyan = Color(0xFF22C55E);
  static const Color blueMaterial = Color(0xFF22C55E);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFF65A30D);

  static const Color cyanMain = Color(0xFF22C55E);
  static const Color cyanDark = Color(0xFF0891B2);
  static const Color tealMain = Color(0xFF22C55E);
  ...
  static const Color infoModuleIcon = Color(0xFF22C55E);
