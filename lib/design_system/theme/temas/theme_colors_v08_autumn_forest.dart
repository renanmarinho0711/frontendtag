...
/// ==============================================================================
/// TEMA: AUTUMN FOREST - Tema Outono Floresta
/// ==============================================================================
///
/// Conceito Visual:
/// Tons terrosos - marrom, laranja queimado, amarelo outonal
...
class AppThemeColors {
  ...
  static const Color surfaceVariant = Color(0xFFFFE0B2);

  /// Fundo de inputs (Campos de texto). Cinza clarÃ­ssimo para conforto visual.
  static const Color inputBackground = Color(0xFFFFE0B2);

  /// Fundo secundÃ¡rio para Ã¡reas de separaÃ§Ã£o. Cinza claro e neutro.
  static const Color backgroundMedium = Color(0xFFFFCC80);
  ...
  static const Color borderLight = Color(0xFFFFCC80);

  /// Borda mÃ©dia para elementos interativos.
  static const Color borderMedium = Color(0xFFCBD5E1);

  /// Borda escura para destaque sutil.
  static const Color borderDark = Color(0xFF5D4037);
  ...
  static const Color infoIcon = Color(0xFF8D6E63);
  static const Color infoDark = Color(0xFFE64A19);
  ...
  static const Color successText = Color(0xFFD84315);
  static const Color successIcon = Color(0xFF689F38);
  ...
  static const Color primaryDashboard = Color(0xFFE64A19);
  static const Color primaryDashboardDark = Color(0xFFD84315);

  // AppBar
  static const Color dashboardAppBarBackground = Color(0xFFFFF3E0);
  static const Color dashboardAppBarShadow = Color(0x1A0D9488);

  // Menu Lateral (Drawer)
  static const Color dashboardDrawerBackground1 = Color(0xFFFFF3E0);
  static const Color dashboardDrawerBackground2 = Color(0xFFFFE0B2);

  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFFE64A19);
  static const Color dashboardDrawerHeaderIconBg = Color(0xFFFFCC80);
  static const Color dashboardDrawerHeaderText = Color(0xFF3E2723);
  static const Color dashboardDrawerHeaderTextSecondary = Color(0xFF5D4037);
  static const Color dashboardDrawerItemSelected = Color(0xFFFFCC80);
  static const Color dashboardDrawerItemUnselected = transparent;
  static const Color dashboardDrawerItemTextSelected = Color(0xFFE64A19);
  static const Color dashboardDrawerItemTextUnselected = Color(0xFF5D4037);

  // Bottom Navigation
  static const Color dashboardBottomNavBackground = Color(0xFFFFF3E0);
  static const Color dashboardBottomNavShadow = Color(0x1A0D9488);
  static const Color dashboardBottomNavIconSelected = Color(0xFFE64A19);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFFE64A19);
  static const Color dashboardBottomNavTextUnselected = Color(0xFF94A3B8);

  // Navigation Rail
  static const Color dashboardRailBackground = Color(0xFFFFF3E0);
  static const Color dashboardRailShadow = Color(0x1A0D9488);
  static const Color dashboardRailToggleBackground = Color(0xFFFFE0B2);
  static const Color dashboardRailToggleIcon = Color(0xFF5D4037);
  static const Color dashboardRailItemIconSelected = Color(0xFFFFF3E0);
  static const Color dashboardRailItemIconUnselected = Color(0xFF5D4037);
  static const Color dashboardRailItemTextSelected = Color(0xFFE64A19);
  static const Color dashboardRailItemTextUnselected = Color(0xFF5D4037);

  static const Color dashboardLogoIconColor = Color(0xFFE64A19);

  // Barra de Busca
  static const Color dashboardSearchBackground = Color(0xFFFFE0B2);
  static const Color dashboardSearchHint = Color(0xFF94A3B8);
  static const Color dashboardSearchIcon = Color(0xFF5D4037);

  // NotificaÃ§Ãµes e Badges
  static const Color dashboardNotificationBackground = Color(0xFFFFCC80);
  static const Color dashboardNotificationBadge = Color(0xFFEF4444);
  static const Color dashboardNotificationIcon = Color(0xFFE64A19);

  // Status de ConexÃ£o
  static const Color dashboardConnectionBackground = Color(0xFFFFCC80);
  static const Color dashboardConnectionBorder = Color(0xFFCBD5E1);
  static const Color dashboardConnectionDot = Color(0xFF689F38);
  static const Color dashboardConnectionDotGlow = Color(0x4D10B981);
  static const Color dashboardConnectionText = Color(0xFF3E2723);

  // User Menu
  static const Color dashboardUserMenuBackground1 = Color(0xFFFFF3E0);
  static const Color dashboardUserMenuBackground2 = Color(0xFFFFE0B2);
  static const Color dashboardUserMenuAvatarBg = Color(0xFFE64A19);
  static const Color dashboardUserMenuAvatarText = Color(0xFFFFF3E0);
  static const Color dashboardUserMenuText = Color(0xFF3E2723);
  static const Color dashboardUserMenuTextSecondary = Color(0xFF5D4037);
  static const Color dashboardUserMenuIcon = Color(0xFF5D4037);
  ...
  static const Color dashboardWelcomeText = Color(0xFF3E2723);
  static const Color dashboardWelcomeTextSecondary = Color(0xFF5D4037);
  static const Color dashboardWelcomeTextTertiary = Color(0xFF94A3B8);
  static const Color dashboardWelcomeIcon = Color(0xFFE64A19);

  // ===========================================================================
  // 7. CARDS E MÃ‰TRICAS (KPIs) - DINÃ‚MICOS E LEVES
  // ===========================================================================

  static const Color dashboardMetricsCardBackground = Color(0xFFFFF3E0);
  ...
  static const Color dashboardMetricsBlue = Color(0xFF8D6E63);
  static const Color dashboardMetricsPurple = Color(0xFF8B5CF6);
  static const Color dashboardMetricsRed = Color(0xFFEF4444);
  static const Color dashboardMetricsGreen = Color(0xFF689F38);
  ...
  static const Color dashboardMetricsValueText = Color(0xFF3E2723);
  static const Color dashboardMetricsLabelText = Color(0xFF5D4037);

  // Cards GenÃ©ricos
  static const Color dashboardCardBackground = Color(0xFFFFF3E0);
  static const Color dashboardCardShadow = Color(0x1A0D9488);
  static const Color dashboardCardTitle = Color(0xFF3E2723);
  static const Color dashboardCardSubtitle = Color(0xFF5D4037);

  // ===========================================================================
  // 8. CORES DE MÃ“DULOS - "PALETA MODERNA E DINÃ‚MICA"
  // ===========================================================================

  static const Color moduleDashboard = Color(0xFFE64A19);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFFD84315);

  static const Color moduleProdutos = Color(0xFF8D6E63);        // Fresh Cyan
  static const Color moduleProdutosDark = Color(0xFF0D6F8B);

  static const Color moduleEtiquetas = Color(0xFF689F38);       // Emerald Green
  static const Color moduleEtiquetasDark = Color(0xFF0B7A57);

  static const Color moduleEstrategias = Color(0xFFFFB300);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFFFF8F00);

  static const Color moduleSincronizacao = Color(0xFF8D6E63);   // Fresh Cyan
  static const Color moduleSincronizacaoDark = Color(0xFF6D4C41);

  static const Color modulePrecificacao = Color(0xFFF59E0B);    // Amber
  static const Color modulePrecificacaoDark = Color(0xFFD97706);

  static const Color moduleCategorias = Color(0xFF689F38);      // Emerald Green
  static const Color moduleCategoriasDark = Color(0xFF0B7A57);

  static const Color moduleImportacao = Color(0xFFE64A19);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFFD84315);
  ...
  static const Color moduleConfiguracoes = Color(0xFF5D4037);   // Cinza mÃ©dio
  ...
  static const List<Color> produtosGradient = [Color(0xFF8D6E63), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF689F38), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFFFFB300), Color(0xFFFF8F00)];
  static const List<Color> sincronizacaoGradient = [Color(0xFF8D6E63), Color(0xFF6D4C41)];
  static const List<Color> precificacaoGradient = [Color(0xFFF59E0B), Color(0xFFD97706)];
  static const List<Color> categoriasGradient = [Color(0xFF689F38), Color(0xFF0B7A57)];
  static const List<Color> importacaoGradient = [Color(0xFFE64A19), Color(0xFFD84315)];
  static const List<Color> relatÃ³riosGradient = [Color(0xFF059669), Color(0xFF047857)];
  static const List<Color> configuracoesGradient = [Color(0xFF5D4037), Color(0xFF475569)];

  static const List<Color> successGradient = [Color(0xFF689F38), Color(0xFF059669)];
  ...
  static const List<Color> infoGradient = [Color(0xFF8D6E63), Color(0xFFE64A19)];
  ...
  static const Color surfaceLow = Color(0xFFFFE0B2);
  static const Color surfaceHigh = Color(0xFFFFF3E0);
  static const Color surfaceTinted = Color(0xFFFFCC80);
  static const Color surfaceTintedDark = Color(0xFFE2E8F0);

  // Menu de UsuÃ¡rio
  static const Color userMenuBackgroundStart = Color(0xFFFFF3E0);
  static const Color userMenuBackgroundEnd = Color(0xFFFFE0B2);
  static const Color userMenuAvatarBackground = Color(0xFFE64A19);
  static const Color userMenuAvatarText = Color(0xFFFFF3E0);
  static const Color userMenuHighlight = Color(0xFFFFCC80);
  static const Color menuItemHover = Color(0xFFFFE0B2);
  static const Color avatarBackground = Color(0xFFE64A19);
  static const Color avatarText = Color(0xFFFFF3E0);
  static const Color destructive = Color(0xFFEF4444);

  // Ãcones
  static const Color iconDefault = Color(0xFF5D4037);
  ...
  static const Color connectionOnline = Color(0xFF689F38);
  static const Color connectionOffline = Color(0xFFEF4444);
  static const Color connectionPending = Color(0xFFF59E0B);
  static const Color connectionSyncing = Color(0xFF8D6E63);

  static const Color batteryHigh = Color(0xFF689F38);
  ...
  static const Color erpConnected = Color(0xFF689F38);
  static const Color erpDisconnected = Color(0xFFEF4444);
  static const Color erpError = Color(0xFFDC2626);
  static const Color erpSyncing = Color(0xFF8D6E63);

  static const Color tagOnline = Color(0xFF689F38);
  ...
  static const Color productActive = Color(0xFF689F38);
  ...
  static const Color categoryBebidas = Color(0xFF8D6E63);
  ...
  static const Color categoryPereciveis = Color(0xFF689F38);
  static const Color categoryPereciveisDark = Color(0xFF0B7A57);

  static const Color categoryLimpeza = Color(0xFF8D6E63);
  static const Color categoryLimpezaDark = Color(0xFF6D4C41);

  static const Color categoryHigiene = Color(0xFFEC4899);
  static const Color categoryHigieneDark = Color(0xFFDB2777);

  static const Color categoryHortifruti = Color(0xFFFFB300);
  static const Color categoryHortifrutiDark = Color(0xFFFF8F00);

  static const Color categoryFrios = Color(0xFFE64A19);
  static const Color categoryFriosDark = Color(0xFFD84315);
  ...
  static const Color erpSAP = Color(0xFF8D6E63);
  static const Color erpTOTVS = Color(0xFF8D6E63);
  static const Color erpOracle = Color(0xFFEF4444);
  static const Color erpSenior = Color(0xFF689F38);
  static const Color erpSankhya = Color(0xFFFFB300);
  static const Color erpOmie = Color(0xFFE64A19);
  static const Color erpBling = Color(0xFF5D4037);
  ...
  static const Color roleAdmin = Color(0xFF689F38);
  static const Color roleManager = Color(0xFF8D6E63);
  static const Color roleOperator = Color(0xFFF59E0B);
  static const Color roleViewer = Color(0xFF5D4037);
  static const Color rolePlus = Color(0xFF6366F1);

  static const Color statusActive = Color(0xFF689F38);
  ...
  static const Color grey50 = Color(0xFFFFE0B2);
  static const Color grey100 = Color(0xFFFFCC80);
  static const Color grey200 = Color(0xFFE2E8F0);
  static const Color grey300 = Color(0xFFCBD5E1);
  static const Color grey400 = Color(0xFF94A3B8);
  static const Color grey500 = Color(0xFF5D4037);
  static const Color grey600 = Color(0xFF475569);
  static const Color grey700 = Color(0xFF334155);
  static const Color grey800 = Color(0xFF3E2723);
  static const Color grey900 = Color(0xFF0F172A);
  static const Color greySlate = Color(0xFF5D4037);
  static const Color greyDarkSlate = Color(0xFF3E2723);

  static const Color grey500Overlay10 = Color(0x1A64748B);

  // BÃ¡sicos
  static const Color neutralWhite = Color(0xFFFFF3E0);
  static const Color neutralBlack = Color(0xFF3E2723);
  ...
  static const Color blue = Color(0xFF8D6E63);
  ...
  static const Color white = Color(0xFFFFF3E0);
  ...
  static const Color brandPrimaryTeal = Color(0xFFE64A19);
  static const Color brandPrimaryTealDark = Color(0xFFD84315);
  static const Color brandPrimaryTealLight = Color(0xFFFF7043);
  static const Color brandAccentLime = Color(0xFFFFB300);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFFE64A19), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFF8D6E63);
  static const Color categoryVisualizarDark = Color(0xFF0D6F8B);

  static const Color categoryNova = Color(0xFF689F38);
  static const Color categoryNovaDark = Color(0xFF0B7A57);

  static const Color categoryProdutos = Color(0xFFE64A19);
  static const Color categoryProdutosDark = Color(0xFFD84315);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFFFFB300);
  static const Color categoryStatsDark = Color(0xFFFF8F00);

  static const Color categoryImportExport = Color(0xFFE64A19);
  static const Color categoryImportExportDark = Color(0xFFD84315);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFF8D6E63);
  static const Color importProdutosDark = Color(0xFF0D6F8B);

  static const Color importTags = Color(0xFF689F38);
  static const Color importTagsDark = Color(0xFF0B7A57);

  static const Color exportProdutos = Color(0xFFFFB300);
  static const Color exportProdutosDark = Color(0xFFFF8F00);
  ...
  static const Color importHistorico = Color(0xFF8D6E63);
  static const Color importHistoricoDark = Color(0xFF6D4C41);

  // Stats Cards - Fundos claros e frescos
  static const Color statTagsBackground = Color(0xFFFFCC80);
  static const Color statTagsIcon = Color(0xFF689F38);
  static const Color statTagsBorder = Color(0xFFA7F3D0);

  static const Color statVendasBackground = Color(0xFFFFE0B2);
  ...
  static const Color statInsightsIcon = Color(0xFFFFB300);
  static const Color statInsightsBorder = Color(0xFFD9F99D);

  static const Color statLogsBackground = Color(0xFFF0FDFA);
  static const Color statLogsIcon = Color(0xFF8D6E63);
  static const Color statLogsBorder = Color(0xFF99F6E4);

  // Cards de AÃ§Ãµes RÃ¡pidas - CORES VIBRANTES
  static const Color quickActionTemplateBackground = Color(0xFF8D6E63);
  static const Color quickActionTemplateIcon = Color(0xFFFFF3E0);
  static const Color quickActionTemplateBorder = Color(0xFF0D6F8B);

  static const Color quickActionUploadBackground = Color(0xFF689F38);
  static const Color quickActionUploadIcon = Color(0xFFFFF3E0);
  static const Color quickActionUploadBorder = Color(0xFF0B7A57);

  static const Color quickActionHistoricoBackground = Color(0xFF8D6E63);
  static const Color quickActionHistoricoIcon = Color(0xFFFFF3E0);
  static const Color quickActionHistoricoBorder = Color(0xFF6D4C41);

  // Cards de AÃ§Ãµes - EstratÃ©gias
  static const Color strategyCardSugestoesBackground = Color(0xFFF7FEE7);
  static const Color strategyCardSugestoesIcon = Color(0xFFFFB300);
  static const Color strategyCardSugestoesBorder = Color(0xFFD9F99D);

  static const Color strategyCardSecondaryBackground = Color(0xFFFFCC80);
  static const Color strategyCardSecondaryIcon = Color(0xFF689F38);
  ...
  static const Color statsOverviewBackground1 = Color(0xFFFFF3E0);
  static const Color statsOverviewBackground2 = Color(0xFFFFE0B2);

  static const Color quickActionsReportsBackground1 = Color(0xFFFFF3E0);
  static const Color quickActionsReportsBackground2 = Color(0xFFFFE0B2);

  static const Color quickActionsImportBackground1 = Color(0xFFFFF3E0);
  static const Color quickActionsImportBackground2 = Color(0xFFFFE0B2);
  ...
  static const Color quickActionExportarTudo = Color(0xFF8D6E63);
  static const Color quickActionAgendar = Color(0xFFFFB300);
  static const Color quickActionEmail = Color(0xFF689F38);

  // ===========================================================================
  // PAINEL ADMINISTRATIVO - CORES CLARAS E PROFISSIONAIS
  // ===========================================================================

  static const Color adminPanelBackground1 = Color(0xFFFFF3E0);
  static const Color adminPanelBackground2 = Color(0xFFFFE0B2);

  static const Color adminPanelButtonLojas = Color(0xFF8D6E63);
  static const Color adminPanelButtonUsuarios = Color(0xFF689F38);
  static const Color adminPanelButtonConfig = Color(0xFF5D4037);

  // ===========================================================================
  // PRIMEIROS PASSOS (Onboarding Light) - GUIA SUAVE
  // ===========================================================================

  static const Color onboardingBackground1 = Color(0xFFFFCC80);
  static const Color onboardingBackground2 = Color(0xFFE2E8F0);
  static const Color onboardingBorder = Color(0xFFCBD5E1);

  static const Color onboardingIcon = Color(0xFFE64A19);
  static const Color onboardingProgress = Color(0xFFD84315);

  static const Color onboardingStepCompleted = Color(0xFFE64A19);
  static const Color onboardingStepPending = Color(0xFF8D6E63);
  ...
  static const Color nextStepBackground1 = Color(0xFFFFCC80);
  static const Color nextStepBackground2 = Color(0xFFE2E8F0);
  static const Color nextStepBorder = Color(0xFFCBD5E1);
  static const Color nextStepIcon = Color(0xFFE64A19);
  static const Color nextStepTitle = Color(0xFF3E2723);

  // Stats ImportaÃ§Ã£o - CORES FUNCIONAIS
  static const Color statProdutosBackground = Color(0xFFF0FDFF);
  static const Color statProdutosIcon = Color(0xFF8D6E63);
  static const Color statProdutosBorder = Color(0xFF99F6E4);

  static const Color statTagsESLBackground = Color(0xFFFFCC80);
  static const Color statTagsESLIcon = Color(0xFF689F38);
  static const Color statTagsESLBorder = Color(0xFFA7F3D0);

  static const Color statSyncBackground = Color(0xFFF0FDFF);
  static const Color statSyncIcon = Color(0xFF8D6E63);
  ...
  static const Color reportOperacional = Color(0xFFE64A19);
  static const Color reportOperacionalDark = Color(0xFFD84315);

  static const Color reportVendas = Color(0xFF689F38);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFFFFB300);
  static const Color reportPerformanceDark = Color(0xFFFF8F00);

  static const Color reportauditoria = Color(0xFF8D6E63);
  ...
  static const Color pricingPercentage = Color(0xFF8D6E63);
  static const Color pricingPercentageDark = Color(0xFF0D6F8B);
  static const Color pricingFixedValue = Color(0xFF689F38);
  static const Color pricingFixedValueDark = Color(0xFF0B7A57);
  static const Color pricingIndividual = Color(0xFFFFB300);
  static const Color pricingIndividualDark = Color(0xFFFF8F00);
  static const Color pricingMarginReview = Color(0xFF8D6E63);
  static const Color pricingMarginReviewDark = Color(0xFF6D4C41);
  static const Color pricingDynamic = Color(0xFFE64A19);
  static const Color pricingDynamicDark = Color(0xFFD84315);
  static const Color pricingHistory = Color(0xFF8D6E63);
  static const Color pricingHistoryDark = Color(0xFF0D6F8B);

  static const Color syncComplete = Color(0xFF689F38);
  ...
  static const Color syncSettings = Color(0xFFE64A19);
  static const Color syncSettingsDark = Color(0xFFD84315);
  ...
  static const Color tipCardBg = Color(0xFFFFCC80);
  static const Color tipCardBorder = Color(0xFFA7F3D0);
  static const Color tipCardText = Color(0xFFD84315);
  ...
  static const Color successCardText = Color(0xFFD84315);
  ...
  static const Color syncedBg = Color(0xFFFFCC80);
  static const Color syncedBorder = Color(0xFFA7F3D0);
  static const Color syncedIcon = Color(0xFF689F38);
  ...
  static const Color notSyncedBg = Color(0xFFFFE0B2);
  ...
  static const Color darkSurface = Color(0xFFFFF3E0);
  static const Color darkBackground = Color(0xFFFFE0B2);
  static const Color darkCard = Color(0xFFFFF3E0);
  static const Color darkDialog = Color(0xFFFFF3E0);
  static const Color darkInput = Color(0xFFFFE0B2);
  static const Color darkDropdown = Color(0xFFFFF3E0);
  ...
  static const Color statusGreen = Color(0xFF689F38);
  ...
  static const Color statusBlueGrey = Color(0xFF5D4037);
  static const Color statusBlueGreyLight = Color(0xFF94A3B8);
  static const Color statusBlueGreyBg = Color(0xFFFFE0B2);

  static const Color gradientDarkTeal = Color(0xFFE64A19);
  static const Color gradientDarkTealLight = Color(0xFFFF7043);
  ...
  static const Color gradientSugestoesStart = Color(0xFFFFB300);
  static const Color gradientSugestoesEnd = Color(0xFF689F38);

  static const Color gradientDarkStart = Color(0xFF689F38);
  ...
  static const Color strategyOrangeDark = Color(0xFFFF8F00);
  ...
  static const Color greenMain = Color(0xFF689F38);
  static const Color greenTeal = Color(0xFF8D6E63);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFFFF7043);
  static const Color greenMaterial = Color(0xFF689F38);
  static const Color successMaterial = Color(0xFF689F38);
  static const Color greenDark = Color(0xFF059669);
  static const Color greenLightMaterial = Color(0xFF6EE7B7);

  static const Color blueMain = Color(0xFF8D6E63);
  static const Color blueCyan = Color(0xFF8D6E63);
  static const Color blueMaterial = Color(0xFF8D6E63);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFFD84315);

  static const Color cyanMain = Color(0xFF8D6E63);
  static const Color cyanDark = Color(0xFF6D4C41);
  static const Color tealMain = Color(0xFF8D6E63);
  static const Color cyanGradientStart = Color(0xFF22D3EE);
  static const Color cyanGradientEnd = Color(0xFF6D4C41);
  ...
  static const Color primaryPastel = Color(0xFFFFCC80);
  ...
  static const Color infoModuleIcon = Color(0xFF8D6E63);

  static const Color suggestionCardStart = Color(0xFF689F38);
  static const Color suggestionCardEnd = Color(0xFF059669);
  static const Color suggestionAumentosBackground = Color(0xFFFFCC80);
  static const Color suggestionAumentosText = Color(0xFF3E2723);
  ...
  static const Color mintPastel = Color(0xFFFFCC80);
  static const Color pinkPastel = Color(0xFFFDF2F8);
  static const Color bluePastel = Color(0xFFF0FDFF);
  static const Color surfacePastel = Color(0xFFFFE0B2);
