...
class AppThemeColors {
  ...
  static const Color primaryDashboard = Color(0xFF0EA5E9);
  static const Color primaryDashboardDark = Color(0xFF0284C7);
  ...
  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFF0EA5E9);
  ...
  static const Color dashboardDrawerItemTextSelected = Color(0xFF0EA5E9);
  ...
  static const Color dashboardBottomNavIconSelected = Color(0xFF0EA5E9);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFF0EA5E9);
  ...
  static const Color dashboardRailItemTextSelected = Color(0xFF0EA5E9);
  static const Color dashboardRailItemTextUnselected = Color(0xFF64748B);

  static const Color dashboardLogoIconColor = Color(0xFF0EA5E9);
  ...
  static const Color dashboardNotificationIcon = Color(0xFF0EA5E9);
  ...
  static const Color dashboardUserMenuAvatarBg = Color(0xFF0EA5E9);
  ...
  static const Color dashboardWelcomeIcon = Color(0xFF0EA5E9);
  ...
  static const Color moduleDashboard = Color(0xFF0EA5E9);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFF0284C7);
  ...
  static const Color moduleEstrategias = Color(0xFF3B82F6);     // Lime Green
  ...
  static const Color moduleImportacao = Color(0xFF0EA5E9);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFF0284C7);
  ...
  static const List<Color> estrategiasGradient = [Color(0xFF3B82F6), Color(0xFF65A30D)];
  ...
  static const List<Color> importacaoGradient = [Color(0xFF0EA5E9), Color(0xFF0284C7)];
  ...
  static const List<Color> infoGradient = [Color(0xFF06B6D4), Color(0xFF0EA5E9)];
  ...
  static const Color userMenuAvatarBackground = Color(0xFF0EA5E9);
  ...
  static const Color avatarBackground = Color(0xFF0EA5E9);
  ...
  static const Color materialTeal = Color(0xFF0EA5E9);
  ...
  static const Color brandPrimaryTeal = Color(0xFF0EA5E9);
  static const Color brandPrimaryTealDark = Color(0xFF0284C7);
  static const Color brandPrimaryTealLight = Color(0xFF38BDF8);
  static const Color brandAccentLime = Color(0xFF3B82F6);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFF0EA5E9), Color(0xFF1E3A3A)],
  );
