...
/// ==============================================================================
/// TEMA: EMERALD POWER - Verde Esmeralda Vibrante
/// ==============================================================================
///
/// Conceito Visual:
/// Fundo branco puro, cards verde esmeralda sólido, texto branco nos cards
...
class AppThemeColors {
  ...
  // --- INFORMAÃ‡ÃƒO ---
  static const Color infoBackground = Color(0xFFECFDF5);
  ...
  static const Color infoIcon = Color(0xFF047857);
  static const Color infoDark = Color(0xFF10B981);
  ...
  static const Color primaryDashboard = Color(0xFF10B981);
  static const Color primaryDashboardDark = Color(0xFF059669);
  ...
  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFF10B981);
  ...
  static const Color dashboardDrawerItemTextSelected = Color(0xFF10B981);
  ...
  static const Color dashboardBottomNavIconSelected = Color(0xFF10B981);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF9CA3AF);
  static const Color dashboardBottomNavTextSelected = Color(0xFF10B981);
  static const Color dashboardBottomNavTextUnselected = Color(0xFF9CA3AF);
  ...
  static const Color dashboardRailItemTextSelected = Color(0xFF10B981);
  static const Color dashboardRailItemTextUnselected = Color(0xFF6B7280);

  static const Color dashboardLogoIconColor = Color(0xFF10B981);

  // Barra de Busca
  static const Color dashboardSearchBackground = Color(0xFFF9FAFB);
  static const Color dashboardSearchHint = Color(0xFF9CA3AF);
  ...
  static const Color dashboardNotificationBadge = Color(0xFFDC2626);
  static const Color dashboardNotificationIcon = Color(0xFF10B981);
  ...
  static const Color dashboardUserMenuAvatarBg = Color(0xFF10B981);
  ...
  static const Color dashboardUserMenuIconDestructive = Color(0xFFDC2626);
  static const Color dashboardUserMenuTextDestructive = Color(0xFFDC2626);
  ...
  static const Color dashboardWelcomeTextTertiary = Color(0xFF9CA3AF);
  static const Color dashboardWelcomeIcon = Color(0xFF10B981);
  ...
  static const Color dashboardMetricsBlue = Color(0xFF047857);
  static const Color dashboardMetricsPurple = Color(0xFF8B5CF6);
  static const Color dashboardMetricsRed = Color(0xFFDC2626);
  ...
  static const Color dashboardMetricsBlueLight = Color(0xFFECFDF5);
  static const Color dashboardMetricsBlueVeryLight = Color(0xFFD1FAE5);
  ...
  static const Color dashboardMetricsRedLight = Color(0xFFFEE2E2);
  ...
  static const Color moduleDashboard = Color(0xFF10B981);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFF059669);

  static const Color moduleProdutos = Color(0xFF047857);        // Fresh Cyan
  ...
  static const Color moduleEstrategias = Color(0xFFF97316);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFFEA580C);

  static const Color moduleSincronizacao = Color(0xFF047857);   // Fresh Cyan
  static const Color moduleSincronizacaoDark = Color(0xFF065F46);
  ...
  static const Color moduleImportacao = Color(0xFF10B981);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFF059669);
  ...
  static const Color moduleConfiguracoes = Color(0xFF6B7280);   // Cinza mÃ©dio
  ...
  static const List<Color> produtosGradient = [Color(0xFF047857), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF10B981), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFFF97316), Color(0xFFEA580C)];
  static const List<Color> sincronizacaoGradient = [Color(0xFF047857), Color(0xFF065F46)];
  ...
  static const List<Color> importacaoGradient = [Color(0xFF10B981), Color(0xFF059669)];
  ...
  static const List<Color> errorGradient = [Color(0xFFDC2626), Color(0xFFDC2626)];
  static const List<Color> infoGradient = [Color(0xFF047857), Color(0xFF10B981)];
  ...
  static const Color avatarBackground = Color(0xFF10B981);
  ...
  static const Color productInactive = Color(0xFF9CA3AF);
  static const Color productOutOfStock = Color(0xFFDC2626);
  ...
  static const Color categoryBebidas = Color(0xFF047857);
  ...
  static const Color categoryLimpeza = Color(0xFF047857);
  static const Color categoryLimpezaDark = Color(0xFF065F46);

  static const Color categoryHigiene = Color(0xFFEC4899);
  static const Color categoryHigieneDark = Color(0xFFDB2777);

  static const Color categoryHortifruti = Color(0xFFF97316);
  static const Color categoryHortifrutiDark = Color(0xFFEA580C);

  static const Color categoryFrios = Color(0xFF10B981);
  static const Color categoryFriosDark = Color(0xFF059669);
  ...
  static const Color erpSAP = Color(0xFF047857);
  static const Color erpTOTVS = Color(0xFF047857);
  static const Color erpOracle = Color(0xFFDC2626);
  static const Color erpSenior = Color(0xFF10B981);
  static const Color erpSankhya = Color(0xFFF97316);
  static const Color erpOmie = Color(0xFF10B981);
  ...
  static const Color roleManager = Color(0xFF047857);
  ...
  static const Color info = Color(0xFF047857);
  ...
  static const Color materialBlue = Color(0xFF047857);
  static const Color materialPurple = Color(0xFF8B5CF6);
  static const Color materialRed = Color(0xFFDC2626);
  static const Color materialGreen = Color(0xFF10B981);
  static const Color materialOrange = Color(0xFFF59E0B);
  static const Color materialTeal = Color(0xFF10B981);

  // Shades Auxiliares
  static const Color blue50 = Color(0xFFECFDF5);
  static const Color blue100 = Color(0xFFD1FAE5);
  static const Color blue200 = Color(0xFF99F6E4);
  static const Color blue = Color(0xFF047857);
  ...
  static const Color orange50 = Color(0xFFFEF3C7);
  ...
  static const Color brandPrimaryTeal = Color(0xFF10B981);
  static const Color brandPrimaryTealDark = Color(0xFF059669);
  static const Color brandPrimaryTealLight = Color(0xFF34D399);
  static const Color brandAccentLime = Color(0xFFF97316);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFF10B981), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFF047857);
  ...
  static const Color categoryProdutos = Color(0xFF10B981);
  static const Color categoryProdutosDark = Color(0xFF059669);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFFF97316);
  static const Color categoryStatsDark = Color(0xFFEA580C);

  static const Color categoryImportExport = Color(0xFF10B981);
  static const Color categoryImportExportDark = Color(0xFF059669);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFF047857);
  ...
  static const Color exportProdutos = Color(0xFFF97316);
  static const Color exportProdutosDark = Color(0xFFEA580C);
  ...
  static const Color importHistorico = Color(0xFF047857);
  static const Color importHistoricoDark = Color(0xFF065F46);
  ...
  static const Color statInsightsIcon = Color(0xFFF97316);
  static const Color statInsightsBorder = Color(0xFFD9F99D);

  static const Color statLogsBackground = Color(0xFFECFDF5);
  static const Color statLogsIcon = Color(0xFF047857);
  static const Color statLogsBorder = Color(0xFF99F6E4);

  // Cards de AÃ§Ãµes RÃ¡pidas - CORES VIBRANTES
  static const Color quickActionTemplateBackground = Color(0xFF047857);
  ...
  static const Color quickActionHistoricoBackground = Color(0xFF047857);
  static const Color quickActionHistoricoIcon = Color(0xFFFFFFFF);
  static const Color quickActionHistoricoBorder = Color(0xFF065F46);

  // Cards de AÃ§Ãµes - EstratÃ©gias
  static const Color strategyCardSugestoesBackground = Color(0xFFF7FEE7);
  static const Color strategyCardSugestoesIcon = Color(0xFFF97316);
  ...
  static const Color statsOverviewImportBackground1 = Color(0xFFECFDF5);
  static const Color statsOverviewImportBackground2 = Color(0xFFD1FAE5);

  // ===========================================================================
  // AÃ‡Ã•ES RÃPIDAS - BOTÃ•ES VIBRANTES E FUNCIONAIS
  // ===========================================================================

  static const Color quickActionExportarTudo = Color(0xFF047857);
  static const Color quickActionAgendar = Color(0xFFF97316);
  ...
  static const Color adminPanelButtonLojas = Color(0xFF047857);
  ...
  static const Color onboardingBackground2 = Color(0xFFE5E7EB);
  static const Color onboardingBorder = Color(0xFFCBD5E1);

  static const Color onboardingIcon = Color(0xFF10B981);
  static const Color onboardingProgress = Color(0xFF059669);

  static const Color onboardingStepCompleted = Color(0xFF10B981);
  static const Color onboardingStepPending = Color(0xFF047857);
  static const Color onboardingStepPendingBg = Color(0xFFECFDF5);
  ...
  static const Color nextStepBackground2 = Color(0xFFE5E7EB);
  static const Color nextStepBorder = Color(0xFFCBD5E1);
  static const Color nextStepIcon = Color(0xFF10B981);
  static const Color nextStepTitle = Color(0xFF111827);

  // Stats ImportaÃ§Ã£o - CORES FUNCIONAIS
  static const Color statProdutosBackground = Color(0xFFECFDF5);
  static const Color statProdutosIcon = Color(0xFF047857);
  ...
  static const Color statSyncBackground = Color(0xFFECFDF5);
  static const Color statSyncIcon = Color(0xFF047857);
  ...
  static const Color reportOperacional = Color(0xFF10B981);
  static const Color reportOperacionalDark = Color(0xFF059669);

  static const Color reportVendas = Color(0xFF10B981);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFFF97316);
  static const Color reportPerformanceDark = Color(0xFFEA580C);

  static const Color reportauditoria = Color(0xFF047857);
  ...
  static const Color pricingPercentage = Color(0xFF047857);
  ...
  static const Color pricingIndividual = Color(0xFFF97316);
  static const Color pricingIndividualDark = Color(0xFFEA580C);
  static const Color pricingMarginReview = Color(0xFF047857);
  static const Color pricingMarginReviewDark = Color(0xFF065F46);
  static const Color pricingDynamic = Color(0xFF10B981);
  static const Color pricingDynamicDark = Color(0xFF059669);
  static const Color pricingHistory = Color(0xFF047857);
  ...
  static const Color syncSettings = Color(0xFF10B981);
  static const Color syncSettingsDark = Color(0xFF059669);
  ...
  static const Color alertRedMain = Color(0xFFDC2626);

  static const Color infoCardBg = Color(0xFFECFDF5);
  ...
  static const Color tipCardText = Color(0xFF059669);
  ...
  static const Color successCardText = Color(0xFF059669);

  static const Color errorCardBg = Color(0xFFFEE2E2);
  ...
  static const Color syncErrorBg = Color(0xFFFEE2E2);
  static const Color syncErrorBorder = Color(0xFFFECACA);
  static const Color syncErrorIcon = Color(0xFFDC2626);

  static const Color notSyncedBg = Color(0xFFF9FAFB);
  static const Color notSyncedBorder = Color(0xFFE5E7EB);
  static const Color notSyncedIcon = Color(0xFF9CA3AF);
  ...
  static const Color statusBlueGreyLight = Color(0xFF9CA3AF);
  static const Color statusBlueGreyBg = Color(0xFFF9FAFB);

  static const Color gradientDarkTeal = Color(0xFF10B981);
  static const Color gradientDarkTealLight = Color(0xFF34D399);
  ...
  static const Color gradientSugestoesStart = Color(0xFFF97316);
  ...
  static const Color strategyOrangeDark = Color(0xFFEA580C);
  ...
  static const Color greenTeal = Color(0xFF047857);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFF34D399);
  ...
  static const Color blueMain = Color(0xFF047857);
  static const Color blueCyan = Color(0xFF047857);
  static const Color blueMaterial = Color(0xFF047857);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFF059669);

  static const Color cyanMain = Color(0xFF047857);
  static const Color cyanDark = Color(0xFF065F46);
  static const Color tealMain = Color(0xFF047857);
  static const Color cyanGradientStart = Color(0xFF22D3EE);
  static const Color cyanGradientEnd = Color(0xFF065F46);
  ...
  static const Color alertErrorBackground = Color(0xFFFEE2E2);
  ...
  static const Color alertErrorCardBackground = Color(0xFFFEE2E2);
  ...
  static const Color infoModuleBackground = Color(0xFFECFDF5);
  static const Color infoModuleBackgroundAlt = Color(0xFFD1FAE5);
  static const Color infoModuleBorder = Color(0xFF99F6E4);
  static const Color infoModuleText = Color(0xFF0F766E);
  static const Color infoModuleIcon = Color(0xFF047857);
  ...
  static const Color bluePastel = Color(0xFFECFDF5);
