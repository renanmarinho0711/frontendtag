...
/// ==============================================================================
/// TEMA: LIGHT PASTEL - Tema Claro Suave
/// ==============================================================================
///
/// Conceito Visual:
/// Tema light com fundos pastel suaves e cards coloridos
...
class AppThemeColors {
  ...
  static const Color surfaceVariant = Color(0xFFFFF4E6);

  /// Fundo de inputs (Campos de texto). Cinza clarÃ­ssimo para conforto visual.
  static const Color inputBackground = Color(0xFFFFF4E6);

  /// Fundo secundÃ¡rio para Ã¡reas de separaÃ§Ã£o. Cinza claro e neutro.
  static const Color backgroundMedium = Color(0xFFFFF0DC);
  ...
  static const Color borderLight = Color(0xFFFFF0DC);

  /// Borda mÃ©dia para elementos interativos.
  static const Color borderMedium = Color(0xFFCBD5E1);

  /// Borda escura para destaque sutil.
  static const Color borderDark = Color(0xFF546E7A);
  ...
  static const Color infoIcon = Color(0xFFB39DDB);
  static const Color infoDark = Color(0xFFFF8A80);
  ...
  static const Color successText = Color(0xFFFF6659);
  ...
  static const Color primaryDashboard = Color(0xFFFF8A80);
  static const Color primaryDashboardDark = Color(0xFFFF6659);

  // AppBar
  static const Color dashboardAppBarBackground = Color(0xFFFFF8F0);
  static const Color dashboardAppBarShadow = Color(0x1A0D9488);

  // Menu Lateral (Drawer)
  static const Color dashboardDrawerBackground1 = Color(0xFFFFF8F0);
  static const Color dashboardDrawerBackground2 = Color(0xFFFFF4E6);

  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFFFF8A80);
  static const Color dashboardDrawerHeaderIconBg = Color(0xFFFFF0DC);
  static const Color dashboardDrawerHeaderText = Color(0xFF2C3E50);
  static const Color dashboardDrawerHeaderTextSecondary = Color(0xFF546E7A);
  static const Color dashboardDrawerItemSelected = Color(0xFFFFF0DC);
  static const Color dashboardDrawerItemUnselected = transparent;
  static const Color dashboardDrawerItemTextSelected = Color(0xFFFF8A80);
  static const Color dashboardDrawerItemTextUnselected = Color(0xFF546E7A);

  // Bottom Navigation
  static const Color dashboardBottomNavBackground = Color(0xFFFFF8F0);
  static const Color dashboardBottomNavShadow = Color(0x1A0D9488);
  static const Color dashboardBottomNavIconSelected = Color(0xFFFF8A80);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFFFF8A80);
  static const Color dashboardBottomNavTextUnselected = Color(0xFF94A3B8);

  // Navigation Rail
  static const Color dashboardRailBackground = Color(0xFFFFF8F0);
  static const Color dashboardRailShadow = Color(0x1A0D9488);
  static const Color dashboardRailToggleBackground = Color(0xFFFFF4E6);
  static const Color dashboardRailToggleIcon = Color(0xFF546E7A);
  static const Color dashboardRailItemIconSelected = Color(0xFFFFF8F0);
  static const Color dashboardRailItemIconUnselected = Color(0xFF546E7A);
  static const Color dashboardRailItemTextSelected = Color(0xFFFF8A80);
  static const Color dashboardRailItemTextUnselected = Color(0xFF546E7A);

  static const Color dashboardLogoIconColor = Color(0xFFFF8A80);

  // Barra de Busca
  static const Color dashboardSearchBackground = Color(0xFFFFF4E6);
  static const Color dashboardSearchHint = Color(0xFF94A3B8);
  static const Color dashboardSearchIcon = Color(0xFF546E7A);

  // NotificaÃ§Ãµes e Badges
  static const Color dashboardNotificationBackground = Color(0xFFFFF0DC);
  static const Color dashboardNotificationBadge = Color(0xFFEF4444);
  static const Color dashboardNotificationIcon = Color(0xFFFF8A80);

  // Status de ConexÃ£o
  static const Color dashboardConnectionBackground = Color(0xFFFFF0DC);
  ...
  static const Color dashboardConnectionText = Color(0xFF2C3E50);

  // User Menu
  static const Color dashboardUserMenuBackground1 = Color(0xFFFFF8F0);
  static const Color dashboardUserMenuBackground2 = Color(0xFFFFF4E6);
  static const Color dashboardUserMenuAvatarBg = Color(0xFFFF8A80);
  static const Color dashboardUserMenuAvatarText = Color(0xFFFFF8F0);
  static const Color dashboardUserMenuText = Color(0xFF2C3E50);
  static const Color dashboardUserMenuTextSecondary = Color(0xFF546E7A);
  static const Color dashboardUserMenuIcon = Color(0xFF546E7A);
  ...
  static const Color dashboardWelcomeText = Color(0xFF2C3E50);
  static const Color dashboardWelcomeTextSecondary = Color(0xFF546E7A);
  static const Color dashboardWelcomeTextTertiary = Color(0xFF94A3B8);
  static const Color dashboardWelcomeIcon = Color(0xFFFF8A80);

  // ===========================================================================
  // 7. CARDS E MÃ‰TRICAS (KPIs) - DINÃ‚MICOS E LEVES
  // ===========================================================================

  static const Color dashboardMetricsCardBackground = Color(0xFFFFF8F0);
  ...
  static const Color dashboardMetricsBlue = Color(0xFFB39DDB);
  ...
  static const Color dashboardMetricsValueText = Color(0xFF2C3E50);
  static const Color dashboardMetricsLabelText = Color(0xFF546E7A);

  // Cards GenÃ©ricos
  static const Color dashboardCardBackground = Color(0xFFFFF8F0);
  static const Color dashboardCardShadow = Color(0x1A0D9488);
  static const Color dashboardCardTitle = Color(0xFF2C3E50);
  static const Color dashboardCardSubtitle = Color(0xFF546E7A);

  // ===========================================================================
  // 8. CORES DE MÃ“DULOS - "PALETA MODERNA E DINÃ‚MICA"
  // ===========================================================================

  static const Color moduleDashboard = Color(0xFFFF8A80);       // Teal Fresh
  static const Color moduleDashboardDark = Color(0xFFFF6659);

  static const Color moduleProdutos = Color(0xFFB39DDB);        // Fresh Cyan
  ...
  static const Color moduleEstrategias = Color(0xFF80CBC4);     // Lime Green
  static const Color moduleEstrategiasDark = Color(0xFF4DB6AC);

  static const Color moduleSincronizacao = Color(0xFFB39DDB);   // Fresh Cyan
  static const Color moduleSincronizacaoDark = Color(0xFF9575CD);
  ...
  static const Color moduleImportacao = Color(0xFFFF8A80);      // Teal Fresh
  static const Color moduleImportacaoDark = Color(0xFFFF6659);
  ...
  static const Color moduleConfiguracoes = Color(0xFF546E7A);   // Cinza mÃ©dio
  ...
  static const List<Color> produtosGradient = [Color(0xFFB39DDB), Color(0xFF0D6F8B)];
  static const List<Color> etiquetasGradient = [Color(0xFF10B981), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFF80CBC4), Color(0xFF4DB6AC)];
  static const List<Color> sincronizacaoGradient = [Color(0xFFB39DDB), Color(0xFF9575CD)];
  ...
  static const List<Color> importacaoGradient = [Color(0xFFFF8A80), Color(0xFFFF6659)];
  static const List<Color> relatÃ³riosGradient = [Color(0xFF059669), Color(0xFF047857)];
  static const List<Color> configuracoesGradient = [Color(0xFF546E7A), Color(0xFF475569)];
  ...
  static const List<Color> infoGradient = [Color(0xFFB39DDB), Color(0xFFFF8A80)];
  ...
  static const Color surfaceLow = Color(0xFFFFF4E6);
  static const Color surfaceHigh = Color(0xFFFFF8F0);
  static const Color surfaceTinted = Color(0xFFFFF0DC);
  static const Color surfaceTintedDark = Color(0xFFE2E8F0);

  // Menu de UsuÃ¡rio
  static const Color userMenuBackgroundStart = Color(0xFFFFF8F0);
  static const Color userMenuBackgroundEnd = Color(0xFFFFF4E6);
  static const Color userMenuAvatarBackground = Color(0xFFFF8A80);
  static const Color userMenuAvatarText = Color(0xFFFFF8F0);
  static const Color userMenuHighlight = Color(0xFFFFF0DC);
  static const Color menuItemHover = Color(0xFFFFF4E6);
  static const Color avatarBackground = Color(0xFFFF8A80);
  static const Color avatarText = Color(0xFFFFF8F0);
  ...
  static const Color connectionSyncing = Color(0xFFB39DDB);
  ...
  static const Color erpSyncing = Color(0xFFB39DDB);
  ...
  static const Color categoryBebidas = Color(0xFFB39DDB);
  ...
  static const Color categoryLimpeza = Color(0xFFB39DDB);
  static const Color categoryLimpezaDark = Color(0xFF9575CD);

  static const Color categoryHigiene = Color(0xFFEC4899);
  static const Color categoryHigieneDark = Color(0xFFDB2777);

  static const Color categoryHortifruti = Color(0xFF80CBC4);
  static const Color categoryHortifrutiDark = Color(0xFF4DB6AC);

  static const Color categoryFrios = Color(0xFFFF8A80);
  static const Color categoryFriosDark = Color(0xFFFF6659);
  ...
  static const Color erpSAP = Color(0xFFB39DDB);
  static const Color erpTOTVS = Color(0xFFB39DDB);
  static const Color erpOracle = Color(0xFFEF4444);
  static const Color erpSenior = Color(0xFF10B981);
  static const Color erpSankhya = Color(0xFF80CBC4);
  static const Color erpOmie = Color(0xFFFF8A80);
  static const Color erpBling = Color(0xFF546E7A);
  ...
  static const Color roleManager = Color(0xFFB39DDB);
  static const Color roleOperator = Color(0xFFF59E0B);
  static const Color roleViewer = Color(0xFF546E7A);
  ...
  static const Color grey50 = Color(0xFFFFF4E6);
  static const Color grey100 = Color(0xFFFFF0DC);
  static const Color grey200 = Color(0xFFE2E8F0);
  static const Color grey300 = Color(0xFFCBD5E1);
  static const Color grey400 = Color(0xFF94A3B8);
  static const Color grey500 = Color(0xFF546E7A);
  static const Color grey600 = Color(0xFF475569);
  static const Color grey700 = Color(0xFF334155);
  static const Color grey800 = Color(0xFF2C3E50);
  static const Color grey900 = Color(0xFF0F172A);
  static const Color greySlate = Color(0xFF546E7A);
  static const Color greyDarkSlate = Color(0xFF2C3E50);

  static const Color grey500Overlay10 = Color(0x1A64748B);

  // BÃ¡sicos
  static const Color neutralWhite = Color(0xFFFFF8F0);
  static const Color neutralBlack = Color(0xFF2C3E50);
  ...
  static const Color info = Color(0xFFB39DDB);
  ...
  static const Color materialBlue = Color(0xFFB39DDB);
  ...
  static const Color materialTeal = Color(0xFFFF8A80);
  ...
  static const Color blue = Color(0xFFB39DDB);
  ...
  static const Color brandPrimaryTeal = Color(0xFFFF8A80);
  static const Color brandPrimaryTealDark = Color(0xFFFF6659);
  static const Color brandPrimaryTealLight = Color(0xFFFFAEA8);
  static const Color brandAccentLime = Color(0xFF80CBC4);
  ...
  static const LinearGradient brandPrimaryGradient = LinearGradient(
    ...
    colors: [Color(0xFFFF8A80), Color(0xFFFF6659)],
  );

  static const LinearGradient brandLoginGradient = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: [Color(0xFFFF8A80), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFFB39DDB);
  ...
  static const Color categoryProdutos = Color(0xFFFF8A80);
  static const Color categoryProdutosDark = Color(0xFFFF6659);

  static const Color categoryAdmin = Color(0xFF059669);
  static const Color categoryAdminDark = Color(0xFF047857);

  static const Color categoryStats = Color(0xFF80CBC4);
  static const Color categoryStatsDark = Color(0xFF4DB6AC);

  static const Color categoryImportExport = Color(0xFFFF8A80);
  static const Color categoryImportExportDark = Color(0xFFFF6659);

  // ImportaÃ§Ã£o e ExportaÃ§Ã£o - CORES DINÃ‚MICAS
  static const Color importProdutos = Color(0xFFB39DDB);
  ...
  static const Color exportProdutos = Color(0xFF80CBC4);
  static const Color exportProdutosDark = Color(0xFF4DB6AC);
  ...
  static const Color importHistorico = Color(0xFFB39DDB);
  static const Color importHistoricoDark = Color(0xFF9575CD);

  // Stats Cards - Fundos claros e frescos
  static const Color statTagsBackground = Color(0xFFFFF0DC);
  static const Color statTagsIcon = Color(0xFF10B981);
  static const Color statTagsBorder = Color(0xFFA7F3D0);

  static const Color statVendasBackground = Color(0xFFFFF4E6);
  ...
  static const Color statInsightsIcon = Color(0xFF80CBC4);
  static const Color statInsightsBorder = Color(0xFFD9F99D);

  static const Color statLogsBackground = Color(0xFFF0FDFA);
  static const Color statLogsIcon = Color(0xFFB39DDB);
  static const Color statLogsBorder = Color(0xFF99F6E4);

  // Cards de AÃ§Ãµes RÃ¡pidas - CORES VIBRANTES
  static const Color quickActionTemplateBackground = Color(0xFFB39DDB);
  static const Color quickActionTemplateIcon = Color(0xFFFFF8F0);
  ...
  static const Color quickActionUploadIcon = Color(0xFFFFF8F0);
  static const Color quickActionUploadBorder = Color(0xFF0B7A57);

  static const Color quickActionHistoricoBackground = Color(0xFFB39DDB);
  static const Color quickActionHistoricoIcon = Color(0xFFFFF8F0);
  static const Color quickActionHistoricoBorder = Color(0xFF9575CD);

  // Cards de AÃ§Ãµes - EstratÃ©gias
  static const Color strategyCardSugestoesBackground = Color(0xFFF7FEE7);
  static const Color strategyCardSugestoesIcon = Color(0xFF80CBC4);
  static const Color strategyCardSugestoesBorder = Color(0xFFD9F99D);

  static const Color strategyCardSecondaryBackground = Color(0xFFFFF0DC);
  ...
  static const Color statsOverviewBackground1 = Color(0xFFFFF8F0);
  static const Color statsOverviewBackground2 = Color(0xFFFFF4E6);

  static const Color quickActionsReportsBackground1 = Color(0xFFFFF8F0);
  static const Color quickActionsReportsBackground2 = Color(0xFFFFF4E6);

  static const Color quickActionsImportBackground1 = Color(0xFFFFF8F0);
  static const Color quickActionsImportBackground2 = Color(0xFFFFF4E6);
  ...
  static const Color quickActionExportarTudo = Color(0xFFB39DDB);
  static const Color quickActionAgendar = Color(0xFF80CBC4);
  ...
  static const Color adminPanelBackground1 = Color(0xFFFFF8F0);
  static const Color adminPanelBackground2 = Color(0xFFFFF4E6);

  static const Color adminPanelButtonLojas = Color(0xFFB39DDB);
  static const Color adminPanelButtonUsuarios = Color(0xFF10B981);
  static const Color adminPanelButtonConfig = Color(0xFF546E7A);

  // ===========================================================================
  // PRIMEIROS PASSOS (Onboarding Light) - GUIA SUAVE
  // ===========================================================================

  static const Color onboardingBackground1 = Color(0xFFFFF0DC);
  static const Color onboardingBackground2 = Color(0xFFE2E8F0);
  static const Color onboardingBorder = Color(0xFFCBD5E1);

  static const Color onboardingIcon = Color(0xFFFF8A80);
  static const Color onboardingProgress = Color(0xFFFF6659);

  static const Color onboardingStepCompleted = Color(0xFFFF8A80);
  static const Color onboardingStepPending = Color(0xFFB39DDB);
  ...
  static const Color nextStepBackground1 = Color(0xFFFFF0DC);
  static const Color nextStepBackground2 = Color(0xFFE2E8F0);
  static const Color nextStepBorder = Color(0xFFCBD5E1);
  static const Color nextStepIcon = Color(0xFFFF8A80);
  static const Color nextStepTitle = Color(0xFF2C3E50);

  // Stats ImportaÃ§Ã£o - CORES FUNCIONAIS
  static const Color statProdutosBackground = Color(0xFFF0FDFF);
  static const Color statProdutosIcon = Color(0xFFB39DDB);
  static const Color statProdutosBorder = Color(0xFF99F6E4);

  static const Color statTagsESLBackground = Color(0xFFFFF0DC);
  ...
  static const Color statSyncIcon = Color(0xFFB39DDB);
  ...
  static const Color reportOperacional = Color(0xFFFF8A80);
  static const Color reportOperacionalDark = Color(0xFFFF6659);

  static const Color reportVendas = Color(0xFF10B981);
  static const Color reportVendasDark = Color(0xFF0B7A57);

  static const Color reportPerformance = Color(0xFF80CBC4);
  static const Color reportPerformanceDark = Color(0xFF4DB6AC);

  static const Color reportauditoria = Color(0xFFB39DDB);
  ...
  static const Color pricingPercentage = Color(0xFFB39DDB);
  ...
  static const Color pricingIndividual = Color(0xFF80CBC4);
  static const Color pricingIndividualDark = Color(0xFF4DB6AC);
  static const Color pricingMarginReview = Color(0xFFB39DDB);
  static const Color pricingMarginReviewDark = Color(0xFF9575CD);
  static const Color pricingDynamic = Color(0xFFFF8A80);
  static const Color pricingDynamicDark = Color(0xFFFF6659);
  static const Color pricingHistory = Color(0xFFB39DDB);
  ...
  static const Color syncSettings = Color(0xFFFF8A80);
  static const Color syncSettingsDark = Color(0xFFFF6659);
  ...
  static const Color tipCardBg = Color(0xFFFFF0DC);
  static const Color tipCardBorder = Color(0xFFA7F3D0);
  static const Color tipCardText = Color(0xFFFF6659);
  ...
  static const Color successCardText = Color(0xFFFF6659);
  ...
  static const Color syncedBg = Color(0xFFFFF0DC);
  ...
  static const Color notSyncedBg = Color(0xFFFFF4E6);
  ...
  static const Color darkSurface = Color(0xFFFFF8F0);
  static const Color darkBackground = Color(0xFFFFF4E6);
  static const Color darkCard = Color(0xFFFFF8F0);
  static const Color darkDialog = Color(0xFFFFF8F0);
  static const Color darkInput = Color(0xFFFFF4E6);
  static const Color darkDropdown = Color(0xFFFFF8F0);

  static const Color primaryDark = Color(0xFFFF6659);
  static const Color primaryLight = Color(0xFFFFAEA8);
  ...
  static const Color statusBlueGrey = Color(0xFF546E7A);
  static const Color statusBlueGreyLight = Color(0xFF94A3B8);
  static const Color statusBlueGreyBg = Color(0xFFFFF4E6);

  static const Color gradientDarkTeal = Color(0xFFFF8A80);
  static const Color gradientDarkTealLight = Color(0xFFFFAEA8);
  ...
  static const Color gradientSugestoesStart = Color(0xFF80CBC4);
  ...
  static const Color strategyOrangeDark = Color(0xFF4DB6AC);
  ...
  static const Color greenTeal = Color(0xFFB39DDB);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFFFFAEA8);
  ...
  static const Color blueMain = Color(0xFFB39DDB);
  static const Color blueCyan = Color(0xFFB39DDB);
  static const Color blueMaterial = Color(0xFFB39DDB);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFFFF6659);

  static const Color cyanMain = Color(0xFFB39DDB);
  static const Color cyanDark = Color(0xFF9575CD);
  static const Color tealMain = Color(0xFFB39DDB);
  static const Color cyanGradientStart = Color(0xFF22D3EE);
  static const Color cyanGradientEnd = Color(0xFF9575CD);
  ...
  static const Color primaryPastel = Color(0xFFFFF0DC);
  ...
  static const Color infoModuleIcon = Color(0xFFB39DDB);

  static const Color suggestionCardStart = Color(0xFF10B981);
  static const Color suggestionCardEnd = Color(0xFF059669);
  static const Color suggestionAumentosBackground = Color(0xFFFFF0DC);
  static const Color suggestionAumentosText = Color(0xFF2C3E50);
  ...
  static const Color mintPastel = Color(0xFFFFF0DC);
  static const Color pinkPastel = Color(0xFFFDF2F8);
  static const Color bluePastel = Color(0xFFF0FDFF);
  static const Color surfacePastel = Color(0xFFFFF4E6);
