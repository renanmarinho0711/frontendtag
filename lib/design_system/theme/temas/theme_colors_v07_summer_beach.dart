...
class AppThemeColors {
  ...
  static const Color infoIcon = Color(0xFF00BCD4);
  ...
  static const Color successText = Color(0xFF01579B);
  static const Color successIcon = Color(0xFF00C853);
  ...
  // AppBar
  static const Color dashboardAppBarBackground = Color(0xFFFFF8E1);
  static const Color dashboardAppBarShadow = Color(0x1A0D9488);

  // Menu Lateral (Drawer)
  static const Color dashboardDrawerBackground1 = Color(0xFFFFF8E1);
  static const Color dashboardDrawerBackground2 = Color(0xFFFFECB3);

  // Elementos do Drawer
  static const Color dashboardDrawerHeaderIcon = Color(0xFF0288D1);
  static const Color dashboardDrawerHeaderIconBg = Color(0xFFFFE082);
  static const Color dashboardDrawerHeaderText = Color(0xFF01579B);
  static const Color dashboardDrawerHeaderTextSecondary = Color(0xFF0277BD);
  static const Color dashboardDrawerItemSelected = Color(0xFFFFE082);
  static const Color dashboardDrawerItemUnselected = transparent;
  static const Color dashboardDrawerItemTextSelected = Color(0xFF0288D1);
  static const Color dashboardDrawerItemTextUnselected = Color(0xFF0277BD);

  // Bottom Navigation
  static const Color dashboardBottomNavBackground = Color(0xFFFFF8E1);
  static const Color dashboardBottomNavShadow = Color(0x1A0D9488);
  static const Color dashboardBottomNavIconSelected = Color(0xFF0288D1);
  static const Color dashboardBottomNavIconUnselected = Color(0xFF94A3B8);
  static const Color dashboardBottomNavTextSelected = Color(0xFF0288D1);
  static const Color dashboardBottomNavTextUnselected = Color(0xFF94A3B8);

  // Navigation Rail
  static const Color dashboardRailBackground = Color(0xFFFFF8E1);
  static const Color dashboardRailShadow = Color(0x1A0D9488);
  static const Color dashboardRailToggleBackground = Color(0xFFFFECB3);
  static const Color dashboardRailToggleIcon = Color(0xFF0277BD);
  static const Color dashboardRailItemIconSelected = Color(0xFFFFF8E1);
  static const Color dashboardRailItemIconUnselected = Color(0xFF0277BD);
  static const Color dashboardRailItemTextSelected = Color(0xFF0288D1);
  static const Color dashboardRailItemTextUnselected = Color(0xFF0277BD);

  static const Color dashboardLogoIconColor = Color(0xFF0288D1);

  // Barra de Busca
  static const Color dashboardSearchBackground = Color(0xFFFFECB3);
  ...
  static const Color dashboardConnectionText = Color(0xFF01579B);

  // User Menu
  static const Color dashboardUserMenuBackground1 = Color(0xFFFFF8E1);
  static const Color dashboardUserMenuBackground2 = Color(0xFFFFECB3);
  static const Color dashboardUserMenuAvatarBg = Color(0xFF0288D1);
  static const Color dashboardUserMenuAvatarText = Color(0xFFFFF8E1);
  static const Color dashboardUserMenuText = Color(0xFF01579B);
  static const Color dashboardUserMenuTextSecondary = Color(0xFF0277BD);
  static const Color dashboardUserMenuIcon = Color(0xFF0277BD);
  ...
  static const Color dashboardWelcomeText = Color(0xFF01579B);
  static const Color dashboardWelcomeTextSecondary = Color(0xFF0277BD);
  ...
  static const Color dashboardMetricsGreen = Color(0xFF00C853);
  ...
  static const Color moduleDashboardDark = Color(0xFF01579B);

  static const Color moduleProdutos = Color(0xFF00BCD4);        // Fresh Cyan
  static const Color moduleProdutosDark = Color(0xFF0D6F8B);

  static const Color moduleEtiquetas = Color(0xFF00C853);       // Emerald Green
  ...
  static const Color moduleSincronizacao = Color(0xFF00BCD4);   // Fresh Cyan
  static const Color moduleSincronizacaoDark = Color(0xFF0097A7);

  static const Color modulePrecificacao = Color(0xFFF59E0B);    // Amber
  static const Color modulePrecificacaoDark = Color(0xFFD97706);

  static const Color moduleCategorias = Color(0xFF00C853);      // Emerald Green
  ...
  static const List<Color> etiquetasGradient = [Color(0xFF00C853), Color(0xFF0B7A57)];
  static const List<Color> estrategiasGradient = [Color(0xFFFF6F00), Color(0xFFFF5722)];
  static const List<Color> sincronizacaoGradient = [Color(0xFF00BCD4), Color(0xFF0097A7)];
  ...
  static const List<Color> infoGradient = [Color(0xFF00BCD4), Color(0xFF0288D1)];
  ...
  static const Color surfaceLow = Color(0xFFFFECB3);
  static const Color surfaceHigh = Color(0xFFFFF8E1);
  ...
  static const Color userMenuAvatarText = Color(0xFFFFF8E1);
  static const Color userMenuHighlight = Color(0xFFFFE082);
  static const Color menuItemHover = Color(0xFFFFECB3);
  static const Color avatarBackground = Color(0xFF0288D1);
  ...
  static const Color connectionSyncing = Color(0xFF00BCD4);

  static const Color batteryHigh = Color(0xFF00C853);
  ...
  static const Color erpConnected = Color(0xFF00C853);
  static const Color erpDisconnected = Color(0xFFEF4444);
  static const Color erpError = Color(0xFFDC2626);
  static const Color erpSyncing = Color(0xFF00BCD4);

  static const Color tagOnline = Color(0xFF00C853);
  ...
  static const Color productActive = Color(0xFF00C853);
  ...
  static const Color categoryBebidas = Color(0xFF00BCD4);
  ...
  static const Color categoryPereciveis = Color(0xFF00C853);
  static const Color categoryPereciveisDark = Color(0xFF0B7A57);

  static const Color categoryLimpeza = Color(0xFF00BCD4);
  static const Color categoryLimpezaDark = Color(0xFF0097A7);
  ...
  static const Color categoryFrios = Color(0xFF0288D1);
  static const Color categoryFriosDark = Color(0xFF01579B);
  ...
  static const Color erpTOTVS = Color(0xFF00BCD4);
  static const Color erpOracle = Color(0xFFEF4444);
  static const Color erpSenior = Color(0xFF00C853);
  static const Color erpSankhya = Color(0xFFFF6F00);
  static const Color erpOmie = Color(0xFF0288D1);
  ...
  static const Color roleAdmin = Color(0xFF00C853);
  ...
  static const Color grey50 = Color(0xFFFFECB3);
  static const Color grey100 = Color(0xFFFFE082);
  static const Color grey200 = Color(0xFFE2E8F0);
  static const Color grey300 = Color(0xFFCBD5E1);
  static const Color grey400 = Color(0xFF94A3B8);
  static const Color grey500 = Color(0xFF0277BD);
  static const Color grey600 = Color(0xFF475569);
  static const Color grey700 = Color(0xFF334155);
  static const Color grey800 = Color(0xFF01579B);
  static const Color grey900 = Color(0xFF0F172A);
  static const Color greySlate = Color(0xFF0277BD);
  static const Color greyDarkSlate = Color(0xFF01579B);
  ...
  static const Color materialGreen = Color(0xFF00C853);
  static const Color materialOrange = Color(0xFFF59E0B);
  static const Color materialTeal = Color(0xFF0288D1);
  ...
  static const Color white = Color(0xFFFFF8E1);
  static const Color white70 = Color(0xB3FFFFFF);
  static const Color white60 = Color(0x99FFFFFF);
  static const Color white90 = Color(0xE6FFFFFF);
  static const Color white80 = Color(0xCCFFFFFF);

  static const Color black = Color(0xFF01579B);
  ...
  static const Color brandPrimaryTeal = Color(0xFF0288D1);
  static const Color brandPrimaryTealDark = Color(0xFF01579B);
  ...
  static const LinearGradient brandLoginGradient = LinearGradient(
    ...
    colors: [Color(0xFF0288D1), Color(0xFF1E3A3A)],
  );
  ...
  // Cards de Categoria
  static const Color categoryVisualizar = Color(0xFF00BCD4);
  static const Color categoryVisualizarDark = Color(0xFF0D6F8B);

  static const Color categoryNova = Color(0xFF00C853);
  static const Color categoryNovaDark = Color(0xFF0B7A57);

  static const Color categoryProdutos = Color(0xFF0288D1);
  static const Color categoryProdutosDark = Color(0xFF01579B);
  ...
  static const Color importTags = Color(0xFF00C853);
  ...
  static const Color importHistorico = Color(0xFF00BCD4);
  static const Color importHistoricoDark = Color(0xFF0097A7);

  // Stats Cards - Fundos claros e frescos
  static const Color statTagsBackground = Color(0xFFFFE082);
  static const Color statTagsIcon = Color(0xFF00C853);
  static const Color statTagsBorder = Color(0xFFA7F3D0);

  static const Color statVendasBackground = Color(0xFFFFECB3);
  ...
  static const Color quickActionUploadBackground = Color(0xFF00C853);
  static const Color quickActionUploadIcon = Color(0xFFFFF8E1);
  static const Color quickActionUploadBorder = Color(0xFF0B7A57);

  static const Color quickActionHistoricoBackground = Color(0xFF00BCD4);
  ...
  static const Color strategyCardSecondaryBackground = Color(0xFFFFE082);
  static const Color strategyCardSecondaryIcon = Color(0xFF00C853);
  ...
  static const Color statsOverviewBackground1 = Color(0xFFFFF8E1);
  static const Color statsOverviewBackground2 = Color(0xFFFFECB3);

  static const Color quickActionsReportsBackground1 = Color(0xFFFFF8E1);
  static const Color quickActionsReportsBackground2 = Color(0xFFFFECB3);

  static const Color quickActionsImportBackground1 = Color(0xFFFFF8E1);
  static const Color quickActionsImportBackground2 = Color(0xFFFFECB3);
  ...
  static const Color quickActionEmail = Color(0xFF00C853);

  // ===========================================================================
  // PAINEL ADMINISTRATIVO - CORES CLARAS E PROFISSIONAIS
  // ===========================================================================

  static const Color adminPanelBackground1 = Color(0xFFFFF8E1);
  static const Color adminPanelBackground2 = Color(0xFFFFECB3);

  static const Color adminPanelButtonLojas = Color(0xFF00BCD4);
  static const Color adminPanelButtonUsuarios = Color(0xFF00C853);
  static const Color adminPanelButtonConfig = Color(0xFF0277BD);

  // ===========================================================================
  // PRIMEIROS PASSOS (Onboarding Light) - GUIA SUAVE
  // ===========================================================================

  static const Color onboardingBackground1 = Color(0xFFFFE082);
  static const Color onboardingBackground2 = Color(0xFFE2E8F0);
  static const Color onboardingBorder = Color(0xFFCBD5E1);

  static const Color onboardingIcon = Color(0xFF0288D1);
  static const Color onboardingProgress = Color(0xFF01579B);

  static const Color onboardingStepCompleted = Color(0xFF0288D1);
  static const Color onboardingStepPending = Color(0xFF00BCD4);
  ...
  static const Color statTagsESLBackground = Color(0xFFFFE082);
  static const Color statTagsESLIcon = Color(0xFF00C853);
  static const Color statTagsESLBorder = Color(0xFFA7F3D0);

  static const Color statSyncBackground = Color(0xFFF0FDFF);
  static const Color statSyncIcon = Color(0xFF00BCD4);
  ...
  static const Color reportVendas = Color(0xFF00C853);
  ...
  static const Color pricingFixedValue = Color(0xFF00C853);
  ...
  static const Color pricingMarginReview = Color(0xFF00BCD4);
  static const Color pricingMarginReviewDark = Color(0xFF0097A7);
  static const Color pricingDynamic = Color(0xFF0288D1);
  static const Color pricingDynamicDark = Color(0xFF01579B);
  static const Color pricingHistory = Color(0xFF00BCD4);
  static const Color pricingHistoryDark = Color(0xFF0D6F8B);

  static const Color syncComplete = Color(0xFF00C853);
  ...
  static const Color syncSettings = Color(0xFF0288D1);
  static const Color syncSettingsDark = Color(0xFF01579B);
  ...
  static const Color tipCardBg = Color(0xFFFFE082);
  static const Color tipCardBorder = Color(0xFFA7F3D0);
  static const Color tipCardText = Color(0xFF01579B);
  ...
  static const Color successCardText = Color(0xFF01579B);
  ...
  static const Color syncedBg = Color(0xFFFFE082);
  static const Color syncedBorder = Color(0xFFA7F3D0);
  static const Color syncedIcon = Color(0xFF00C853);
  ...
  static const Color notSyncedBg = Color(0xFFFFECB3);
  ...
  static const Color darkSurface = Color(0xFFFFF8E1);
  static const Color darkBackground = Color(0xFFFFECB3);
  static const Color darkCard = Color(0xFFFFF8E1);
  static const Color darkDialog = Color(0xFFFFF8E1);
  static const Color darkInput = Color(0xFFFFECB3);
  static const Color darkDropdown = Color(0xFFFFF8E1);
  ...
  static const Color statusBlueGrey = Color(0xFF0277BD);
  static const Color statusBlueGreyLight = Color(0xFF94A3B8);
  static const Color statusBlueGreyBg = Color(0xFFFFECB3);
  ...
  static const Color gradientSugestoesEnd = Color(0xFF00C853);

  static const Color gradientDarkStart = Color(0xFF00C853);
  ...
  static const Color greenMain = Color(0xFF00C853);
  static const Color greenTeal = Color(0xFF00BCD4);
  static const Color greenGradient = Color(0xFF059669);
  static const Color greenGradientEnd = Color(0xFF4FC3F7);
  static const Color greenMaterial = Color(0xFF00C853);
  static const Color successMaterial = Color(0xFF00C853);
  static const Color greenDark = Color(0xFF059669);
  static const Color greenLightMaterial = Color(0xFF6EE7B7);

  static const Color blueMain = Color(0xFF00BCD4);
  static const Color blueCyan = Color(0xFF00BCD4);
  static const Color blueMaterial = Color(0xFF00BCD4);
  static const Color blueLight = Color(0xFF5EEAD4);
  static const Color blueDark = Color(0xFF0D6F8B);
  static const Color blueIndigo = Color(0xFF01579B);

  static const Color cyanMain = Color(0xFF00BCD4);
  static const Color cyanDark = Color(0xFF0097A7);
  static const Color tealMain = Color(0xFF00BCD4);
  static const Color cyanGradientStart = Color(0xFF22D3EE);
  static const Color cyanGradientEnd = Color(0xFF0097A7);
  ...
  static const Color primaryPastel = Color(0xFFFFE082);
  ...
  static const Color infoModuleIcon = Color(0xFF00BCD4);

  static const Color suggestionCardStart = Color(0xFF00C853);
  static const Color suggestionCardEnd = Color(0xFF059669);
  static const Color suggestionAumentosBackground = Color(0xFFFFE082);
  static const Color suggestionAumentosText = Color(0xFF01579B);
  ...
  static const Color mintPastel = Color(0xFFFFE082);
  static const Color pinkPastel = Color(0xFFFDF2F8);
  static const Color bluePastel = Color(0xFFF0FDFF);
  static const Color surfacePastel = Color(0xFFFFECB3);
