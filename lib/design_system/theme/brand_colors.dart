...
class TagBeanColors {
  // Cores primãrias da marca (extraãdas da logo)
  ...
  static const Color textOnPrimary = Color(0xFFFFFFFF); // white/surface
  ...
  // Cores de superfãcie
  static const Color cardBackground = Color(0xFFFFFFFF); // white/surface
  ...
  // Mãtodo auxiliar para obter cor com opacidade
