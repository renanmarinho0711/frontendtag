...
class TagBeanColors {
  // Cores prim�rias da marca (extra�das da logo)
  ...
  static const Color mediumBackground = Color(0xFF2D4A42); // Verde m�dio
  ...
  static const Color textOnPrimary = AppThemeColors.surface;
  ...
  // M�todo auxiliar para obter cor com opacidade
