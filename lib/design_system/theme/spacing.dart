...
class AppSpacing {
  ...
  static const double gapVerticalXs = 4.0;

  static const double gapVerticalSm = 8.0;

  static const double gapVerticalMd = 12.0;

  static const double gapVerticalLg = 16.0;

  static const double gapHorizontalSm = 8.0;

  static const double gapHorizontalMd = 12.0;

  static const double gapHorizontalLg = 16.0;
