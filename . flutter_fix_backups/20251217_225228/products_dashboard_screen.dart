...
class _ProdutosDashboardScreenState extends ConsumerState<ProdutosDashboardScreen>
  ...
  /// Carrega preferência do onboarding
  ...
  /// Salva preferência do onboarding
  ...
  // Estatísticas do provider ou valores default
  ...
  // Verifica condições para onboarding contextual
  ...
  String get _syncTimeAgo {
    ...
    if (diff.inHours < 24) return 'há ${diff.inHours}há';
        ...
        children: [
          ...
          IconButton(
            ...
            icon: AnimatedRotation(
              ...
              child: Icon(
                Icons.sync_rounded,
                color: _isSyncing ? AppThemeColors.surfaceOverlay50 : AppThemeColors.surface,
      ...
      return Row(
        ...
        children: [
          FloatingActionButton.small(
            ...
            backgroundColor: AppThemeColors.textSecondaryOverlay80,
            foregroundColor: AppThemeColors.surface,
    ...
    return Container(
      ...
      child: const Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            CircularProgressIndicator(color: AppThemeColors.brandPrimaryGreen),
            SizedBox(height: 16),
            Text(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(10),
              border: Border.all(color: AppThemeColors.blueMaterial.withValues(alpha: 0.2)),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisSize: MainAxisSize.min,
  ...
  /// SEÃ‡ÃƒO 6: Categorias com Chips e botão + Nova
  ...
  Widget _buildMapaModulo() {
    ...
    final menus = [
      ...
      _ModuloMenuItem(
        titulo: 'Estoque',
        subtitulo: 'Gestão de inventário',
        icone: Icons.warehouse_rounded,
        cor: AppThemeColors.materialTeal,
        onTap: () => setState(() => _currentScreen = 'estoque'),
      ),
      _ModuloMenuItem(
        titulo: 'Categorias',
