            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: AppSpacing.sm),
                  _buildTagInfo(context, 'Última Sincronização', 
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: ['Bebidas', 'Mercearia', 'Perecãveis', 'Limpeza', 'Higiene']
  ...
  void _desassociarTag() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'O produto ficarã sem uma tag associada e não será atualizado automaticamente.',
          textAlign: TextAlign.center,
        ),
        actions: [
          TextButton(
