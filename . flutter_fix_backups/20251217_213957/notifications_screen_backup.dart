...
class _ConfiguracoesNotificacoesScreenState
  ...
  Widget _buildChannelSwitch(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        // ignore: deprecated_member_use
        color: value ? color.withValues(alpha:  0.05) : ThemeColors.of(context).textSecondary,
        borderRadius: BorderRadius.circular(
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              // ignore: deprecated_member_use
              color: value ? color.withValues(alpha:  0.1) : ThemeColors.of(context).textSecondary,
              borderRadius: BorderRadius.circular(
                ResponsiveHelper.getResponsiveBorderRadius(
                  context,
                  mobile: 10,
