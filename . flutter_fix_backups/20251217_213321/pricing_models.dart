...
class MarginReviewModel {
  ...
  factory MarginReviewModel.fromJson(Map<String, dynamic> json) {
    ...
    return MarginReviewModel(
      ...
      custoCompra: cost,
      margemAtual: margin,
      margemIdeal: (json['targetMargin'] as double ?? json['margemIdeal'] as double ?? 30).toDouble(),
      margemMinima: (json['minMargin'] as double ?? json['margemMinima'] as double ?? 10).toDouble(),
      status: status,
...
class PricingHistoryModel {
  ...
  factory PricingHistoryModel.fromJson(Map<String, dynamic> json) {
    ...
    return PricingHistoryModel(
      ...
      precoAntigo: (json['oldPrice'] as double ?? json['preco_antigo'] as double ?? 0).toDouble(),
      precoNovo: (json['newPrice'] as double ?? json['preco_novo'] as double ?? 0).toDouble(),
