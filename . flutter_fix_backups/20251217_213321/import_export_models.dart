...
class ImportHistoryModel {
  ...
  factory ImportHistoryModel.fromJson(Map<String, dynamic> json) {
    ...
    return ImportHistoryModel(
      ...
      fileName: json['fileName'] as String ?? json['nome'] as String as String,

      dateTime: DateTime.tryParse(json['dateTime'] as String ?? json['data'] as String ?? '') ?? DateTime.now(),

      totalRecords: json['totalRecords'] as int ?? json['total'] as int as int,

      successCount: json['successCount'] as int ?? json['sucesso'] as int as int,

      errorCount: json['errorCount'] as int ?? json['erros'] as int ?? 0,

      duplicateCount: json['duplicateCount'] as int ?? json['duplicados'] as int ?? 0,

      duration: json['duration'] as String ?? json['duracao'] as String as String,
...
class BatchOperationModel {
  ...
  factory BatchOperationModel.fromJson(Map<String, dynamic> json) {
    ...
    return BatchOperationModel(
      ...
      title: json['titulo'] as String ?? json['title'] as String as String,

      subtitle: json['subtitulo'] as String ?? json['subtitle'] as String as String,

      description: json['descricao'] as String ?? json['description'] as String as String,

      detailedDescription: json['descricaoDetalhada'] as String ?? json['detailedDescription'] as String as String,

      gradientColors: (json['gradiente'] as List?)?.cast<Color>() ?? [],

      hasTemplate: json['template'] as bool ?? true,

      requiredColumns: (json['colunas'] as List?)?.cast<String>() ?? [],

      example: json['exemplo'] as String ?? json['example'] as String as String,
...
class ImportExportStats {
  ...
  factory ImportExportStats.fromJson(Map<String, dynamic> json) {
    ...
    return ImportExportStats(
      ...
      totalRecordsImported: json['totalRecordsImported'] as int ?? 0,

      totalRecordsExported: json['totalRecordsExported'] as int ?? 0,
...
class ColumnMappingModel {
  ...
  factory ColumnMappingModel.fromJson(Map<String, dynamic> json) {
    ...
    return ColumnMappingModel(
      ...
      confidence: (json['confidence'] as double ?? 1.0).toDouble(),
