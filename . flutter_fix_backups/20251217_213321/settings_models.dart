...
enum ERPConnectionStatus {
  ...
  connected('Conectado', AppThemeColors.success),

  disconnected('Desconectado', AppThemeColors.error),

  testing('Testando...', AppThemeColors.orangeMaterial),

  error('Erro', AppThemeColors.error);



  const ERPConnectionStatus(this.label, this.color);
  ...
  Color dynamicColor(BuildContext context) {
    ...
    switch (this) {
      ...
      case ERPConnectionStatus.disconnected:

        return colors.error;

      case ERPConnectionStatus.testing:
