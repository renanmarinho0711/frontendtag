...
class ProductModel {
  ...
  /// Getter para verificar se o produto está ativo
  ...
  factory ProductModel.fromProduto(dynamic produto) {
    ...
    // Assume que é um objeto Produto da camada de dados
    return ProductModel(
      ...
      // Novos campos Minew (se disponíveis no objeto Produto)
...
class PriceHistoryModel {
  ...
  factory PriceHistoryModel.fromJson(Map<String, dynamic> json) {
    // Suporta tanto formato português quanto inglês do backend
